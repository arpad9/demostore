<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 03:41:02
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/profiles/components/profile_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1269363581522d0b0eb52bb8-95620865%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0358c0d6bac7eb22f7d6b5d2de675f6fefbe2c42' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/profiles/components/profile_fields.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1269363581522d0b0eb52bb8-95620865',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d0b0f40ae78_46236303',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d0b0f40ae78_46236303')) {function content_522d0b0f40ae78_46236303($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
?>
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php if ($_smarty_tpl->tpl_vars['show_email']->value){?>
...
" class="input-text <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php if ($_smarty_tpl->tpl_vars['address_flag']->value){?>
    <div class="address-switch clearfix">
        <div class="float-left"><span><?php if ($_smarty_tpl->tpl_vars['section']->value=="S"){?><?php echo $_smarty_tpl->__("shipping_same_as_billing");?>
<?php }else{ ?><?php echo $_smarty_tpl->__("text_billing_same_with_shipping");?>
<?php }?></span></div>
...
<?php if (!$_smarty_tpl->tpl_vars['nothing_extra']->value){?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['title']->value), 0);?>
...
<div class="control-group <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['class'], ENT_QUOTES, 'UTF-8');?>
">
...
elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['field_id'], ENT_QUOTES, 'UTF-8');?>
" class="cm-state <?php if ($_smarty_tpl->tpl_vars['section']->value=="S"){?>cm-location-shipping<?php }else{ ?>cm-location-billing<?php }?> <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');?>
...
]" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?>>
...
" disabled="disabled" class="cm-state <?php if ($_smarty_tpl->tpl_vars['section']->value=="S"){?>cm-location-shipping<?php }else{ ?>cm-location-billing<?php }?> input-text hidden <?php if ($_smarty_tpl->tpl_vars['_class']->value){?>disabled<?php }?>"/>
...
"<?php }?> id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'UTF-8');?>
elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['field_id'], ENT_QUOTES, 'UTF-8');?>
" class="cm-country <?php if ($_smarty_tpl->tpl_vars['section']->value=="S"){?>cm-location-shipping<?php }else{ ?>cm-location-billing<?php }?> <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');?>
...
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
]" value="N" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?> />
...
<?php }else{ ?>cm-skip-avail-switch<?php }?>" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?> />
...
"<?php }?> class="input-textarea <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');?>
<?php }else{ ?>cm-skip-avail-switch<?php }?>" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'UTF-8');?>
elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['field_id'], ENT_QUOTES, 'UTF-8');?>
" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_name']->value, ENT_QUOTES, 'UTF-8');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
]" cols="32" rows="3" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
...
"<?php }?> id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'UTF-8');?>
elm_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['field']->value['field_id'], ENT_QUOTES, 'UTF-8');?>
" class="<?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');?>
<?php }else{ ?>cm-skip-avail-switch<?php }?>" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_name']->value, ENT_QUOTES, 'UTF-8');?>
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
]" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?>>
...
" <?php if ((!$_smarty_tpl->tpl_vars['value']->value&&$_smarty_tpl->getVariable('smarty')->value['foreach']['rfe']['first'])||$_smarty_tpl->tpl_vars['value']->value==$_smarty_tpl->tpl_vars['k']->value){?>checked="checked"<?php }?> <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
...
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
]" value="residential" <?php if (!$_smarty_tpl->tpl_vars['value']->value||$_smarty_tpl->tpl_vars['value']->value=="residential"){?>checked="checked"<?php }?> <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
...
[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['data_id']->value, ENT_QUOTES, 'UTF-8');?>
]" value="commercial" <?php if ($_smarty_tpl->tpl_vars['value']->value=="commercial"){?>checked="checked"<?php }?> <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="input-text <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_class']->value, ENT_QUOTES, 'UTF-8');?>
<?php }else{ ?>cm-skip-avail-switch<?php }?>" <?php if (!$_smarty_tpl->tpl_vars['skip_field']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['disabled_param']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?> />
    <?php }?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/profiles/components/profile_fields.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/profiles/components/profile_fields.tpl"),$_smarty_tpl);?>
"><div class="cm-template-icon icon-edit hidden"></div><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<!--[/tpl_id]--></span><?php }else{ ?><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<?php }?><?php }?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['show_email']->value){?>
    <div class="control-group">
        <label for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id_prefix']->value, ENT_QUOTES, 'UTF-8');?>
elm_email" class="cm-required cm-email"><?php echo $_smarty_tpl->__("email");?>
<i>*</i></label>
