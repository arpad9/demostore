<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:48:07
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/sitemap/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:150955181522dfbc7c48d17-66953963%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dcf71b0a11000975c0a1adfe9f92ff2219aebd38' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/sitemap/view.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '150955181522dfbc7c48d17-66953963',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfbc7d85a69_00991273',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfbc7d85a69_00991273')) {function content_522dfbc7d85a69_00991273($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><div class="sitemap">
    <div class="sitemap-section">
        ...
        <?php if ($_smarty_tpl->tpl_vars['sitemap_settings']->value['show_site_info']=="Y"){?>
            ...
            <ul>
                <?php echo $_smarty_tpl->getSubTemplate ("views/pages/components/pages_tree.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tree'=>$_smarty_tpl->tpl_vars['sitemap']->value['pages_tree'],'root'=>true,'no_delim'=>true), 0);?>
...
" class="strong"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value['category'], ENT_QUOTES, 'UTF-8');?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['sitemap']->value['categories_tree']){?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/sitemap/components/categories_tree.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('all_categories_tree'=>$_smarty_tpl->tpl_vars['sitemap']->value['categories_tree'],'background'=>"white"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/sitemap/view.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/sitemap/view.tpl"),$_smarty_tpl);?>
