<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:59:45
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/product_filters_advanced_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1282097237522dfe81e4ae93-03822391%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '11c7fa57c58dfabce7738764779ef93e7512b0d2' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/product_filters_advanced_form.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1282097237522dfe81e4ae93-03822391',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfe827454c8_66194628',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfe827454c8_66194628')) {function content_522dfe827454c8_66194628($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.split.php';
...
<div class="buttons-container">
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[".((string)$_REQUEST['dispatch'])."]",'but_text'=>__("submit")), 0);?>
...
<?php }?>
<?php echo $_smarty_tpl->getSubTemplate ("common/section.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section_title'=>__("advanced_filter"),'section_content'=>Smarty::$_smarty_vars['capture']['section'],'collapse'=>$_smarty_tpl->tpl_vars['_collapse']->value), 0);?>


<?php }else{ ?>

<?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("advanced_filter")), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/products/components/product_filters_advanced_form.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/product_filters_advanced_form.tpl"),$_smarty_tpl);?>
