<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:48:41
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/addons/gift_certificates/hooks/wishlist/view.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:373655496522dfbe99ec3a3-06876252%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '8285017de986cf08ef76e723eb689b44df0bf1c5' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/addons/gift_certificates/hooks/wishlist/view.post.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '373655496522dfbe99ec3a3-06876252',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfbe9e898f0_50870355',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfbe9e898f0_50870355')) {function content_522dfbe9e898f0_50870355($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
...
?>
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php if ($_smarty_tpl->tpl_vars['wishlist']->value['gift_certificates']){?>
...
<?php  $_smarty_tpl->tpl_vars["gift"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["gift"]->_loop = false;
 ...
 $_smarty_tpl->tpl_vars["gift"]->total= $_smarty_tpl->_count($_from);
 $_smarty_tpl->tpl_vars["gift"]->iteration=0;
...
$_smarty_tpl->tpl_vars["gift"]->_loop = true;
 ...
 $_smarty_tpl->tpl_vars["gift"]->iteration++;
 $_smarty_tpl->tpl_vars["gift"]->last = $_smarty_tpl->tpl_vars["gift"]->iteration === $_smarty_tpl->tpl_vars["gift"]->total;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["gift_certificates"]['last'] = $_smarty_tpl->tpl_vars["gift"]->last;
?>
<?php echo smarty_function_math(array('equation'=>"it + 1",'assign'=>"iteration",'it'=>$_smarty_tpl->tpl_vars['iteration']->value),$_smarty_tpl);?>
    ...
    <td class="product-cell valign-top" style="width: <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cell_width']->value, ENT_QUOTES, 'UTF-8');?>
%">
...
<?php if ($_smarty_tpl->tpl_vars['gift']->value['products']){?> + <?php echo $_smarty_tpl->__("free_products");?>
<?php }?></a>
                </td>
            </tr>
            <tr>
                <td class="product-description">
                    <p>
                        <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['gift']->value['amount']), 0);?>

                    </p>
                    <div class="quick-view">
                        <span class="button button-wrap-left">
                        <span class="button button-wrap-right"><a id="opener_gift_cert_picker_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'UTF-8');?>
" class="cm-dialog-opener cm-dialog-auto-size" data-ca-target-id="gift_cert_quick_view_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'UTF-8');?>
...
"><?php echo $_smarty_tpl->__("quick_view");?>
</a></span>
                        </span>
                    </div>
                </td>
                ...
                <div class="product-container wishlist-wrap">
                    <div class="float-left center">
                        <div class="cm-image-wrap wishlist-image">
                            <p><a href="<?php echo htmlspecialchars(fn_url("gift_certificates.update?gift_cert_wishlist_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php echo $_smarty_tpl->getSubTemplate ("addons/gift_certificates/views/gift_certificates/components/gift_certificates_cart_icon.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('width'=>"150",'height'=>"150"), 0);?>
</a></p>

                            <p class="center"><?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("edit"),'but_href'=>"gift_certificates.update?gift_cert_wishlist_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value),'but_role'=>"text"), 0);?>
</p>
                        </div>
                    </div>
...
" class="product-title"><?php echo $_smarty_tpl->__("gift_certificate");?>
                        ...
                        <div class="control-group product-list-field">
                            <label><?php echo $_smarty_tpl->__("gift_cert_to");?>
:</label>
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['recipient'], ENT_QUOTES, 'UTF-8');?>
</span>
                        </div>
                        <div class="control-group product-list-field">
                            <label><?php echo $_smarty_tpl->__("gift_cert_from");?>
:</label>
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift']->value['sender'], ENT_QUOTES, 'UTF-8');?>
</span>
                        </div>
                        <div class="control-group product-list-field">
                            <label><?php echo $_smarty_tpl->__("amount");?>
:</label>
                            <span><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['gift']->value['amount']), 0);?>
</span>
                        </div>
                        <div class="control-group product-list-field">
                            <label><?php echo $_smarty_tpl->__("send_via");?>
:</label>
                            <span><?php if ($_smarty_tpl->tpl_vars['gift']->value['send_via']=="E"){?><?php echo $_smarty_tpl->__("email");?>
...
:</strong></p>
                            ...
                            <tr>
                                ...
                                <th class="right" style="width: 10%"><?php echo $_smarty_tpl->__("subtotal");?>
</th>
                            </tr>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_product']->value['product'], ENT_QUOTES, 'UTF-8');?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['_product']->value['product_options']){?>
                                        <?php echo $_smarty_tpl->getSubTemplate ("common/options_info.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product_options'=>$_smarty_tpl->tpl_vars['_product']->value['product_options'],'fields_prefix'=>"gift_cert_data[products][".((string)$_smarty_tpl->tpl_vars['key_cert_prod']->value)."][product_options]"), 0);?>

                                    <?php }?>
                                </td>
                                <td class="center">
                                    <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['_product']->value['price']), 0);?>
</td>
                                ...
                                <td class="right nowrap">
                                    ...
                                    <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['subtotal']->value), 0);?>
</td>
                            </tr>
                            <?php }?>
                            ...
                            <div class="control-group product-list-field wishlist-price float-right">
                                <label><?php echo $_smarty_tpl->__("price_summary");?>
:</label>
                                <span><?php echo smarty_function_math(array('equation'=>"item_price + gift_",'item_price'=>(($tmp = @$_smarty_tpl->tpl_vars['gift_price']->value)===null||$tmp==='' ? "0" : $tmp),'gift_'=>(($tmp = @$_smarty_tpl->tpl_vars['gift']->value['amount'])===null||$tmp==='' ? "0" : $tmp),'assign'=>"gift_price"),$_smarty_tpl);?>

                                    <strong><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['gift_price']->value), 0);?>
</strong></span>
                            </div>
                            <div class="clear"></div>
                        </div>
                        ...
                        <div class="qv-buttons-container">
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/add_to_cart.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_role'=>"big",'but_name'=>"dispatch[gift_certificates.add]"), 0);?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['iteration']->value%$_smarty_tpl->tpl_vars['columns']->value==0&&!$_smarty_tpl->getVariable('smarty')->value['foreach']['gift_certificates']['last']){?>
    </tr>
    <tr>
    <?php }?>
<?php } ?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="addons/gift_certificates/hooks/wishlist/view.post.tpl" id="<?php echo smarty_function_set_id(array('name'=>"addons/gift_certificates/hooks/wishlist/view.post.tpl"),$_smarty_tpl);?>
"><div class="cm-template-icon icon-edit hidden"></div><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<!--[/tpl_id]--></span><?php }else{ ?><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<?php }?><?php }?><?php }else{ ?><?php if ($_smarty_tpl->tpl_vars['wishlist']->value['gift_certificates']){?>
