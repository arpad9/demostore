<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 01:48:41
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/auth/login_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1903290000522cf0b91b9f65-85837937%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '83c647ff9e90dd5fcda2e51f67fd4afc04a72e6a' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/auth/login_form.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1903290000522cf0b91b9f65-85837937',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf0b9347555_54431803',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf0b9347555_54431803')) {function content_522cf0b9347555_54431803($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['style']->value=="checkout"){?>
    <div class="checkout-login-form"><?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("returning_customer")), 0);?>
...
" class="input-text" maxlength="32" />
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("common/image_verification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option'=>"use_for_login",'align'=>"left"), 0);?>
        ...
        <?php }?>
            <div class="body-bc clearfix">
                <div class="float-right">
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/login.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[auth.login]",'but_role'=>"submit"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/auth/login_form.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/auth/login_form.tpl"),$_smarty_tpl);?>
