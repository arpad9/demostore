<?php /* Smarty version Smarty-3.1.13, created on 2013-09-10 01:03:36
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/checkout/components/checkout_login.tpl" */ ?>
<?php /*%%SmartyHeaderCode:819294377522e37a87788b7-21441708%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3f7a0a95311e4d2a3709e3aa730b0400abe1f192' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/checkout/components/checkout_login.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '819294377522e37a87788b7-21441708',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522e37a88a3770_57769373',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522e37a88a3770_57769373')) {function content_522e37a88a3770_57769373($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
//]]>
    ...
    <div class="login-form float-left">
        <?php echo $_smarty_tpl->getSubTemplate ("views/auth/login_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"checkout_login",'style'=>"checkout",'result_ids'=>"checkout*,account*"), 0);?>
    ...
    <div class="checkout-register">
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("register", null, null); ob_start(); ?>
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['approve_user_profiles']!="Y"){?>
                <div id="register_checkout" class="checkout-buttons"><?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_onclick'=>"fn_switch_checkout_type();",'but_text'=>__("register")), 0);?>
</div>
            <?php }?>
...
" method="post">
                        ...
                        <div class="checkout-buttons">
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[checkout.customer_info.guest_checkout]",'but_text'=>__("checkout_as_guest")), 0);?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <div class="register-content">
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['approve_user_profiles']!="Y"||$_smarty_tpl->tpl_vars['settings']->value['General']['disable_anonymous_checkout']!="Y"){?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("new_customer")), 0);?>

            <?php }?>

            <ul class="register-methods">
                <li class="one"><input class="radio valign" type="radio" id="checkout_type_register" name="checkout_type" value="" checked="checked" onclick="fn_show_checkout_buttons('register')" /><div class="radio1"><label for="checkout_type_register"><span class="method-title"><?php echo $_smarty_tpl->__("register");?>
</span><span class="method-hint"><?php echo $_smarty_tpl->__("create_new_account");?>
</span></label></div></li>

                <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['disable_anonymous_checkout']!="Y"){?>
                    <li><input class="radio valign" type="radio" id="checkout_type_guest" name="checkout_type" value="" onclick="fn_show_checkout_buttons('guest')" /><div class="radio1"><label for="checkout_type_guest"><span class="method-title"><?php echo $_smarty_tpl->__("checkout_as_guest");?>
</span><span class="method-hint"><?php echo $_smarty_tpl->__("create_guest_account");?>
</span></label></div></li>
                <?php }?>
            </ul>
        </div>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/checkout/components/checkout_login.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/checkout/components/checkout_login.tpl"),$_smarty_tpl);?>
