<?php /* Smarty version Smarty-3.1.13, created on 2013-09-16 01:57:04
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/profiles/components/multiple_profiles.tpl" */ ?>
<?php /*%%SmartyHeaderCode:206641883952362d30dbb2c0-16866292%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d26933cb5b4c78ed177e161397d8fa87ddc1dc0' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/profiles/components/multiple_profiles.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '206641883952362d30dbb2c0-16866292',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52362d310603b0_24618619',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52362d310603b0_24618619')) {function content_52362d310603b0_24618619($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['show_title']->value){?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("select_profile")), 0);?>
...
" data-ca-target-id="checkout_steps,cart_items,checkout_totals"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['up']->value['profile_name'], ENT_QUOTES, 'UTF-8');?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['up']->value['profile_type']!="P"&&!$_smarty_tpl->tpl_vars['hide_profile_delete']->value){?>
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_meta'=>"cm-confirm",'but_target_id'=>"checkout_steps,cart_items,checkout_totals",'but_role'=>"delete",'but_text'=>"&nbsp;",'but_href'=>"profiles.delete_profile?profile_id=".((string)$_smarty_tpl->tpl_vars['up']->value['profile_id'])), 0);?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/profiles/components/multiple_profiles.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/profiles/components/multiple_profiles.tpl"),$_smarty_tpl);?>
