<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:09:37
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/product_options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1477784902522cf5a1333245-51461790%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'acffcfa36e5019015a2a55dde4baabe845f76434' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/product_options.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1477784902522cf5a1333245-51461790',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5a1ca0bf6_05340569',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5a1ca0bf6_05340569')) {function content_522cf5a1ca0bf6_05340569($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
<?php if (trim(preg_replace('!<[^>]*?>!', ' ', $_smarty_tpl->tpl_vars['po']->value['description']))){?><?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>$_smarty_tpl->tpl_vars['po']->value['description']), 0);?>
<?php }?>:&nbsp;</label>
...
<?php if (floatval($_smarty_tpl->tpl_vars['vr']->value['modifier'])){?>(<?php echo $_smarty_tpl->getSubTemplate ("common/modifier.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('mod_type'=>$_smarty_tpl->tpl_vars['vr']->value['modifier_type'],'mod_value'=>$_smarty_tpl->tpl_vars['vr']->value['modifier'],'display_sign'=>true), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/products/components/product_options.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/product_options.tpl"),$_smarty_tpl);?>
"><div class="cm-template-icon icon-edit hidden"></div><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<!--[/tpl_id]--></span><?php }else{ ?><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<?php }?><?php }?><?php }else{ ?><?php if (($_smarty_tpl->tpl_vars['settings']->value['General']['display_options_modifiers']=="Y"&&($_smarty_tpl->tpl_vars['auth']->value['user_id']||($_smarty_tpl->tpl_vars['settings']->value['General']['allow_anonymous_shopping']!="P"&&!$_smarty_tpl->tpl_vars['auth']->value['user_id'])))){?>
<?php $_smarty_tpl->tpl_vars["show_modifiers"] = new Smarty_variable(true, null, 0);?>
<?php }?>
