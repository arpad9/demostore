<?php /* Smarty version Smarty-3.1.13, created on 2013-09-10 01:03:37
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/checkout/components/promotion_coupon.tpl" */ ?>
<?php /*%%SmartyHeaderCode:277003448522e37a92c13c0-51326788%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c02fad1568a4fd89069a3be7a69f62825b314123' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/checkout/components/promotion_coupon.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '277003448522e37a92c13c0-51326788',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522e37a93e09c9_22185256',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522e37a93e09c9_22185256')) {function content_522e37a93e09c9_22185256($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
?>
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><div class="code-input discount-coupon">
    <?php if (fn_display_promotion_input_field($_smarty_tpl->tpl_vars['cart']->value)){?>
    <div>
        <form class="cm-ajax cm-ajax-full-render" name="coupon_code_form<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['position']->value, ENT_QUOTES, 'UTF-8');?>
...
" />
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/go.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"checkout.apply_coupon",'alt'=>__("apply")), 0);?>
...
?>
                <li>
                    <span><?php echo $_smarty_tpl->__("coupon");?>
...
"
                    ...
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_href'=>"checkout.delete_coupon?coupon_code=".((string)$_smarty_tpl->tpl_vars['coupon_code']->value)."&redirect_url=".((string)$_smarty_tpl->tpl_vars['_redirect_url']->value),'but_role'=>"delete",'but_meta'=>"cm-ajax cm-ajax-full-render",'but_target_id'=>"checkout*,cart_status*,cart_items"), 0);?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['cart']->value['applied_promotions']){?>
                    <li>
                        <?php echo $_smarty_tpl->getSubTemplate ("views/checkout/components/applied_promotions.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/checkout/components/promotion_coupon.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/checkout/components/promotion_coupon.tpl"),$_smarty_tpl);?>
"><div class="cm-template-icon icon-edit hidden"></div><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<!--[/tpl_id]--></span><?php }else{ ?><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<?php }?><?php }?><?php }else{ ?><div class="code-input discount-coupon">
    <?php if (fn_display_promotion_input_field($_smarty_tpl->tpl_vars['cart']->value)){?>
    <div>
        <form class="cm-ajax cm-ajax-full-render" name="coupon_code_form<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['position']->value, ENT_QUOTES, 'UTF-8');?>
" action="<?php echo htmlspecialchars(fn_url(''), ENT_QUOTES, 'UTF-8');?>
