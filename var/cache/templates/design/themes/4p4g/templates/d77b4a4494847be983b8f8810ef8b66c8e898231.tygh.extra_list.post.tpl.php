<?php /* Smarty version Smarty-3.1.13, created on 2013-09-16 01:44:50
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/addons/gift_certificates/hooks/checkout/extra_list.post.tpl" */ ?>
<?php /*%%SmartyHeaderCode:66685729852362a526b4644-65310994%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd77b4a4494847be983b8f8810ef8b66c8e898231' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/addons/gift_certificates/hooks/checkout/extra_list.post.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '66685729852362a526b4644-65310994',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52362a52ad2ce0_63760398',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52362a52ad2ce0_63760398')) {function content_52362a52ad2ce0_63760398($_smarty_tpl) {?><?php if (!is_callable('smarty_function_cycle')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.cycle.php';
...
">
            <?php echo $_smarty_tpl->getSubTemplate ("addons/gift_certificates/views/gift_certificates/components/gift_certificates_cart_icon.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('width'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_cart_thumbnail_width'],'height'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_cart_thumbnail_height']), 0);?>

            </a>
            <p class="center"><?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("edit"),'but_href'=>"gift_certificates.update?gift_cert_id=".((string)$_smarty_tpl->tpl_vars['gift_key']->value),'but_role'=>"text"), 0);?>
</p>
        <?php }else{ ?>
            <?php echo $_smarty_tpl->getSubTemplate ("addons/gift_certificates/views/gift_certificates/components/gift_certificates_cart_icon.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('width'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_cart_thumbnail_width'],'height'=>$_smarty_tpl->tpl_vars['settings']->value['Thumbnails']['product_cart_thumbnail_height']), 0);?>
...
:</label><span><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['gift']->value['amount']), 0);?>
</span>
        </div>
        <div class="control-group product-list-field">
...
<?php }?></span>
        ...
        <p><a id="sw_gift_products_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['gift_key']->value, ENT_QUOTES, 'UTF-8');?>
" class="cm-combo-on cm-combination"><?php echo $_smarty_tpl->__("free_products");?>
</a></p>
...
"><i class="icon-cancel-circle"></i></a>
                    <p><?php echo $_smarty_tpl->getSubTemplate ("common/options_info.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product_options'=>fn_get_selected_product_options_info($_smarty_tpl->tpl_vars['cart']->value['products'][$_smarty_tpl->tpl_vars['key']->value]['product_options']),'fields_prefix'=>"cart_products[".((string)$_smarty_tpl->tpl_vars['key']->value)."][product_options]"), 0);?>
</p>
...
" /></td>
                <td class="center">
                    <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['original_price']), 0);?>
</td>
                <td class="center">
...
" /></td>
                <?php if ($_smarty_tpl->tpl_vars['cart']->value['use_discount']){?>
                <td class="center">
                    <?php if (floatval($_smarty_tpl->tpl_vars['product']->value['discount'])){?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['discount']), 0);?>
<?php }else{ ?>-<?php }?></td>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['cart']->value['taxes']&&$_smarty_tpl->tpl_vars['settings']->value['General']['tax_calculation']!="subtotal"){?>
                <td class="center">
                    <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['tax_summary']['total']), 0);?>
</td>
                <?php }?>
                <td class="right">
                    <?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['display_subtotal']), 0);?>
</td>
            </tr>
            <?php }?>
            <?php } ?>
...
:</label>
                <?php if (!$_smarty_tpl->tpl_vars['gift']->value['extra']['exclude_from_calculate']){?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['gift']->value['display_subtotal'],'class'=>"price"), 0);?>
...
">
        <?php if (!$_smarty_tpl->tpl_vars['gift']->value['extra']['exclude_from_calculate']){?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['gift']->value['display_subtotal'],'class'=>"sub-price"), 0);?>
<?php }else{ ?><span class="price"><?php echo $_smarty_tpl->__("free");?>
</span><?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="addons/gift_certificates/hooks/checkout/extra_list.post.tpl" id="<?php echo smarty_function_set_id(array('name'=>"addons/gift_certificates/hooks/checkout/extra_list.post.tpl"),$_smarty_tpl);?>
