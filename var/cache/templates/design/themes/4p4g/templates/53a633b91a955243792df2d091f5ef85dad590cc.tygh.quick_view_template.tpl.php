<?php /* Smarty version Smarty-3.1.13, created on 2013-09-14 19:43:38
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/quick_view_template.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3830606785234842a7ade92-93654524%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '53a633b91a955243792df2d091f5ef85dad590cc' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/quick_view_template.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '3830606785234842a7ade92-93654524',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5234842acf63d5_23383222',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5234842acf63d5_23383222')) {function content_5234842acf63d5_23383222($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
...
?><?php
fn_preload_lang_vars(array('add_to_cart','save_discount','prev_page','quick_product_viewer','next','quick_product_viewer','sku','add_to_cart','save_discount','prev_page','quick_product_viewer','next','quick_product_viewer','sku'));
?>
...
"<?php }?>><i class="icon-left-circle"></i></a>
            ...
            <a class="quick-view-switcher-icon right <?php if (!$_smarty_tpl->tpl_vars['view_tools']->value['next_id']){?>disabled<?php }else{ ?>cm-dialog-opener cm-dialog-auto-size<?php }?>" <?php if ($_smarty_tpl->tpl_vars['view_tools']->value['next_id']){?>href="<?php echo htmlspecialchars(fn_query_remove($_smarty_tpl->tpl_vars['view_tools']->value['next_url'],"skip_result_ids_check"), ENT_QUOTES, 'UTF-8');?>
" title="<?php if ($_smarty_tpl->tpl_vars['view_tools']->value['links_label']){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['view_tools']->value['links_label'], ENT_QUOTES, 'UTF-8');?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                    ...
                    <div class="product-fields-group">
                        ...
                        <div class="product-list-field">
                            <label><?php echo $_smarty_tpl->__("sku");?>
:</label>
                            <span><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value['product_code'], ENT_QUOTES, 'UTF-8');?>
</span>    
                        </div>
                        <?php }?>                   
                    </div>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/products/components/quick_view_template.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/quick_view_template.tpl"),$_smarty_tpl);?>
