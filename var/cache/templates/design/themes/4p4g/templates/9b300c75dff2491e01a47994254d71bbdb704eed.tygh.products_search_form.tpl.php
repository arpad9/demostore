<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:47:42
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/products_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:822662751522dfbae07b998-23010903%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b300c75dff2491e01a47994254d71bbdb704eed' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/products_search_form.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '822662751522dfbae07b998-23010903',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfbae391943_55193363',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfbae391943_55193363')) {function content_522dfbae391943_55193363($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
"><?php echo preg_replace('!^!m',str_repeat("&#166;&nbsp;&nbsp;&nbsp;&nbsp;",$_smarty_tpl->tpl_vars['cat']->value['level']),smarty_modifier_truncate(htmlspecialchars($_smarty_tpl->tpl_vars['cat']->value['category'], ENT_QUOTES, 'UTF-8', true),50,"...",true));?>
    ...
    <div class="select-field subcategories-field">
        <label for="subcats">
            <input type="checkbox" value="Y"<?php if ($_smarty_tpl->tpl_vars['search']->value['subcats']=="Y"){?> checked="checked"<?php }?> name="subcats" id="subcats" class="checkbox" />
...
<?php if (!$_smarty_tpl->tpl_vars['simple_search_form']->value){?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("advanced_search_options")), 0);?>
...
" />
        <?php if (fn_allowed_for("MULTIVENDOR")){?>
            <?php echo $_smarty_tpl->getSubTemplate ("common/ajax_select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('label'=>__("search_by_vendor"),'data_url'=>"companies.get_companies_list?show_all=Y&search=Y",'text'=>(($tmp = @fn_get_company_name($_smarty_tpl->tpl_vars['search']->value['company_id']))===null||$tmp==='' ? $_smarty_tpl->__("all_vendors") : $tmp),'result_elm'=>"company_id",'id'=>"company_id_selector"), 0);?>
...
" onfocus="this.select();" class="input-text" size="30" />
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/product_filters_advanced_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/section.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section_title'=>__("search_options"),'section_content'=>Smarty::$_smarty_vars['capture']['section'],'class'=>"search-form"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/products/components/products_search_form.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/products_search_form.tpl"),$_smarty_tpl);?>
