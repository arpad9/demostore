<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 08:50:10
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/blocks/list_templates/small_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:36162767522d53828cfe76-61020658%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5933eda59d173280455f3d60e914f2820d313fde' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/blocks/list_templates/small_list.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '36162767522d53828cfe76-61020658',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d5382b84201_64689703',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d5382b84201_64689703')) {function content_522d5382b84201_64689703($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.split.php';
...
<?php if ($_smarty_tpl->tpl_vars['show_price_values']->value&&$_smarty_tpl->tpl_vars['settings']->value['General']['allow_anonymous_shopping']=="P"&&!$_smarty_tpl->tpl_vars['auth']->value['user_id']){?>
...
"><?php echo $_smarty_tpl->getSubTemplate ("common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image_width'=>"40",'image_height'=>"40",'obj_id'=>$_smarty_tpl->tpl_vars['obj_id_prefix']->value,'images'=>$_smarty_tpl->tpl_vars['product']->value['main_pair']), 0);?>
</a></td>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="blocks/list_templates/small_list.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/list_templates/small_list.tpl"),$_smarty_tpl);?>
