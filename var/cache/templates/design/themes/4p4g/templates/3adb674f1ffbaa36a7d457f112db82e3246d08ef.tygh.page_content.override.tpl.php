<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:46:44
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/addons/form_builder/hooks/pages/page_content.override.tpl" */ ?>
<?php /*%%SmartyHeaderCode:746498425522dfb745b1f13-65796232%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3adb674f1ffbaa36a7d457f112db82e3246d08ef' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/addons/form_builder/hooks/pages/page_content.override.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '746498425522dfb745b1f13-65796232',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfb74b42c93_02902357',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfb74b42c93_02902357')) {function content_522dfb74b42c93_02902357($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php if ($_smarty_tpl->tpl_vars['page']->value['page_type']==@constant('PAGE_TYPE_FORM')){?>
    <?php if ($_REQUEST['sent']=="Y"){?>
        ...
        <p class="center">
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("continue"),'but_href'=>fn_url($_smarty_tpl->tpl_vars['continue_url']->value),'but_role'=>"action"), 0);?>
...
?>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['element']->value['description']), 0);?>
...
" class="input-textarea" name="form_values[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['element']->value['element_id'], ENT_QUOTES, 'UTF-8');?>
            ...
            <?php }elseif($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_DATE')){?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/calendar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('date_name'=>"form_values[".((string)$_smarty_tpl->tpl_vars['element']->value['element_id'])."]",'date_id'=>"elm_".((string)$_smarty_tpl->tpl_vars['element']->value['element_id']),'date_val'=>$_smarty_tpl->tpl_vars['form_values']->value[$_smarty_tpl->tpl_vars['element_id']->value]), 0);?>
...
" <?php if ($_smarty_tpl->tpl_vars['_country']->value){?>selected="selected"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['country']->value, ENT_QUOTES, 'UTF-8');?>
</option>
                    <?php } ?>
                </select>
...
" disabled="disabled" />
            ...
            <?php }elseif($_smarty_tpl->tpl_vars['element']->value['element_type']==@constant('FORM_FILE')){?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('var_name'=>"fb_files[".((string)$_smarty_tpl->tpl_vars['element']->value['element_id'])."]"), 0);?>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/image_verification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option'=>"use_for_form_builder"), 0);?>


    <div class="buttons-container">
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_role'=>"submit",'but_text'=>__("submit"),'but_name'=>"dispatch[pages.send_form]"), 0);?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="addons/form_builder/hooks/pages/page_content.override.tpl" id="<?php echo smarty_function_set_id(array('name'=>"addons/form_builder/hooks/pages/page_content.override.tpl"),$_smarty_tpl);?>
