<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:09:44
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/sorting.tpl" */ ?>
<?php /*%%SmartyHeaderCode:650451220522cf5a896d732-24764232%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1d1dff9ea9e3e17df2bdee1aaaf80388d1a52014' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/sorting.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '650451220522cf5a896d732-24764232',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5a8b9a5c1_46755081',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5a8b9a5c1_46755081')) {function content_522cf5a8b9a5c1_46755081($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/modifier.replace.php';
...
<?php echo $_smarty_tpl->getSubTemplate ("common/sorting.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<span id="sw_elm_pagination_steps" class="sort-dropdown cm-combination cm-combo-on"><a><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pagination']->value['items_per_page'], ENT_QUOTES, 'UTF-8');?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/products/components/sorting.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/sorting.tpl"),$_smarty_tpl);?>
