<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:09:38
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/tabs/components/product_tabs.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2047840973522cf5a29d3f92-27017450%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '86030f38aeaed82aa1b7e780b51e886b390e0419' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/tabs/components/product_tabs.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2047840973522cf5a29d3f92-27017450',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5a2b1e056_78385402',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5a2b1e056_78385402')) {function content_522cf5a2b1e056_78385402($_smarty_tpl) {?><?php if (!is_callable('smarty_function_render_block')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.render_block.php';
        ...
        <?php if ($_smarty_tpl->tpl_vars['tab']->value['show_in_popup']!="Y"&&$_smarty_tpl->tpl_vars['tab']->value['status']=="A"){?>
            ...
            <?php $_smarty_tpl->_capture_stack[0][] = array($_smarty_tpl->tpl_vars['tab_content_capture']->value, null, null); ob_start(); ?>
                ...
                <?php }elseif($_smarty_tpl->tpl_vars['tab']->value['tab_type']=='T'){?>
                    <?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['tab']->value['template'], $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product_tab_id'=>$_smarty_tpl->tpl_vars['tab']->value['html_id']), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/tabs/components/product_tabs.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/tabs/components/product_tabs.tpl"),$_smarty_tpl);?>
