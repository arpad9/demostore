<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:09:43
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/blocks/product_filters/original.tpl" */ ?>
<?php /*%%SmartyHeaderCode:786323263522cf5a7885875-72753959%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '642e6fa42b69bfb3018b1758020a82c8aa3fb1f7' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/blocks/product_filters/original.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '786323263522cf5a7885875-72753959',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5a7b13314_80648723',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5a7b13314_80648723')) {function content_522cf5a7b13314_80648723($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
" class="filter-wrap cm-combination-filter_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter_uid']->value, ENT_QUOTES, 'UTF-8');?>
 cm-combo-<?php if ($_smarty_tpl->tpl_vars['collapse']->value){?>on<?php }else{ ?>off<?php }?>">
            <i class="icon-down-dir"></i><i class="icon-right-dir"></i>
            <span class="filter-title cm-save-state <?php if ($_smarty_tpl->tpl_vars['filter']->value['display']=="Y"){?>cm-ss-reverse<?php }?>"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['filter']->value['filter'], ENT_QUOTES, 'UTF-8');?>
</span>

            <?php if ($_smarty_tpl->tpl_vars['filter']->value['slider']){?>
                <?php echo $_smarty_tpl->getSubTemplate ("blocks/product_filters/components/product_filter_slider.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('filter_uid'=>$_smarty_tpl->tpl_vars['filter_uid']->value,'id'=>"slider_".((string)$_smarty_tpl->tpl_vars['filter_uid']->value),'filter'=>$_smarty_tpl->tpl_vars['filter']->value,'ajax_div_ids'=>$_smarty_tpl->tpl_vars['ajax_div_ids']->value,'dynamic'=>true,'filter_qstring'=>$_smarty_tpl->tpl_vars['filter_qstring']->value,'reset_qstring'=>$_smarty_tpl->tpl_vars['reset_qstring']->value,'allow_ajax'=>$_smarty_tpl->tpl_vars['allow_ajax']->value), 0);?>

            <?php }else{ ?>
                <?php echo $_smarty_tpl->getSubTemplate ("blocks/product_filters/components/product_filter_variants.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('filter_uid'=>$_smarty_tpl->tpl_vars['filter_uid']->value,'filter'=>$_smarty_tpl->tpl_vars['filter']->value,'ajax_div_ids'=>$_smarty_tpl->tpl_vars['ajax_div_ids']->value,'collapse'=>$_smarty_tpl->tpl_vars['collapse']->value,'filter_qstring'=>$_smarty_tpl->tpl_vars['filter_qstring']->value,'reset_qstring'=>$_smarty_tpl->tpl_vars['reset_qstring']->value,'allow_ajax'=>$_smarty_tpl->tpl_vars['allow_ajax']->value), 0);?>
...
<?php }?>" rel="nofollow" class="reset-filters<?php if ($_smarty_tpl->tpl_vars['allow_ajax']->value&&$_smarty_tpl->tpl_vars['use_ajax']->value){?> cm-ajax cm-ajax-full-render cm-history" data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ajax_div_ids']->value, ENT_QUOTES, 'UTF-8');?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="blocks/product_filters/original.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/product_filters/original.tpl"),$_smarty_tpl);?>
