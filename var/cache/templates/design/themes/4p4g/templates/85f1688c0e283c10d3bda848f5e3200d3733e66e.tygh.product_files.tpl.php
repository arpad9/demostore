<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:09:38
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/product_files.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1846176785522cf5a2e870b4-87902889%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '85f1688c0e283c10d3bda848f5e3200d3733e66e' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/products/components/product_files.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1846176785522cf5a2e870b4-87902889',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5a3045204_94838122',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5a3045204_94838122')) {function content_522cf5a3045204_94838122($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_formatfilesize')) include '/var/www/4profit4good/app/functions/smarty_plugins/modifier.formatfilesize.php';
...
<tr>
    <td style="width: 80%">
        <a href="<?php echo htmlspecialchars(fn_url("orders.get_file?file_id=".((string)$_smarty_tpl->tpl_vars['file']->value['file_id'])."&preview=Y"), ENT_QUOTES, 'UTF-8');?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/products/components/product_files.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/product_files.tpl"),$_smarty_tpl);?>
