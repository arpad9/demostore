<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:47:34
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/addons/gift_certificates/views/gift_certificates/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1263938682522dfba6e679c8-42671735%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2d4811b8169e5fb7ad2650531deaaeec839e5c49' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/addons/gift_certificates/views/gift_certificates/update.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1263938682522dfba6e679c8-42671735',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfba73eb967_44167749',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfba73eb967_44167749')) {function content_522dfba73eb967_44167749($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
<?php $_smarty_tpl->tpl_vars["max_amount"] = new Smarty_variable($_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['addons']->value['gift_certificates']['max_amount']), 0));?>

<?php $_smarty_tpl->tpl_vars["min_amount"] = new Smarty_variable($_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['addons']->value['gift_certificates']['min_amount']), 0));?>
...
<div class="control-group gift-cert-amount">
    ...
    <input type="text" id="gift_cert_amount" name="gift_cert_data[amount]" class="valign input-text-short inp-el cm-value-decimal" size="5" value="<?php if ($_smarty_tpl->tpl_vars['gift_cert_data']->value){?><?php echo htmlspecialchars(fn_format_rate_value($_smarty_tpl->tpl_vars['gift_cert_data']->value['amount'],'',$_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['secondary_currency']->value]['decimals'],".",'',$_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['secondary_currency']->value]['coefficient']), ENT_QUOTES, 'UTF-8');?>
...
<div class="control-group product-options">
    <?php if ($_smarty_tpl->tpl_vars['addons']->value['gift_certificates']['free_products_allow']=="Y"){?>
        <div class="info-field-body ">
            <?php echo $_smarty_tpl->getSubTemplate ("pickers/products/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_id'=>"free_products",'item_ids'=>$_smarty_tpl->tpl_vars['gift_cert_data']->value['products'],'input_name'=>"gift_cert_data[products]",'type'=>"table",'no_item_text'=>__("text_no_products_defined"),'holder_name'=>"gift_certificates",'but_role'=>"text",'but_text'=>__("gift_add_products"),'no_container'=>true,'icon_plus'=>true), 0);?>
...
" />
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"gift_certificates:buttons")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"gift_certificates:buttons"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/add_to_cart.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[gift_certificates.add]",'but_role'=>"action"), 0);?>
...
<?php }else{ ?>
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[gift_certificates.update]"), 0);?>

<?php }?>
<?php if ($_smarty_tpl->tpl_vars['templates']->value){?>
    <div class="float-right">
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("preview"),'but_name'=>"dispatch[gift_certificates.preview]",'but_meta'=>"cm-new-window",'but_role'=>"submit"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="addons/gift_certificates/views/gift_certificates/update.tpl" id="<?php echo smarty_function_set_id(array('name'=>"addons/gift_certificates/views/gift_certificates/update.tpl"),$_smarty_tpl);?>
