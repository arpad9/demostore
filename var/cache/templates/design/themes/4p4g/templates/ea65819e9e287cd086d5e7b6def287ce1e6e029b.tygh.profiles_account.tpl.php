<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 03:41:02
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/profiles/components/profiles_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1657868002522d0b0e9fb5b5-14297057%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea65819e9e287cd086d5e7b6def287ce1e6e029b' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/profiles/components/profiles_account.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1657868002522d0b0e9fb5b5-14297057',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d0b0eabca07_09261949',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d0b0eabca07_09261949')) {function content_522d0b0eabca07_09261949($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php if (!$_smarty_tpl->tpl_vars['nothing_extra']->value){?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("user_account_info")), 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['use_email_as_login']!="Y"){?>
    <div class="control-group">
        <label for="user_login_profile" class="cm-required cm-trim"><?php echo $_smarty_tpl->__("username");?>
</label>
...
<?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['use_email_as_login']=="Y"||$_smarty_tpl->tpl_vars['nothing_extra']->value||$_smarty_tpl->tpl_vars['runtime']->value['checkout']){?>
    <div class="control-group">
        <label for="email" class="cm-required cm-email cm-trim"><?php echo $_smarty_tpl->__("email");?>
</label>
...
<div class="control-group">
    ...
    <input type="password" id="password1" name="user_data[password1]" size="32" maxlength="32" value="<?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="update"){?>            <?php }?>" class="input-text cm-autocomplete-off" />
</div>

<div class="control-group">
    <label for="password2" class="cm-required cm-password"><?php echo $_smarty_tpl->__("confirm_password");?>
</label>
    <input type="password" id="password2" name="user_data[password2]" size="32" maxlength="32" value="<?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="update"){?>            <?php }?>" class="input-text cm-autocomplete-off" />
</div>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/profiles/components/profiles_account.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/profiles/components/profiles_account.tpl"),$_smarty_tpl);?>
