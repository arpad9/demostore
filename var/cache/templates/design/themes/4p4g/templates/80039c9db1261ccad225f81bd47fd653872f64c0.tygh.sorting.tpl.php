<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:09:44
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/common/sorting.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2100782631522cf5a8baa4e9-08324862%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '80039c9db1261ccad225f81bd47fd653872f64c0' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/common/sorting.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2100782631522cf5a8baa4e9-08324862',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5a8cc8177_11653340',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5a8cc8177_11653340')) {function content_522cf5a8cc8177_11653340($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.set_id.php';
?><?php
...
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><div class="dropdown-container">
    <span id="sw_elm_sort_fields" class="sort-dropdown cm-combination cm-combo-on"><a><?php echo $_smarty_tpl->__("sort_by_".((string)$_smarty_tpl->tpl_vars['search']->value['sort_by'])."_".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order']));?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="common/sorting.tpl" id="<?php echo smarty_function_set_id(array('name'=>"common/sorting.tpl"),$_smarty_tpl);?>
