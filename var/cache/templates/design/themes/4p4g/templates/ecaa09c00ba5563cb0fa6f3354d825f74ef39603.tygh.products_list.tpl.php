<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:47:42
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/blocks/list_templates/products_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1758994355522dfbae4f86a3-80258118%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ecaa09c00ba5563cb0fa6f3354d825f74ef39603' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/blocks/list_templates/products_list.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1758994355522dfbae4f86a3-80258118',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfbae8ed730_36175633',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfbae8ed730_36175633')) {function content_522dfbae8ed730_36175633($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
...
?><?php
fn_preload_lang_vars(array('save_discount','save_discount'));
?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/product_data.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product'=>$_smarty_tpl->tpl_vars['product']->value,'min_qty'=>true), 0);?>
...
&nbsp;<?php }?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['settings']->value['Appearance']['in_stock_field']=="N"){?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="blocks/list_templates/products_list.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/list_templates/products_list.tpl"),$_smarty_tpl);?>
