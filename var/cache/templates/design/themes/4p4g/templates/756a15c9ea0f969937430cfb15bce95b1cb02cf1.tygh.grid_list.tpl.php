<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:09:44
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/blocks/list_templates/grid_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:771768187522cf5a852a196-57345688%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '756a15c9ea0f969937430cfb15bce95b1cb02cf1' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/blocks/list_templates/grid_list.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '771768187522cf5a852a196-57345688',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5a8832556_96164860',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5a8832556_96164860')) {function content_522cf5a8832556_96164860($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
...
?>
<tr<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['sprod']['last']){?> class="row-border"<?php }?>>
...
%">
    <?php if ($_smarty_tpl->tpl_vars['product']->value){?>
        ...
        <tr class="valign-top">
            <td class="preview-image">
                <div class="preview-image-wrapper">
                    <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/product_icon.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product'=>$_smarty_tpl->tpl_vars['product']->value,'show_gallery'=>true), 0);?>
        ...
        <tr>
            ...
            <?php if ($_smarty_tpl->tpl_vars['item_number']->value=="Y"){?><span class="item-number"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['cur_number']->value, ENT_QUOTES, 'UTF-8');?>
...
&nbsp;<?php }?>
    ...
    <td class="product-spacer">&nbsp;</td>
<?php } ?>
<?php if ($_smarty_tpl->tpl_vars['show_empty']->value&&$_smarty_tpl->getVariable('smarty')->value['foreach']['sprod']['last']){?>
    <?php $_smarty_tpl->tpl_vars["iteration"] = new Smarty_variable($_smarty_tpl->getVariable('smarty')->value['foreach']['sproducts']['iteration'], null, 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"products:products_multicolumns_extra")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"products:products_multicolumns_extra"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['iteration']->value%$_smarty_tpl->tpl_vars['columns']->value!=0){?> 
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="blocks/list_templates/grid_list.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/list_templates/grid_list.tpl"),$_smarty_tpl);?>
