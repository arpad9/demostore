<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:09:39
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/common/tabsbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1274624415522cf5a3419f99-54344660%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5d531c5548ace0a4a87bf2c863e1df121864d3f1' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/common/tabsbox.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1274624415522cf5a3419f99-54344660',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5a35d0ea0_50771159',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5a35d0ea0_50771159')) {function content_522cf5a35d0ea0_50771159($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_empty_tabs')) include '/var/www/4profit4good/app/functions/smarty_plugins/modifier.empty_tabs.php';
...
" class="<?php if ($_smarty_tpl->tpl_vars['tab']->value['js']){?>cm-js<?php }elseif($_smarty_tpl->tpl_vars['tab']->value['ajax']){?>cm-js cm-ajax<?php }?><?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['active_tab']->value){?> cm-active<?php }?>"><a<?php if ($_smarty_tpl->tpl_vars['tab']->value['href']){?> href="<?php echo htmlspecialchars(fn_url($_smarty_tpl->tpl_vars['tab']->value['href']), ENT_QUOTES, 'UTF-8');?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="common/tabsbox.tpl" id="<?php echo smarty_function_set_id(array('name'=>"common/tabsbox.tpl"),$_smarty_tpl);?>
