<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 03:41:02
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/profiles/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1634640240522d0b0e5731a7-55912290%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '84ae5ded20f371f03f14966563a77dabadee6194' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/profiles/update.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1634640240522d0b0e5731a7-55912290',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d0b0e99aff8_13162999',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d0b0e99aff8_13162999')) {function content_522d0b0e99aff8_13162999($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"checkout:checkout_steps"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
            ...
            <?php $_smarty_tpl->tpl_vars["image_verification"] = new Smarty_variable($_smarty_tpl->getSubTemplate ("common/image_verification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option'=>"use_for_register",'align'=>"left"), 0));?>
            ...
            <div class="buttons-container left">
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/register_profile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[profiles.update]"), 0);?>

            </div>
        </form>
    </div>
    <?php $_smarty_tpl->_capture_stack[0][] = array("mainbox_title", null, null); ob_start(); ?><?php echo $_smarty_tpl->__("register_new_account");?>
                ...
                <?php $_smarty_tpl->_capture_stack[0][] = array("group", null, null); ob_start(); ?>
                    ...
                    <?php if ($_smarty_tpl->tpl_vars['profile_fields']->value['B']||$_smarty_tpl->tpl_vars['profile_fields']->value['S']){?>
                        <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['user_multiple_profiles']=="Y"&&$_smarty_tpl->tpl_vars['runtime']->value['mode']=="update"){?>
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/multiple_profiles.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('profile_id'=>$_smarty_tpl->tpl_vars['user_data']->value['profile_id']), 0);?>
                        ...
                        <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profile_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section'=>$_smarty_tpl->tpl_vars['first_section']->value,'body_id'=>'','ship_to_another'=>true,'title'=>$_smarty_tpl->tpl_vars['first_section_text']->value), 0);?>

                        <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profile_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section'=>$_smarty_tpl->tpl_vars['sec_section']->value,'body_id'=>$_smarty_tpl->tpl_vars['body_id']->value,'ship_to_another'=>$_smarty_tpl->tpl_vars['ship_to_another']->value,'title'=>$_smarty_tpl->tpl_vars['sec_section_text']->value,'address_flag'=>fn_compare_shipping_billing($_smarty_tpl->tpl_vars['profile_fields']->value)), 0);?>
                    ...
                    <?php echo $_smarty_tpl->getSubTemplate ("common/image_verification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option'=>"use_for_register",'align'=>"center"), 0);?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <div class="buttons-container left">
                    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['mode']=="add"){?>
                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/register_profile.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[profiles.update]",'but_id'=>"save_profile_but"), 0);?>

                    <?php }else{ ?>
                        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[profiles.update]",'but_id'=>"save_profile_but"), 0);?>

                        <input class="account-cancel" type="reset" name="reset" value="<?php echo $_smarty_tpl->__("revert");?>
" id="reset"/>
                    <?php }?>
                </div>
            </form>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['_link_text']->value, ENT_QUOTES, 'UTF-8');?>
                        ...
                        <tr class="table-footer">
                            <td colspan="<?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['allow_usergroup_signup']=="Y"){?>3<?php }else{ ?>2<?php }?>">&nbsp;</td>
                        </tr>
                        </table>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php $_smarty_tpl->_capture_stack[0][] = array("mainbox_title", null, null); ob_start(); ?><?php echo $_smarty_tpl->__("profile_details");?>
<?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/profiles/update.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/profiles/update.tpl"),$_smarty_tpl);?>
"><div class="cm-template-icon icon-edit hidden"></div><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<!--[/tpl_id]--></span><?php }else{ ?><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<?php }?><?php }?><?php }else{ ?><?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profiles_scripts.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
