<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:47:35
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/pickers/products/js.tpl" */ ?>
<?php /*%%SmartyHeaderCode:369927909522dfba76e4114-75159930%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1ae10f14b55019902412c6873e52055744477116' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/pickers/products/js.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '369927909522dfba76e4114-75159930',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfba781c2d1_64209927',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfba781c2d1_64209927')) {function content_522dfba781c2d1_64209927($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.set_id.php';
?><?php
fn_preload_lang_vars(array('remove','remove'));
?>
<?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><tr <?php if (!$_smarty_tpl->tpl_vars['clone']->value){?>id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['root_id']->value, ENT_QUOTES, 'UTF-8');?>
...
', 'p');" class="icon-delete-big" title="<?php echo $_smarty_tpl->__("remove");?>
"><i class="icon-cancel-circle"></i></a>
            <?php }?>
        </li>
        <?php if ($_smarty_tpl->tpl_vars['options']->value){?>
        <li><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['options']->value, ENT_QUOTES, 'UTF-8');?>
</li>
        <?php }?>
    </ul>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="pickers/products/js.tpl" id="<?php echo smarty_function_set_id(array('name'=>"pickers/products/js.tpl"),$_smarty_tpl);?>
"><div class="cm-template-icon icon-edit hidden"></div><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<!--[/tpl_id]--></span><?php }else{ ?><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<?php }?><?php }?><?php }else{ ?><tr <?php if (!$_smarty_tpl->tpl_vars['clone']->value){?>id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['root_id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['delete_id']->value, ENT_QUOTES, 'UTF-8');?>
" <?php }?>class="cm-js-item<?php if ($_smarty_tpl->tpl_vars['clone']->value){?> cm-clone hidden<?php }?>">
<td>
    <ul>
