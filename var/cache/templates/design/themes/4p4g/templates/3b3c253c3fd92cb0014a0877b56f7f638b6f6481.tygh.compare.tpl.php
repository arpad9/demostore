<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 20:48:46
         compiled from "/var/www/4profit4good/design/themes/4p4g/templates/views/product_features/compare.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1143524487522dfbee22e3e7-95190401%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3b3c253c3fd92cb0014a0877b56f7f638b6f6481' => 
    array (
      0 => '/var/www/4profit4good/design/themes/4p4g/templates/views/product_features/compare.tpl',
      1 => 1378674277,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1143524487522dfbee22e3e7-95190401',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522dfbee6f63d2_50542412',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522dfbee6f63d2_50542412')) {function content_522dfbee6f63d2_50542412($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
...
if (!is_callable('smarty_function_html_checkboxes')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.html_checkboxes.php';
if (!is_callable('smarty_function_set_id')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.set_id.php';
?><?php
fn_preload_lang_vars(array('no_products_selected','all_features','all_features','similar_only','similar_only','different_only','different_only','remove','remove','enter_your_price','contact_us_for_price','remove','clear_list','add_feature','add','compare','no_products_selected','all_features','all_features','similar_only','similar_only','different_only','different_only','remove','remove','enter_your_price','contact_us_for_price','remove','clear_list','add_feature','add','compare'));
?>
            ...
            <td>
                <div class="product">
                    <?php if (floatval($_smarty_tpl->tpl_vars['product']->value['price'])||$_smarty_tpl->tpl_vars['product']->value['zero_price_action']=="P"||($_smarty_tpl->tpl_vars['hide_add_to_cart_button']->value=="Y"&&$_smarty_tpl->tpl_vars['product']->value['zero_price_action']=="A")){?>
                        <span class="price<?php if (!floatval($_smarty_tpl->tpl_vars['product']->value['price'])){?> hidden<?php }?>" id="line_discounted_price_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_prefix']->value, ENT_QUOTES, 'UTF-8');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
"><?php if ($_smarty_tpl->tpl_vars['details_page']->value){?><?php }?><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['price'],'span_id'=>"discounted_price_".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']),'class'=>"price-num"), 0);?>
</span>
                    <?php }elseif($_smarty_tpl->tpl_vars['product']->value['zero_price_action']=="A"){?>
                        ...
                        <span class="price-curency"><?php echo $_smarty_tpl->__("enter_your_price");?>
...
<?php }?><input class="input-text-short" type="text" size="3" name="product_data[<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
$_smarty_tpl->tpl_vars['product']->_loop = true;
?>
                    <td><?php echo $_smarty_tpl->getSubTemplate ("blocks/list_templates/simple_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('min_qty'=>true,'product'=>$_smarty_tpl->tpl_vars['product']->value,'show_add_to_cart'=>true,'but_role'=>"action"), 0);?>
</td>
                <?php } ?>
            </tr>
        </table>
...
<?php }?>
    ...
    <div class="compare-buttons">
        <div class="buttons-container">
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("clear_list"),'but_href'=>"product_features.clear_list?redirect_url=".((string)$_smarty_tpl->tpl_vars['r_url']->value)), 0);?>
&nbsp;&nbsp;&nbsp;
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/continue_shopping.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_href'=>fn_url($_smarty_tpl->tpl_vars['continue_url']->value),'but_role'=>"text"), 0);?>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("add_feature")), 0);?>
...
" />
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("add"),'but_name'=>"dispatch[product_features.add_feature]"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/product_features/compare.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/product_features/compare.tpl"),$_smarty_tpl);?>
