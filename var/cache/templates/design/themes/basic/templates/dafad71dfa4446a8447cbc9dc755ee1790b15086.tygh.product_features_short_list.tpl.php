<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 06:33:07
         compiled from "/var/www/4profit4good/design/themes/basic/templates/views/products/components/product_features_short_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2101933004522d336336d341-09793505%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'dafad71dfa4446a8447cbc9dc755ee1790b15086' => 
    array (
      0 => '/var/www/4profit4good/design/themes/basic/templates/views/products/components/product_features_short_list.tpl',
      1 => 1378672733,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2101933004522d336336d341-09793505',
  'function' => 
  array (
    'feature_value' => 
    array (
  ...
  'unifunc' => 'content_522d33635a53b9_26360298',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d33635a53b9_26360298')) {function content_522d33635a53b9_26360298($_smarty_tpl) {?><?php if (!is_callable('smarty_function_set_id')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.set_id.php';
?><?php if ($_smarty_tpl->tpl_vars['runtime']->value['customization_mode']['design']=="Y"&&@constant('AREA')=="C"){?><?php $_smarty_tpl->_capture_stack[0][] = array("template_content", null, null); ob_start(); ?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/modifier.date_format.php';
...
<?php if (!$_smarty_tpl->tpl_vars['no_container']->value){?><p class="features-list description"><?php }?>
...
?>
        <?php if ($_smarty_tpl->tpl_vars['feature']->value['feature_type']=="D"||$_smarty_tpl->tpl_vars['feature']->value['feature_type']=="O"||$_smarty_tpl->tpl_vars['feature']->value['feature_type']=="N"){?>
            <?php echo $_smarty_tpl->tpl_vars['feature']->value['description'];?>
: 
        <?php }?>
        <?php smarty_template_function_feature_value($_smarty_tpl,array('feature'=>$_smarty_tpl->tpl_vars['feature']->value));?>
<?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['features_list']['last']){?>, <?php }?>
    <?php } ?>
<?php if (!$_smarty_tpl->tpl_vars['no_container']->value){?></p><?php }?>
...
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="views/products/components/product_features_short_list.tpl" id="<?php echo smarty_function_set_id(array('name'=>"views/products/components/product_features_short_list.tpl"),$_smarty_tpl);?>
"><div class="cm-template-icon icon-edit hidden"></div><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<!--[/tpl_id]--></span><?php }else{ ?><?php echo Smarty::$_smarty_vars['capture']['template_content'];?>
<?php }?><?php }?><?php }else{ ?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/modifier.date_format.php';
?><?php if (!function_exists('smarty_template_function_feature_value')) {
    function smarty_template_function_feature_value($_smarty_tpl,$params) {
    $saved_tpl_vars = $_smarty_tpl->tpl_vars;
    foreach ($_smarty_tpl->smarty->template_functions['feature_value']['parameter'] as $key => $value) {$_smarty_tpl->tpl_vars[$key] = new Smarty_variable($value);};
