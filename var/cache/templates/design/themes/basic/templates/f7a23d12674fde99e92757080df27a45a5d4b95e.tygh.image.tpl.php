<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 06:33:05
         compiled from "/var/www/4profit4good/design/themes/basic/templates/common/image.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1749387557522d3361148617-24633109%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f7a23d12674fde99e92757080df27a45a5d4b95e' => 
    array (
      0 => '/var/www/4profit4good/design/themes/basic/templates/common/image.tpl',
      1 => 1378672733,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1749387557522d3361148617-24633109',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d336136a196_85713609',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d336136a196_85713609')) {function content_522d336136a196_85713609($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
...
<?php }?><?php $_smarty_tpl->tpl_vars['image_data'] = new Smarty_variable(fn_image_to_display($_smarty_tpl->tpl_vars['images']->value,$_smarty_tpl->tpl_vars['image_width']->value,$_smarty_tpl->tpl_vars['image_height']->value), null, 0);?><?php $_smarty_tpl->tpl_vars['generate_image'] = new Smarty_variable($_smarty_tpl->tpl_vars['image_data']->value['generate_image']&&!$_smarty_tpl->tpl_vars['external']->value, null, 0);?><?php if (!$_smarty_tpl->tpl_vars['hide_if_no_image']->value){?><?php if ($_smarty_tpl->tpl_vars['show_detailed_link']->value){?><a id="det_img_link_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['obj_id']->value, ENT_QUOTES, 'UTF-8');?>
...
"<?php }?> class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link_class']->value, ENT_QUOTES, 'UTF-8');?>
 <?php if ($_smarty_tpl->tpl_vars['image_data']->value['detailed_image_path']){?>cm-previewer<?php }?>" <?php if ($_smarty_tpl->tpl_vars['image_data']->value['detailed_image_path']){?>href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['image_data']->value['detailed_image_path'], ENT_QUOTES, 'UTF-8');?>
...
"></i></div><?php }?><?php if ($_smarty_tpl->tpl_vars['show_detailed_link']->value){?><?php if ($_smarty_tpl->tpl_vars['images']->value['detailed_id']){?><span class="view-larger-image"></span><?php }?></a><?php }?><?php }?><?php if ($_smarty_tpl->tpl_vars['capture_image']->value){?><?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="common/image.tpl" id="<?php echo smarty_function_set_id(array('name'=>"common/image.tpl"),$_smarty_tpl);?>
