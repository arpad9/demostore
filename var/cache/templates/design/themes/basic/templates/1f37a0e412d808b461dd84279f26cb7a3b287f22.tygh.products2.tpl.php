<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 06:33:07
         compiled from "/var/www/4profit4good/design/themes/basic/templates/blocks/list_templates/products2.tpl" */ ?>
<?php /*%%SmartyHeaderCode:875301450522d336398ae86-37426685%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '1f37a0e412d808b461dd84279f26cb7a3b287f22' => 
    array (
      0 => '/var/www/4profit4good/design/themes/basic/templates/blocks/list_templates/products2.tpl',
      1 => 1378672733,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '875301450522d336398ae86-37426685',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d3363c22711_36867721',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d3363c22711_36867721')) {function content_522d3363c22711_36867721($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.split.php';
...
?>
    <?php if ($_smarty_tpl->tpl_vars['product']->value){?>
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array($_smarty_tpl->tpl_vars['obj_id']->value, null, null); ob_start(); ?>
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_role'=>"text",'but_href'=>"products.view?product_id=".((string)$_smarty_tpl->tpl_vars['product']->value['product_id']),'but_text'=>__("more_info")), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("common/product_data.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product'=>$_smarty_tpl->tpl_vars['product']->value,'extra_button'=>Smarty::$_smarty_vars['capture'][$_smarty_tpl->tpl_vars['obj_id']->value]), 0);?>
...
"><?php echo $_smarty_tpl->getSubTemplate ("common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image_width'=>"70",'image_height'=>"70",'images'=>$_smarty_tpl->tpl_vars['product']->value['main_pair'],'obj_id'=>$_smarty_tpl->tpl_vars['obj_id_prefix']->value), 0);?>
</a>
                    </div>
...
&nbsp;<?php }?>
        ...
        <?php if (!$_smarty_tpl->getVariable('smarty')->value['foreach']['sproducts']['last']){?>
            <td class="delimiter"><img src="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['images_dir']->value, ENT_QUOTES, 'UTF-8');?>
/icons/spacer.gif" width="13" height="1" alt=""></td>
        <?php }?>
    <?php }?>
    <?php } ?>
    <td class="lm-left">&nbsp;</td>
...
if (!empty($_capture_buffer)) {
 ...
 if (isset( $_capture_append)) $_smarty_tpl->append( $_capture_append, ob_get_contents());
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
} else $_smarty_tpl->capture_error();?><?php if (trim(Smarty::$_smarty_vars['capture']['template_content'])){?><?php if ($_smarty_tpl->tpl_vars['auth']->value['area']=="A"){?><span class="cm-template-box" data-ca-te-template="blocks/list_templates/products2.tpl" id="<?php echo smarty_function_set_id(array('name'=>"blocks/list_templates/products2.tpl"),$_smarty_tpl);?>
