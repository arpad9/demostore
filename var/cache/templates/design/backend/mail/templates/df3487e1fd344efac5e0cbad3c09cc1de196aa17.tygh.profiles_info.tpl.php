<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 02:42:22
         compiled from "/var/www/4profit4good/design/backend/mail/templates/profiles/profiles_info.tpl" */ ?>
<?php /*%%SmartyHeaderCode:20885522405232434e870c09-96855337%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'df3487e1fd344efac5e0cbad3c09cc1de196aa17' => 
    array (
      0 => '/var/www/4profit4good/design/backend/mail/templates/profiles/profiles_info.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '20885522405232434e870c09-96855337',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_5232434e970422_50149511',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_5232434e970422_50149511')) {function content_5232434e970422_50149511($_smarty_tpl) {?><?php if (!is_callable('smarty_function_split')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.split.php';
?><?php
...
<?php if (!$_smarty_tpl->tpl_vars['send_password']->value){?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['profile_fields']->value['C']){?>
        <tr>
            <td valign="top" width="50%">
                <table>
                    <?php echo $_smarty_tpl->getSubTemplate ("profiles/profile_fields_info.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('fields'=>$_smarty_tpl->tpl_vars['contact_fields']->value[0],'title'=>__("contact_information")), 0);?>
            ...
            <td valign="top" width="49%">
                ...
                <table>
                    <?php echo $_smarty_tpl->getSubTemplate ("profiles/profile_fields_info.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('fields'=>$_smarty_tpl->tpl_vars['contact_fields']->value[1]), 0);?>
    ...
    <tr>
        ...
        <?php if ($_smarty_tpl->tpl_vars['profile_fields']->value['B']){?>
            <p></p>
            <table>
                <?php echo $_smarty_tpl->getSubTemplate ("profiles/profile_fields_info.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('fields'=>$_smarty_tpl->tpl_vars['profile_fields']->value['B'],'title'=>__("billing_address")), 0);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['profile_fields']->value['S']){?>
            <p></p>
            <table>
                <?php echo $_smarty_tpl->getSubTemplate ("profiles/profile_fields_info.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('fields'=>$_smarty_tpl->tpl_vars['profile_fields']->value['S'],'title'=>__("shipping_address")), 0);?>
