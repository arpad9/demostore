<?php /* Smarty version Smarty-3.1.13, created on 2013-09-15 07:31:20
         compiled from "/var/www/4profit4good/design/backend/templates/views/products/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:187955738952352a08bd23b6-40601501%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2a81923d6f423d8cecff2394c7e1cfed40a69d71' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/products/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '187955738952352a08bd23b6-40601501',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52352a09292dd1_27269535',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52352a09292dd1_27269535')) {function content_52352a09292dd1_27269535($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
if (!is_callable('smarty_modifier_in_array')) include '/var/www/4profit4good/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
fn_preload_lang_vars(array('information','name','text_ult_product_store_field_tooltip','categories','tt_views_products_update_categories','price','full_description','images','text_product_thumbnail','text_product_detailed_image','options_settings','options_type','simultaneous','sequential','exceptions_type','forbidden','allowed','pricing_inventory','sku','list_price','tt_views_products_update_list_price','in_stock','edit','zero_price_action','zpa_refuse','zpa_permit','zpa_ask_price','inventory','tt_views_products_update_inventory','track_with_options','track_without_options','dont_track','min_order_qty','max_order_qty','quantity_step','list_quantity_count','taxes','seo_meta_data','page_title','ttc_page_title','meta_description','meta_keywords','availability','usergroups','ttc_usergroups','creation_date','available_since','out_of_stock_actions','tt_views_products_update_out_of_stock_actions','none','buy_in_advance','sign_up_for_notification','extra','product_details_layout','tt_views_products_update_product_details_layout','feature_comparison','downloadable','edp_enable_shipping','time_unlimited_download','short_description','popularity','ttc_popularity','search_words','promo_text','additional_images','sort_images','sort','additional_thumbnail','additional_popup_larger_image','text_additional_thumbnail','text_additional_detailed_image','additional_thumbnail','additional_popup_larger_image','text_additional_thumbnail','text_additional_detailed_image','preview','preview_as_admin','clone','delete','editing_product','new_product'));
?>
...
" />
            ...
            <div class="product-manage" id="content_detailed"> 
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("information"),'target'=>"#acc_information"), 0);?>
...
" />
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'product','name'=>"update_all_vendors[product]"), 0);?>
                    ...
                    <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_field.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"product_data[company_id]",'id'=>"product_data_company_id",'selected'=>$_smarty_tpl->tpl_vars['product_data']->value['company_id'],'tooltip'=>$_smarty_tpl->tpl_vars['companies_tooltip']->value,'reload_form'=>$_smarty_tpl->tpl_vars['reload_form']->value), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_products_update_categories")), 0);?>
</label>
                        <div class="controls">
                            <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('hide_input'=>$_smarty_tpl->tpl_vars['product_data']->value['shared_product'],'company_ids'=>$_smarty_tpl->tpl_vars['product_data']->value['company_id'],'rnd'=>$_smarty_tpl->tpl_vars['rnd']->value,'data_id'=>"categories",'input_name'=>"product_data[category_ids]",'radio_input_name'=>"product_data[main_category]",'main_category'=>$_smarty_tpl->tpl_vars['product_data']->value['main_category'],'item_ids'=>(($tmp = @$_smarty_tpl->tpl_vars['product_data']->value['category_ids'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['request_category_id']->value : $tmp),'hide_link'=>true,'hide_delete_button'=>true,'display_input_id'=>"category_ids",'disable_no_item_text'=>true,'view_mode'=>"list",'but_meta'=>"btn"), 0);?>
...
" class="input-long" />
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'price','name'=>"update_all_vendors[price]"), 0);?>
...
:</label>
                        <div class="controls">
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'full_description','name'=>"update_all_vendors[full_description]"), 0);?>
                    ...
                    <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"product_data[status]",'id'=>"elm_product_status",'obj'=>$_smarty_tpl->tpl_vars['product_data']->value,'hidden'=>true), 0);?>
...
:</label>
                        <div class="controls">
                            <?php echo $_smarty_tpl->getSubTemplate ("common/attach_images.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image_name'=>"product_main",'image_object_type'=>"product",'image_pair'=>$_smarty_tpl->tpl_vars['product_data']->value['main_pair'],'icon_text'=>__("text_product_thumbnail"),'detailed_text'=>__("text_product_detailed_image"),'no_thumbnail'=>true), 0);?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("options_settings"),'target'=>"#acc_options"), 0);?>
...
:</label>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("pricing_inventory"),'target'=>"#acc_pricing_inventory"), 0);?>
...
" class="input-long" />
 ...
 (<?php echo $_smarty_tpl->tpl_vars['currencies']->value[$_smarty_tpl->tpl_vars['primary_currency']->value]['symbol'];?>
) <?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_products_update_list_price")), 0);?>
:</label>
                        <div class="controls">
...
:</label>
                        <div class="controls">
                            <?php if ($_smarty_tpl->tpl_vars['product_data']->value['tracking']=="O"){?>
                                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("edit"),'but_href'=>"product_options.inventory?product_id=".((string)$_smarty_tpl->tpl_vars['id']->value),'but_role'=>"edit"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_products_update_inventory")), 0);?>
:</label>
                        <div class="controls">
...
?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("seo_meta_data"),'target'=>"#acc_seo_meta"), 0);?>
...
" class="input-large" />
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>"page_title",'name'=>"update_all_vendors[page_title]"), 0);?>
...
:</label>
                        <div class="controls">
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>"meta_description",'name'=>"update_all_vendors[meta_description]"), 0);?>
...
:</label>
                        <div class="controls">
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>"meta_keywords",'name'=>"update_all_vendors[meta_keywords]"), 0);?>
                ...
                <hr>
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("availability"),'target'=>"#acc_availability"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_products_update_out_of_stock_actions")), 0);?>
:</label>
                        <div class="controls">
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("extra"),'target'=>"#acc_extra"), 0);?>

                <div id="acc_extra" class="collapse in">
                    <div class="control-group">
                        <label class="control-label" for="elm_details_layout"><?php echo $_smarty_tpl->__("product_details_layout");?>
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_products_update_product_details_layout")), 0);?>
:</label>
                        <div class="controls">
...
:</label>
                    ...
                    <?php echo $_smarty_tpl->getSubTemplate ("views/localizations/components/select.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_from'=>$_smarty_tpl->tpl_vars['product_data']->value['localization'],'data_name'=>"product_data[localization]"), 0);?>
...
:</label>
                        <div class="controls">
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>"short_description",'name'=>"update_all_vendors[short_description]"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("ttc_popularity")), 0);?>
:</label>
                        <div class="controls">
...
:</label>
                        <div class="controls">
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>'search_words','name'=>"update_all_vendors[search_words]"), 0);?>
...
:</label>
                        <div class="controls">
                            ...
                            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>"promo_text",'name'=>"update_all_vendors[promo_text]"), 0);?>
            ...
            <div id="content_images" class="hidden clearfix"> 
                <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("additional_images")), 0);?>
...
" class="valign" /></div>
                                <div class="sortable-item">
                                    <?php echo $_smarty_tpl->getSubTemplate ("common/attach_images.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image_name'=>"product_additional",'image_object_type'=>"product",'image_key'=>$_smarty_tpl->tpl_vars['pair']->value['pair_id'],'image_type'=>"A",'image_pair'=>$_smarty_tpl->tpl_vars['pair']->value,'icon_title'=>__("additional_thumbnail"),'detailed_title'=>__("additional_popup_larger_image"),'icon_text'=>__("text_additional_thumbnail"),'detailed_text'=>__("text_additional_detailed_image"),'delete_pair'=>true,'no_thumbnail'=>true), 0);?>
...
" class="cm-image-field" />
                        <div class="image-upload-wrap pull-left"><?php echo $_smarty_tpl->getSubTemplate ("common/attach_images.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image_name'=>"product_add_additional",'image_object_type'=>"product",'image_type'=>"A",'icon_title'=>__("additional_thumbnail"),'detailed_title'=>__("additional_popup_larger_image"),'icon_text'=>__("text_additional_thumbnail"),'detailed_text'=>__("text_additional_detailed_image"),'no_thumbnail'=>true), 0);?>
</div>
                        <div class="pull-right"><?php echo $_smarty_tpl->getSubTemplate ("buttons/multiple_buttons.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('item_id'=>"new_image"), 0);?>
</div>
                    </div>
                </div>
            ...
            <div id="content_shippings" class="hidden"> 
                <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/products_shipping_settings.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/products_update_qty_discounts.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/products_update_features.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
            ...
            <?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/view_tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('url'=>"products.update?product_id="), 0);?>

                <?php if (!fn_allowed_for("ULTIMATE")){?>
                    <?php $_smarty_tpl->tpl_vars["view_uri"] = new Smarty_variable("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['id']->value), null, 0);?>
                    <?php $_smarty_tpl->tpl_vars["view_uri_escaped"] = new Smarty_variable(rawurlencode(fn_url(((string)$_smarty_tpl->tpl_vars['view_uri']->value)."&action=preview",'C','http',@constant('DESCR_SL'))), null, 0);?>
                <?php }?>
                ...
                <?php if (fn_allowed_for("ULTIMATE")){?>
                    ...
                    <?php }else{ ?>
                        <?php $_smarty_tpl->tpl_vars["company_id"] = new Smarty_variable($_smarty_tpl->tpl_vars['product_data']->value['company_id'], null, 0);?>
                    <?php }?>
                    <?php $_smarty_tpl->tpl_vars["view_uri"] = new Smarty_variable("products.view?product_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&company_id=".((string)$_smarty_tpl->tpl_vars['company_id']->value), null, 0);?>
                    <?php $_smarty_tpl->tpl_vars["view_uri_escaped"] = new Smarty_variable(rawurlencode(fn_url(((string)$_smarty_tpl->tpl_vars['view_uri']->value)."&action=preview",'C','http',@constant('DESCR_SL'))), null, 0);?>
                <?php }?>
                <?php $_smarty_tpl->tpl_vars['view_uri'] = new Smarty_variable(fn_url($_smarty_tpl->tpl_vars['view_uri']->value,'C','http',@constant('DESCR_SL')), null, 0);?>
                <?php if ($_smarty_tpl->tpl_vars['id']->value){?>
                    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
                        ...
                        <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'target'=>"_blank",'text'=>__("preview_as_admin"),'href'=>"profiles.act_as_user?user_id=".((string)$_smarty_tpl->tpl_vars['auth']->value['user_id'])."&area=C&redirect_url=".((string)$_smarty_tpl->tpl_vars['view_uri_escaped']->value)));?>
</li>
                        <li class="divider"></li>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <?php }?>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_role'=>"submit-link",'but_name'=>"dispatch[products.update]",'but_target_form'=>"product_update_form",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:tabs_extra"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['id']->value){?>
            ...
            <div class="cm-hide-save-button hidden" id="content_options">
                <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/products_update_options.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
            ...
            <div id="content_files" class="cm-hide-save-button hidden">
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/products_update_files.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
            ...
            <div id="content_subscribers" class="cm-hide-save-button hidden">
                <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/product_subscribers.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product_id'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/tabsbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('content'=>Smarty::$_smarty_vars['capture']['tabsbox'],'group_name'=>$_smarty_tpl->tpl_vars['runtime']->value['controller'],'active_tab'=>$_REQUEST['selected_section'],'track'=>true), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>Smarty::$_smarty_vars['capture']['mainbox_title'],'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>$_smarty_tpl->tpl_vars['id']->value,'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons']), 0);?>
<?php }} ?>