<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 01:51:07
         compiled from "/var/www/4profit4good/design/backend/templates/views/block_manager/update_block.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1655263188522cf14b8c9585-20550281%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '647fe71f1edd8162e481684af3247b8d70a32277' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/block_manager/update_block.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1655263188522cf14b8c9585-20550281',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf14bc083a9_13760860',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf14bc083a9_13760860')) {function content_522cf14bc083a9_13760860($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_function_include_ext')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.include_ext.php';
?><?php
...
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_general_".((string)$_smarty_tpl->tpl_vars['html_id']->value)){?> cm-active active<?php }?>"><a><?php echo $_smarty_tpl->__("general");?>
</a></li>
...
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_contents_".((string)$_smarty_tpl->tpl_vars['html_id']->value)){?> cm-active active<?php }?>"><a><?php echo $_smarty_tpl->__("content");?>
</a></li><?php }?>
...
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_settings_".((string)$_smarty_tpl->tpl_vars['html_id']->value)){?> cm-active active<?php }?>"><a><?php echo $_smarty_tpl->__("block_settings");?>
</a></li>
            <?php }?>
...
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_status_".((string)$_smarty_tpl->tpl_vars['html_id']->value)){?> cm-active active<?php }?>"><a><?php echo $_smarty_tpl->__("status");?>
</a></li>
            <?php }?>
        </ul>
    </div>
...
" <?php if ($_smarty_tpl->tpl_vars['block']->value['properties']['template']==$_smarty_tpl->tpl_vars['k']->value){?>selected="selected"<?php }?>><?php if ($_smarty_tpl->tpl_vars['v']->value['name']){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['v']->value['name'], ENT_QUOTES, 'UTF-8');?>
<?php }else{ ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['k']->value, ENT_QUOTES, 'UTF-8');?>
<?php }?></option>
                            <?php } ?>
                        </select>
                    <?php }?>
...
?>
                    <?php echo $_smarty_tpl->getSubTemplate ("views/block_manager/components/setting_element.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option'=>$_smarty_tpl->tpl_vars['setting_data']->value,'name'=>$_smarty_tpl->tpl_vars['name']->value,'block'=>$_smarty_tpl->tpl_vars['block']->value,'html_id'=>"block_".((string)$_smarty_tpl->tpl_vars['html_id']->value)."_properties_".((string)$_smarty_tpl->tpl_vars['name']->value),'html_name'=>"block_data[properties][".((string)$_smarty_tpl->tpl_vars['name']->value)."]",'editable'=>$_smarty_tpl->tpl_vars['editable_template_name']->value,'value'=>$_smarty_tpl->tpl_vars['block']->value['properties'][$_smarty_tpl->tpl_vars['name']->value]), 0);?>
...
" class="cm-no-hide-input" />
                ...
                <?php $_smarty_tpl->_capture_stack[0][] = array("content_stat", null, null); ob_start(); ?><?php  $_smarty_tpl->tpl_vars['stat'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['stat']->_loop = false;
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_block_manager_update_block_override_by_this")), 0);?>
</label>
                    <div class="controls">
...
:</label>
                <div class="controls">
                    <p>
                        <?php if ($_smarty_tpl->tpl_vars['block']->value['status']=='A'){?><?php echo $_smarty_tpl->__("active");?>
...
" />
            <div class="control-group cm-no-hide-input">                        
                <label class="control-label"><?php if ($_smarty_tpl->tpl_vars['block']->value['status']=='A'){?><?php echo $_smarty_tpl->__("disable_for");?>
<?php }else{ ?><?php echo $_smarty_tpl->__("enable_for");?>
<?php }?></label>
                <div class="controls">
...
--></div>
    <div class="buttons-container">
        <?php if ($_REQUEST['force_close']){?>
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[block_manager.update_block]",'cancel_action'=>"close",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
