<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:21:23
         compiled from "/var/www/4profit4good/design/backend/templates/views/categories/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:744470122522cf86345bc32-57451958%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '28d09c3aca43372a7611004dc7c12bfc3920c3f2' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/categories/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '744470122522cf86345bc32-57451958',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf86377afc4_51592050',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf86377afc4_51592050')) {function content_522cf86377afc4_51592050($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('information','name','location','root_level','location','root_level','description','seo_meta_data','page_title','ttc_page_title','meta_description','meta_keywords','availability','usergroups','ttc_usergroups','to_all_subcats','position','creation_date','product_details_layout','tt_views_categories_update_product_details_layout','use_custom_layout','product_columns','available_layouts','default_category_layout','add_subcategory','add_product','preview','preview_as_admin','view_products','delete_this_category','new_category','editing_category'));
?>
...
:</label>
            <div class="controls">
                <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_id'=>"location_category",'input_name'=>"category_data[parent_id]",'item_ids'=>(($tmp = @$_smarty_tpl->tpl_vars['category_data']->value['parent_id'])===null||$tmp==='' ? "0" : $tmp),'hide_link'=>true,'hide_delete_button'=>true,'show_root'=>true,'default_name'=>__("root_level"),'display_input_id'=>"elm_category_parent_id",'except_id'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
:</label>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"category_data[status]",'id'=>"elm_category_status",'obj'=>$_smarty_tpl->tpl_vars['category_data']->value,'hidden'=>true), 0);?>


    <?php if (fn_allowed_for("ULTIMATE")){?>
    <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_field.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"category_data[company_id]",'id'=>"category_data_company_id",'selected'=>$_smarty_tpl->tpl_vars['category_data']->value['company_id']), 0);?>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("seo_meta_data"),'target'=>"#acc_seo"), 0);?>
...
:</label>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("views/localizations/components/select.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_from'=>$_smarty_tpl->tpl_vars['category_data']->value['localization'],'data_name'=>"category_data[localization]"), 0);?>
...
<div id="content_layout">
    <div id="extra">
        <div class="control-group">
            <label class="control-label" for="elm_category_product_layout"><?php echo $_smarty_tpl->__("product_details_layout");?>
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_categories_update_product_details_layout")), 0);?>
:</label>
            <div class="controls">
...
?>
                    <option <?php if ($_smarty_tpl->tpl_vars['category_data']->value['product_details_layout']==$_smarty_tpl->tpl_vars['layout']->value){?>selected="selected"<?php }?> value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value, ENT_QUOTES, 'UTF-8');?>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_category_use_custom_templates"><?php echo $_smarty_tpl->__("use_custom_layout");?>
:</label>
            <div class="controls">
            <input type="hidden" value="N" name="category_data[use_custom_templates]"/>
            <input type="checkbox" class="cm-toggle-checkbox" value="Y" name="category_data[use_custom_templates]" id="elm_category_use_custom_templates"<?php if ($_smarty_tpl->tpl_vars['category_data']->value['selected_layouts']){?> checked="checked"<?php }?> />
            </div>
        </div>
...
" class="cm-toggle-element" <?php if (!$_smarty_tpl->tpl_vars['category_data']->value['selected_layouts']){?>disabled="disabled"<?php }?> />
            </div>
        </div>

        <?php $_smarty_tpl->tpl_vars["layouts"] = new Smarty_variable(fn_get_products_views('',false,false), null, 0);?>
        <div class="control-group">
            <label class="control-label"><?php echo $_smarty_tpl->__("available_layouts");?>
:</label>
            <div class="controls">
                <?php  $_smarty_tpl->tpl_vars["item"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["item"]->_loop = false;
 $_smarty_tpl->tpl_vars["layout"] = new Smarty_Variable;
...
"><input type="checkbox" class="cm-combo-checkbox cm-toggle-element" name="category_data[selected_layouts][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'UTF-8');?>
...
" <?php if (($_smarty_tpl->tpl_vars['category_data']->value['selected_layouts'][$_smarty_tpl->tpl_vars['layout']->value])||(!$_smarty_tpl->tpl_vars['category_data']->value['selected_layouts']&&$_smarty_tpl->tpl_vars['item']->value['active'])){?>checked="checked"<?php }?> <?php if (!$_smarty_tpl->tpl_vars['category_data']->value['selected_layouts']){?>disabled="disabled"<?php }?> /><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item']->value['title'], ENT_QUOTES, 'UTF-8');?>
</label>
                <?php } ?>
            </div>
        </div>
        ...
        <div class="control-group">
            <label class="control-label" for="elm_category_default_layout"><?php echo $_smarty_tpl->__("default_category_layout");?>
:</label>
            <div class="controls">
            <select id="elm_category_default_layout" class="cm-combo-select cm-toggle-element" name="category_data[default_layout]" <?php if (!$_smarty_tpl->tpl_vars['category_data']->value['selected_layouts']){?>disabled="disabled"<?php }?>>
                <?php  $_smarty_tpl->tpl_vars["item"] = new Smarty_Variable; $_smarty_tpl->tpl_vars["item"]->_loop = false;
 $_smarty_tpl->tpl_vars["layout"] = new Smarty_Variable;
 $_from = $_smarty_tpl->tpl_vars['layouts']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars["item"]->key => $_smarty_tpl->tpl_vars["item"]->value){
...
?>
                    <?php if (($_smarty_tpl->tpl_vars['category_data']->value['selected_layouts'][$_smarty_tpl->tpl_vars['layout']->value])||(!$_smarty_tpl->tpl_vars['category_data']->value['selected_layouts']&&$_smarty_tpl->tpl_vars['item']->value['active'])){?>
                        <option <?php if ($_smarty_tpl->tpl_vars['category_data']->value['default_layout']==$_smarty_tpl->tpl_vars['layout']->value){?>selected="selected"<?php }?> value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['layout']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php if ($_smarty_tpl->tpl_vars['id']->value){?>
        <?php echo $_smarty_tpl->getSubTemplate ("common/view_tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('url'=>"categories.update?category_id="), 0);?>


        <?php $_smarty_tpl->_capture_stack[0][] = array("preview", null, null); ob_start(); ?>
            <?php if (!fn_allowed_for("ULTIMATE")){?>
                <?php $_smarty_tpl->tpl_vars["view_uri"] = new Smarty_variable("categories.view?category_id=".((string)$_smarty_tpl->tpl_vars['id']->value), null, 0);?>
        ...
        <?php if (fn_allowed_for("ULTIMATE")){?>
            <?php $_smarty_tpl->tpl_vars["view_uri"] = new Smarty_variable("categories.view?category_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&company_id=".((string)$_smarty_tpl->tpl_vars['category_data']->value['company_id']), null, 0);?>
            <?php $_smarty_tpl->tpl_vars["view_uri_escaped"] = new Smarty_variable(rawurlencode(fn_url(((string)$_smarty_tpl->tpl_vars['view_uri']->value)."&action=preview",'C','http',@constant('DESCR_SL'))), null, 0);?>
        <?php }?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            ...
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'target'=>"_blank",'text'=>__("preview"),'href'=>fn_url($_smarty_tpl->tpl_vars['view_uri']->value,'C','http',@constant('DESCR_SL'))));?>
</li>
            ...
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-confirm",'text'=>__("delete_this_category"),'href'=>"categories.delete?category_id=".((string)$_smarty_tpl->tpl_vars['id']->value)));?>
</li>
        <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php }?>
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_role'=>"submit-link",'but_target_form'=>"category_update_form",'but_name'=>"dispatch[categories.update]",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
<?php if (!$_smarty_tpl->tpl_vars['id']->value){?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("new_category"),'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>

<?php }else{ ?>
    <?php ob_start();?><?php echo $_smarty_tpl->__("editing_category");?>
<?php $_tmp1=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'title'=>$_tmp1.": ".((string)$_smarty_tpl->tpl_vars['category_data']->value['category']),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>true,'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons']), 0);?>
