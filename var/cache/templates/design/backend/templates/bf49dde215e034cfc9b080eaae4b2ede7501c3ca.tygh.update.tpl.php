<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 09:13:30
         compiled from "/var/www/4profit4good/design/backend/templates/views/addons/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:895955075522d58fa44dca4-66310344%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'bf49dde215e034cfc9b080eaae4b2ede7501c3ca' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/addons/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '895955075522d58fa44dca4-66310344',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d58fa584615_88941740',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d58fa584615_88941740')) {function content_522d58fa584615_88941740($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
...
">
    <div class="tabs cm-j-tabs <?php if (count($_smarty_tpl->tpl_vars['subsections']->value)==1){?>hidden<?php }?>">
...
?>
                ...
                <li class="cm-js <?php if ($_REQUEST['selected_section']==$_smarty_tpl->tpl_vars['tab_id']->value){?>cm-active active<?php }?>" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['tab_id']->value, ENT_QUOTES, 'UTF-8');?>
...
if (!empty($_capture_buffer)) {
 ...
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["fe_addons"]['index']=-1;
foreach ($_from as $_smarty_tpl->tpl_vars["data"]->key => $_smarty_tpl->tpl_vars["data"]->value){
$_smarty_tpl->tpl_vars["data"]->_loop = true;
 $_smarty_tpl->tpl_vars["name"]->value = $_smarty_tpl->tpl_vars["data"]->key;
 $_smarty_tpl->tpl_vars['smarty']->value['foreach']["fe_addons"]['index']++;
?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/settings_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('item'=>$_smarty_tpl->tpl_vars['data']->value,'section'=>$_smarty_tpl->tpl_vars['_addon']->value,'html_id'=>"addon_option_".((string)$_smarty_tpl->tpl_vars['_addon']->value)."_".((string)$_smarty_tpl->tpl_vars['data']->value['name']),'html_name'=>"addon_data[options][".((string)$_smarty_tpl->tpl_vars['data']->value['object_id'])."]",'index'=>$_smarty_tpl->getVariable('smarty')->value['foreach']['fe_addons']['index'],'class'=>"setting-wide",'total'=>$_smarty_tpl->getVariable('smarty')->value['foreach']['fe_addons']['total']), 0);?>
        ...
        <div class="buttons-container<?php if ($_smarty_tpl->tpl_vars['separate']->value){?> buttons-bg<?php }?> cm-toggle-button">
            <?php if ($_smarty_tpl->tpl_vars['separate']->value){?>
                <?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[addons.update]",'but_target_form'=>"update_addon_".((string)$_smarty_tpl->tpl_vars['_addon']->value)."_form",'hide_second_button'=>true,'breadcrumbs'=>$_smarty_tpl->tpl_vars['breadcrumbs']->value,'save'=>true), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php }else{ ?>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[addons.update]",'cancel_action'=>"close",'save'=>true), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['addon_name']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>
