<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:10:53
         compiled from "/var/www/4profit4good/design/backend/templates/views/categories/components/categories_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:826452797522cf5ed381bb8-29129074%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5fc11873520d25f73010b1ad76287ce033cef297' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/categories/components/categories_tree.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '826452797522cf5ed381bb8-29129074',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf5ed5b1543_48727181',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf5ed5b1543_48727181')) {function content_522cf5ed5b1543_48727181($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
?><?php
fn_preload_lang_vars(array('position_short','expand_collapse_list','expand_collapse_list','expand_collapse_list','expand_collapse_list','name','products','status','expand_sublist_of_items','expand_sublist_of_items','expand_sublist_of_items','expand_sublist_of_items','collapse_sublist_of_items','collapse_sublist_of_items','disabled','expand_sublist_of_items','expand_sublist_of_items','expand_sublist_of_items','expand_sublist_of_items','collapse_sublist_of_items','collapse_sublist_of_items','expand_sublist_of_items','expand_sublist_of_items','expand_sublist_of_items','expand_sublist_of_items','collapse_sublist_of_items','collapse_sublist_of_items','disabled','add_product','edit','delete'));
?>
...
?>
    ...
    <table class="table table-tree table-middle">
        <?php if ($_smarty_tpl->tpl_vars['header']->value&&!$_smarty_tpl->tpl_vars['parent_id']->value){?>
            ...
            <thead>
            <tr>
                <th width="5%"><?php echo $_smarty_tpl->getSubTemplate ("common/check_items.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('check_statuses'=>fn_get_default_statuses('',true)), 0);?>
</th>
...
').children().get(0)) Tygh.$.ceAjax('request', '<?php echo fn_url("categories.manage?category_id=".((string)$_smarty_tpl->tpl_vars['category']->value['category_id']),'A','rel');?>
...
" title="<?php echo $_smarty_tpl->__("collapse_sublist_of_items");?>
" id="off_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['comb_id']->value, ENT_QUOTES, 'UTF-8');?>
" class="cm-combination<?php if (!$_smarty_tpl->tpl_vars['expand_all']->value||!$_smarty_tpl->tpl_vars['show_all']->value){?> hidden<?php }?>"><span class="exicon-collapse"></span></span><a class="row-status" href="<?php echo htmlspecialchars(fn_url("companies.update?company_id=".((string)$_smarty_tpl->tpl_vars['category']->value['company_id'])), ENT_QUOTES, 'UTF-8');?>
            ...
            <td width="10%" class="center">
                <div class="hidden-tools">
                    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_items", null, null); ob_start(); ?>
                        ...
                        <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-confirm",'text'=>__("delete"),'href'=>"categories.delete?category_id=".((string)$_smarty_tpl->tpl_vars['category']->value['category_id'])));?>
</li>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("common/select_popup.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('popup_additional_class'=>"dropleft",'id'=>$_smarty_tpl->tpl_vars['category']->value['category_id'],'status'=>$_smarty_tpl->tpl_vars['category']->value['status'],'hidden'=>true,'object_id_name'=>"category_id",'table'=>"categories"), 0);?>
...
">
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("views/categories/components/categories_tree.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('categories_tree'=>$_smarty_tpl->tpl_vars['category']->value['subcategories'],'parent_id'=>false), 0);?>
