<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:30:54
         compiled from "/var/www/4profit4good/design/backend/templates/views/product_options/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:57040328352333dbe23f1c2-49628240%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'abe4894500ee553207279665b325080057631086' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/product_options/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '57040328352333dbe23f1c2-49628240',
  'function' => 
  array (
  ),
  'variables' => 
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_options_update_inventory")), 0);?>
</label>
            <div class="controls">           
...
"><?php echo $_smarty_tpl->__("type");?>
            ...
            <div class="controls">
            <?php echo $_smarty_tpl->getSubTemplate ("views/product_options/components/option_types.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"option_data[option_type]",'value'=>$_smarty_tpl->tpl_vars['option_data']->value['option_type'],'display'=>"select",'tag_id'=>"elm_option_type_".((string)$_smarty_tpl->tpl_vars['id']->value),'check'=>true), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_options_update_required")), 0);?>
</label>
            <div class="controls">
            <label class="checkbox">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_options_update_regexp")), 0);?>
</label>
                <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_options_update_inner_hint")), 0);?>
</label>
                <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_options_update_incorrect_filling_message")), 0);?>
</label>
                <div class="controls">
...
" size="5" class="input-mini" />&nbsp;/&nbsp;<select class="input-mini" name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>$_smarty_tpl->tpl_vars['vr']->value['variant_id'],'name'=>"update_all_vendors[".((string)$_smarty_tpl->tpl_vars['num']->value)."]"), 0);?>
...
" size="5" class="input-mini" />&nbsp;/&nbsp;<select class="input-mini" name="option_data[variants][<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
            ...
            <td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']=="C"){?> hidden<?php }?>">
                <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"option_data[variants][".((string)$_smarty_tpl->tpl_vars['num']->value)."][status]",'display'=>"select",'obj'=>$_smarty_tpl->tpl_vars['vr']->value,'meta'=>"input-small"), 0);?>
</td>
            <td class="nowrap">
...
" />
             ...
             <td class="right cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']=="C"){?> hidden<?php }?>">
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/multiple_buttons.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('item_id'=>"option_variants_".((string)$_smarty_tpl->tpl_vars['id']->value)."_".((string)$_smarty_tpl->tpl_vars['num']->value),'tag_level'=>"3",'only_delete'=>"Y"), 0);?>
...
" class="cm-ex-op hidden">
            <td colspan="7">
                ...
                <div class="control-group cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']=="C"){?> hidden<?php }?>">
                    ...
                    <div class="controls">
                        <?php echo $_smarty_tpl->getSubTemplate ("common/attach_images.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image_name'=>"variant_image",'image_key'=>$_smarty_tpl->tpl_vars['num']->value,'hide_titles'=>true,'no_detailed'=>true,'image_object_type'=>"variant_image",'image_type'=>"V",'image_pair'=>$_smarty_tpl->tpl_vars['vr']->value['image_pair'],'prefix'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
">
        <tr>
            ...
            <td class="cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']=="C"){?> hidden<?php }?>">
                <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"option_data[variants][".((string)$_smarty_tpl->tpl_vars['num']->value)."][status]",'display'=>"select",'meta'=>"input-small"), 0);?>
</td>
            <td>
                <span id="on_extra_option_variants_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['num']->value, ENT_QUOTES, 'UTF-8');?>
...
"><?php echo $_smarty_tpl->__("extra");?>
            ...
            <td class="right cm-non-cb<?php if ($_smarty_tpl->tpl_vars['option_data']->value['option_type']=="C"){?> hidden<?php }?>">
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/multiple_buttons.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('item_id'=>"add_variant_".((string)$_smarty_tpl->tpl_vars['id']->value),'tag_level'=>"2"), 0);?>
...
" class="cm-ex-op hidden">
            <td colspan="7">
                ...
                <div class="control-group cm-non-cb">
                    ...
                    <div class="controls">
                        <?php echo $_smarty_tpl->getSubTemplate ("common/attach_images.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image_name'=>"variant_image",'image_key'=>$_smarty_tpl->tpl_vars['num']->value,'hide_titles'=>true,'no_detailed'=>true,'image_object_type'=>"variant_image",'image_type'=>"V",'prefix'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
<div class="buttons-container">
    <?php if ($_smarty_tpl->tpl_vars['id']->value){?>
        ...
        <?php }?>
    <?php }?>
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[product_options.update]",'cancel_action'=>"close",'extra'=>'','hide_first_button'=>$_smarty_tpl->tpl_vars['hide_first_button']->value,'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
