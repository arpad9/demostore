<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 00:38:58
         compiled from "/var/www/4profit4good/design/backend/templates/common/tabsbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:231259737522ce06260f761-02678779%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ea8f3525389e52f7292a573cbb32498656de78d1' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/common/tabsbox.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '231259737522ce06260f761-02678779',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522ce062696945_77522291',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522ce062696945_77522291')) {function content_522ce062696945_77522291($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
if (!is_callable('smarty_modifier_empty_tabs')) include '/var/www/4profit4good/app/functions/smarty_plugins/modifier.empty_tabs.php';
...
" class="<?php if ($_smarty_tpl->tpl_vars['tab']->value['hidden']=="Y"){?>hidden <?php }?><?php if ($_smarty_tpl->tpl_vars['tab']->value['js']){?>cm-js<?php }elseif($_smarty_tpl->tpl_vars['tab']->value['ajax']){?>cm-js cm-ajax<?php }?><?php if ($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['active_tab']->value){?> cm-active active<?php }?><?php if ($_smarty_tpl->tpl_vars['active_tab_extra']->value&&($_smarty_tpl->tpl_vars['key']->value==$_smarty_tpl->tpl_vars['active_tab']->value)){?> extra-tab<?php }?>">
