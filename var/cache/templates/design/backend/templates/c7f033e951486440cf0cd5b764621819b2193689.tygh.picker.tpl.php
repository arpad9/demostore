<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:03:25
         compiled from "/var/www/4profit4good/design/backend/templates/pickers/products/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:776001231522cf42deba119-80737668%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c7f033e951486440cf0cd5b764621819b2193689' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/pickers/products/picker.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '776001231522cf42deba119-80737668',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf42e1e28a0_62199839',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf42e1e28a0_62199839')) {function content_522cf42e1e28a0_62199839($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
...
"><i class="icon-plus"></i> <?php echo $_smarty_tpl->__("add_product");?>
</a>
    <?php if ($_smarty_tpl->tpl_vars['placement']->value=='right'){?>
            </div>
        </div>
...
" class="<?php if (!$_smarty_tpl->tpl_vars['item_ids']->value){?>hidden<?php }?> cm-picker-product">
    <?php echo $_smarty_tpl->getSubTemplate ("pickers/products/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('clone'=>true,'product'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."product".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'root_id'=>$_smarty_tpl->tpl_vars['data_id']->value,'delete_id'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."delete_id".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'type'=>"product",'position_field'=>$_smarty_tpl->tpl_vars['positions']->value,'position'=>"0"), 0);?>
...
<?php echo $_smarty_tpl->__("defined_items");?>
...
: </span>&nbsp;<?php echo $_smarty_tpl->__("any_option_combinations");?>
                ...
                <?php }elseif($_smarty_tpl->tpl_vars['product']->value['product_options']){?>
                    <?php if ($_smarty_tpl->tpl_vars['product']->value['product_options_value']){?>
                        <?php echo $_smarty_tpl->getSubTemplate ("common/options_info.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product_options'=>$_smarty_tpl->tpl_vars['product']->value['product_options_value']), 0);?>

                    <?php }else{ ?>
                        <?php echo $_smarty_tpl->getSubTemplate ("common/options_info.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('product_options'=>fn_get_selected_product_options_info($_smarty_tpl->tpl_vars['product']->value['product_options'])), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("pickers/products/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('clone'=>true,'product'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."product".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'root_id'=>$_smarty_tpl->tpl_vars['data_id']->value,'delete_id'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."delete_id".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'input_name'=>((string)$_smarty_tpl->tpl_vars['input_name']->value)."[".((string)$_smarty_tpl->tpl_vars['ldelim']->value)."product_id".((string)$_smarty_tpl->tpl_vars['rdelim']->value)."]",'amount'=>"1",'amount_input'=>"text",'type'=>"options",'options'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."options".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'product_id'=>''), 0);?>
