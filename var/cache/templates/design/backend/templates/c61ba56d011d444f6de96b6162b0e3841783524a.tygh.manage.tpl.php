<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:30:53
         compiled from "/var/www/4profit4good/design/backend/templates/views/product_options/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:209256261652333dbe015b50-49424009%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c61ba56d011d444f6de96b6162b0e3841783524a' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/product_options/manage.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '209256261652333dbe015b50-49424009',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333dbe22d891_93766428',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333dbe22d891_93766428')) {function content_52333dbe22d891_93766428($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
?><?php
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("toolbar", null, null); ob_start(); ?>
            <?php $_smarty_tpl->_capture_stack[0][] = array("add_new_picker", null, null); ob_start(); ?>
                <?php if ($_smarty_tpl->tpl_vars['product_data']->value){?>
                    <?php echo $_smarty_tpl->getSubTemplate ("views/product_options/update.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option_id'=>"0",'company_id'=>$_smarty_tpl->tpl_vars['product_data']->value['company_id'],'disable_company_picker'=>true), 0);?>

                <?php }else{ ?>
                    <?php echo $_smarty_tpl->getSubTemplate ("views/product_options/update.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option_id'=>"0"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php if ($_smarty_tpl->tpl_vars['view_mode']->value=="embed"){?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_option",'text'=>__("new_option"),'link_text'=>__("add_option"),'act'=>"general",'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'meta'=>$_smarty_tpl->tpl_vars['position']->value), 0);?>


            <?php }else{ ?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_option",'text'=>__("new_option"),'title'=>__("add_option"),'icon'=>"icon-plus",'act'=>"general",'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'meta'=>$_smarty_tpl->tpl_vars['position']->value), 0);?>
        ...
        <?php }else{ ?>
            <?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
                <?php if ($_smarty_tpl->tpl_vars['product_options']->value&&$_smarty_tpl->tpl_vars['object']->value=="global"){?>
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("apply_to_products"),'but_role'=>"action",'but_href'=>"product_options.apply"), 0);?>
