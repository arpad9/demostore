<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 05:33:31
         compiled from "/var/www/4profit4good/design/backend/templates/common/attach_images.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1249782795522d256b787b42-23172084%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c021f7a1eb8f8a0f65a61467665bf42a8f0db452' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/common/attach_images.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1249782795522d256b787b42-23172084',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d256b974e23_53922334',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d256b974e23_53922334')) {function content_522d256b974e23_53922334($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('no_image','text_thumbnail_manual_loading','thumbnail_manual_loading_link','popup_larger_image','delete_image_pair','thumbnail','remove','no_image','alt_text','remove','no_image','alt_text'));
?>
...
(function(_, $) {
    $.ceEvent('on', 'ce.delete_image', function(r, p) {
        if (r.deleted == true) {
            $('#' + p.result_ids).closest('a').replaceWith('<div class="no-image"><i class="glyph-image" title="<?php echo $_smarty_tpl->__("no_image");?>
"></i></div>');
...
" class="attach-images">
    <?php if ($_smarty_tpl->tpl_vars['no_thumbnail']->value&&!$_smarty_tpl->tpl_vars['pair']->value['icon']){?>
        <span class="desc"><?php echo $_smarty_tpl->__("text_thumbnail_manual_loading");?>
&nbsp;<a id="sw_load_thumbnail_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['suffix']->value, ENT_QUOTES, 'UTF-8');?>
<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['key']->value, ENT_QUOTES, 'UTF-8');?>
" class="cm-combination"><?php echo $_smarty_tpl->__("thumbnail_manual_loading_link");?>
</a></span>
    <?php }?>
...
"><i class="icon-remove-sign"></i></a>
            ...
            <?php if (!$_smarty_tpl->tpl_vars['hide_images']->value){?>
                <div class="image">
                    <?php if ($_smarty_tpl->tpl_vars['pair']->value['image_id']){?>
                        <?php echo $_smarty_tpl->getSubTemplate ("common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image'=>$_smarty_tpl->tpl_vars['pair']->value['icon'],'image_id'=>$_smarty_tpl->tpl_vars['pair']->value['image_id'],'image_width'=>85), 0);?>
...
" />
        ...
        <div class="image-upload cm-hide-with-inputs">
            <?php echo $_smarty_tpl->getSubTemplate ("common/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('var_name'=>((string)$_smarty_tpl->tpl_vars['name']->value)."_image_icon".((string)$_smarty_tpl->tpl_vars['suffix']->value)."[".((string)$_smarty_tpl->tpl_vars['key']->value)."]",'image'=>true), 0);?>
...
"><i class="icon-remove-sign"></i></a>
                ...
                <div class="image">
                    <?php if ($_smarty_tpl->tpl_vars['pair']->value['detailed_id']){?>
                        <?php echo $_smarty_tpl->getSubTemplate ("common/image.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image'=>$_smarty_tpl->tpl_vars['pair']->value['detailed'],'image_id'=>$_smarty_tpl->tpl_vars['pair']->value['detailed_id'],'image_width'=>85), 0);?>
...
" />
        ...
        <div class="image-upload cm-hide-with-inputs">
            <?php echo $_smarty_tpl->getSubTemplate ("common/fileuploader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('var_name'=>((string)$_smarty_tpl->tpl_vars['name']->value)."_image_detailed".((string)$_smarty_tpl->tpl_vars['suffix']->value)."[".((string)$_smarty_tpl->tpl_vars['key']->value)."]"), 0);?>
