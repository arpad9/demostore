<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 19:40:48
         compiled from "/var/www/4profit4good/design/backend/templates/views/companies/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:31351484052333200ac29d8-40824829%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6944d54ff89766929c9c2e95edb62ae3a94d3f5' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/companies/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '31351484052333200ac29d8-40824829',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333200f40c67_27907327',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333200f40c67_27907327')) {function content_52333200f40c67_27907327($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_modifier_in_array')) include '/var/www/4profit4good/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
fn_preload_lang_vars(array('use_existing_store','store','none','recommended','information','company','storefront_url','secure_storefront_url','design','store_theme','goto_theme_configuration','status','active','pending','disabled','language','create_administrator_account','account_name','first_name','last_name','vendor_commission','request_account_name','contact_information','contact_information','email','phone','url','fax','shipping_address','shipping_address','address','city','country','select_country','state','select_state','zip_postal_code','settings','company','description','text_all_items_included','categories','redirect_customer_from_storefront','entry_page','none','index','all_pages','countries','shipping_methods','available_for_vendor','disabled','no_data','menu','view_vendor_products','view_vendor_categories','view_vendor_users','view_vendor_orders','editing_vendor','new_vendor'));
?>
...
<?php if (fn_allowed_for("ULTIMATE")&&!$_smarty_tpl->tpl_vars['id']->value&&!$_smarty_tpl->tpl_vars['runtime']->value['company_id']){?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("use_existing_store")), 0);?>
...
:</label>
        <div class="controls">
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("common/ajax_select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_url'=>"companies.get_companies_list?show_all=Y&default_label=none",'text'=>__("none"),'result_elm'=>"elm_company_exists_store",'id'=>"exists_store_selector"), 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['object_data']->value['tooltip']){?><?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__($_smarty_tpl->tpl_vars['object_data']->value['tooltip'])), 0);?>
<?php }?>:</label>
                <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("information")), 0);?>
...
<div class="control-group">
    <label for="elm_company_name" class="control-label cm-required"><?php echo $_smarty_tpl->__("company");?>
:</label>
    <div class="controls">
...
:</label>
    ...
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']){?>
        http://<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['storefront'], ENT_QUOTES, 'UTF-8');?>

    <?php }else{ ?>
        <input type="text" name="company_data[storefront]" id="elm_company_storefront" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['storefront'], ENT_QUOTES, 'UTF-8');?>
...
:</label>
    <div class="controls">
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']){?>
        https://<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['secure_storefront'], ENT_QUOTES, 'UTF-8');?>

    <?php }else{ ?>
        <input type="text" name="company_data[secure_storefront]" id="elm_company_secure_storefront" size="32" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company_data']->value['secure_storefront'], ENT_QUOTES, 'UTF-8');?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("design")), 0);?>
...
:</label>
 ...
 (<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['theme_info']->value['theme_name'], ENT_QUOTES, 'UTF-8');?>
)</p>
...
<?php if (fn_allowed_for("MULTIVENDOR")){?>
    <?php if (!$_smarty_tpl->tpl_vars['runtime']->value['company_id']){?>
        <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"company_data[status]",'id'=>"company_data",'obj'=>$_smarty_tpl->tpl_vars['company_data']->value), 0);?>
...
<?php if (!$_smarty_tpl->tpl_vars['id']->value){?>
    <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profile_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section'=>"C",'title'=>__("contact_information")), 0);?>
...
<?php if (!$_smarty_tpl->tpl_vars['id']->value){?>
    <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profile_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section'=>"B",'title'=>__("shipping_address"),'shipping_flag'=>false), 0);?>
...
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_tmp1.": ".$_tmp2), 0);?>
...
<?php if (fn_allowed_for("MULTIVENDOR")){?>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("views/site_layout/components/logos_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('logos'=>$_smarty_tpl->tpl_vars['company_data']->value['logos'],'company_id'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
    ...
    <div id="content_categories" class="hidden"> 
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('multiple'=>true,'input_name'=>"company_data[categories]",'item_ids'=>$_smarty_tpl->tpl_vars['company_data']->value['categories'],'data_id'=>"category_ids",'no_item_text'=>__("text_all_items_included",array("[items]"=>__("categories"))),'use_keys'=>"N",'but_meta'=>"pull-right"), 0);?>
...
<div id="content_regions" class="hidden"> 
    <fieldset>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("common/double_selectboxes.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("countries"),'first_name'=>"company_data[countries_list]",'first_data'=>$_smarty_tpl->tpl_vars['company_data']->value['countries_list'],'second_name'=>"all_countries",'second_data'=>$_smarty_tpl->tpl_vars['countries_list']->value), 0);?>
...
<div id="content_shipping_methods" class="hidden"> 
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"companies:shipping_methods")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"companies:shipping_methods"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['company_data']->value['shippings']){?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['company_data']->value['shippings']){?>
            <?php $_smarty_tpl->tpl_vars["shippings_ids"] = new Smarty_variable(explode(",",$_smarty_tpl->tpl_vars['company_data']->value['shippings']), null, 0);?>
        <?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['shipping']->value['status']=="D"){?> (<?php echo mb_strtolower($_smarty_tpl->__("disabled"), 'UTF-8');?>
            ...
            <td class="center">
                <input type="checkbox" <?php if (!$_smarty_tpl->tpl_vars['id']->value||smarty_modifier_in_array($_smarty_tpl->tpl_vars['shipping_id']->value,$_smarty_tpl->tpl_vars['shippings_ids']->value)){?> checked="checked"<?php }?> name="company_data[shippings][]" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['shipping_id']->value, ENT_QUOTES, 'UTF-8');?>
">
            </td>
        </tr>
        <?php } ?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tabsbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('content'=>Smarty::$_smarty_vars['capture']['tabsbox'],'group_name'=>"companies",'active_tab'=>$_REQUEST['selected_section'],'track'=>true), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>   
    <?php if ($_smarty_tpl->tpl_vars['id']->value){?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[companies.update]",'but_target_form'=>"company_update_form",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>

    <?php }else{ ?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[companies.add]",'but_target_form'=>"company_update_form"), 0);?>
...
<?php $_tmp3=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_tmp3.": ".((string)$_smarty_tpl->tpl_vars['company_data']->value['company']),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>true,'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar']), 0);?>

<?php }else{ ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("new_vendor"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>
