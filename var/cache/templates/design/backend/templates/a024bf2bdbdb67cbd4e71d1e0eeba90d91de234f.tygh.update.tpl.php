<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:29:48
         compiled from "/var/www/4profit4good/design/backend/templates/views/product_filters/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:140824003152333d7c063572-52692619%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a024bf2bdbdb67cbd4e71d1e0eeba90d91de234f' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/product_filters/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '140824003152333d7c063572-52692619',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333d7c3a48c7_75579157',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333d7c3a48c7_75579157')) {function content_52333d7c3a48c7_75579157($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
?><?php
...
" />
        ...
        <?php if (fn_allowed_for("ULTIMATE")){?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_field.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"filter_data[company_id]",'id'=>"elm_filter_data_".((string)$_smarty_tpl->tpl_vars['id']->value),'selected'=>$_smarty_tpl->tpl_vars['filter']->value['company_id']), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_filters_update_display_variants_count")), 0);?>
</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_filters_update_display_more_variants_count")), 0);?>
</label>
            <div class="controls">
...
<?php }?></td>
            <td class="right">
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/multiple_buttons.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('item_id'=>"range_item_".((string)$_smarty_tpl->tpl_vars['id']->value)."_".((string)$_smarty_tpl->tpl_vars['range']->value['range_id']),'tag_level'=>"1",'only_delete'=>"Y"), 0);?>
...
&nbsp;-&nbsp;
            ...
            <td>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/multiple_buttons.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('item_id'=>"add_to_range_".((string)$_smarty_tpl->tpl_vars['id']->value),'tag_level'=>"1"), 0);?>
</td>
        </tr>
        </table>
    </div>
...
<div class="buttons-container">
    ...
    <?php }?>
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[product_filters.update]",'cancel_action'=>"close",'hide_first_button'=>$_smarty_tpl->tpl_vars['hide_first_button']->value,'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
