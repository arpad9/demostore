<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 19:54:43
         compiled from "/var/www/4profit4good/design/backend/templates/views/products/components/products_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:900141475523335432efe17-22746442%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e599ae33f5ef0fabd504e1921c304bc564b7c98a' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/products/components/products_search_form.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '900141475523335432efe17-22746442',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_523335435e1d95_79098221',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_523335435e1d95_79098221')) {function content_523335435e1d95_79098221($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_truncate')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/modifier.truncate.php';
...
<div class="control-group">
    ...
    <div class="controls">
        <div id="filter"<?php if (!$_COOKIE['filter']){?> class="hidden"<?php }?>>
            <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/advanced_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('filter_features'=>$_smarty_tpl->tpl_vars['filter_items']->value,'prefix'=>"filter_"), 0);?>
...
<div class="group form-horizontal">
    <div class="control-group">
        ...
        <div id="feature"<?php if (!$_COOKIE['feature']){?> class="hidden"<?php }?>>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/advanced_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('filter_features'=>$_smarty_tpl->tpl_vars['feature_items']->value,'prefix'=>"feature_"), 0);?>
...
" onfocus="this.select();" class="input-mini" />
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="checkbox" value="Y" <?php if ($_smarty_tpl->tpl_vars['search']->value['subcats']=="Y"){?>checked="checked"<?php }?> name="subcats"  id="subcats" /></div>
        </div>
    </div>
</div>
...
<?php $_block_content = ob_get_clean(); $_block_repeat=false; echo smarty_block_hook(array('name'=>"products:search_form"), $_block_content, $_smarty_tpl, $_block_repeat);  } array_pop($_smarty_tpl->smarty->_tag_stack);?>
    ...
    <div class="group span6 form-horizontal">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <?php echo $_smarty_tpl->getSubTemplate ("pickers/orders/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('item_ids'=>$_smarty_tpl->tpl_vars['search']->value['order_ids'],'no_item_text'=>__("no_items"),'data_id'=>"order_ids",'input_name'=>"order_ids",'view_mode'=>"simple"), 0);?>
