<?php /* Smarty version Smarty-3.1.13, created on 2013-09-15 07:31:21
         compiled from "/var/www/4profit4good/design/backend/templates/views/products/components/products_update_qty_discounts.tpl" */ ?>
<?php /*%%SmartyHeaderCode:139293195252352a094d3863-01663403%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '95a1b1103c6a972d9bff78f00a0c070670ab4464' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/products/components/products_update_qty_discounts.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '139293195252352a094d3863-01663403',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52352a096703f1_36769020',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52352a096703f1_36769020')) {function content_52352a096703f1_36769020($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("qty_discount_type_tooltip")), 0);?>
</th>
        <?php if (!fn_allowed_for("ULTIMATE:FREE")){?>
...
<?php }?></option>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>"price_".((string)$_smarty_tpl->tpl_vars['_key']->value),'name'=>"update_all_vendors[prices][".((string)$_smarty_tpl->tpl_vars['_key']->value)."]"), 0);?>
 ...
 right">
            <?php if ($_smarty_tpl->tpl_vars['price']->value['lower_limit']=="1"&&$_smarty_tpl->tpl_vars['price']->value['usergroup_id']=="0"){?>
            &nbsp;<?php }else{ ?>
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/clone_delete.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('microformats'=>"cm-delete-row",'no_confirm'=>true), 0);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['usergroup']->value['usergroup'], ENT_QUOTES, 'UTF-8');?>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>"price_".((string)$_smarty_tpl->tpl_vars['new_key']->value),'name'=>"update_all_vendors[prices][".((string)$_smarty_tpl->tpl_vars['new_key']->value)."]"), 0);?>

        </td>
        <?php }?>
        <td width="15%" class="right">
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/multiple_buttons.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('item_id'=>"add_qty_discount"), 0);?>
