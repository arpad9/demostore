<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 01:51:49
         compiled from "/var/www/4profit4good/design/backend/templates/pickers/categories/js.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1582382274522cf17567e683-29950070%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '63cd3ef3713d6dc63fd3293bde8ff947915c6040' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/pickers/categories/js.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1582382274522cf17567e683-29950070',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf17585a783_79701177',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf17585a783_79701177')) {function content_522cf17585a783_79701177($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
?><?php
...
" size="3" class="input-text-short"<?php if ($_smarty_tpl->tpl_vars['clone']->value){?> disabled="disabled"<?php }?> /></td><?php }?>
        <td><?php if (!$_smarty_tpl->tpl_vars['show_only_name']->value){?><a href="<?php echo htmlspecialchars(fn_url("categories.update?category_id=".((string)$_smarty_tpl->tpl_vars['category_id']->value)), ENT_QUOTES, 'UTF-8');?>
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value, ENT_QUOTES, 'UTF-8');?>
</a><?php }else{ ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category']->value, ENT_QUOTES, 'UTF-8');?>
 <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('object'=>$_smarty_tpl->tpl_vars['category_data']->value), 0);?>
<?php }?></td>
    ...
    <?php }else{ ?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['first_item']->value||!$_smarty_tpl->tpl_vars['category_id']->value){?>
            <p class="cm-js-item cm-clone hidden">
                ...
                <label class="radio" for="category_rb_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category_id']->value, ENT_QUOTES, 'UTF-8');?>
...
"><?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['default_category']->value, ENT_QUOTES, 'UTF-8');?>
...
" <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['extra']->value, ENT_QUOTES, 'UTF-8');?>
 />
            <?php if ($_smarty_tpl->tpl_vars['hide_input']->value!="Y"){?>
                <label class="radio" for="category_radio_button_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['category_id']->value, ENT_QUOTES, 'UTF-8');?>
...
" />
            ...
            <?php if ($_smarty_tpl->tpl_vars['category_data']->value['company_id']){?><?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('object'=>$_smarty_tpl->tpl_vars['category_data']->value,'simple'=>true), 0);?>
<?php }?>
