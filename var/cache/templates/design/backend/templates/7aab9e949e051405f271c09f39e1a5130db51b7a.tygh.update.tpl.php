<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 02:12:31
         compiled from "/var/www/4profit4good/design/backend/templates/views/profiles/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:183727740252323c4fb1b2a6-99668573%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7aab9e949e051405f271c09f39e1a5130db51b7a' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/profiles/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '183727740252323c4fb1b2a6-99668573',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52323c4fe710e9_31075883',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52323c4fe710e9_31075883')) {function content_52323c4fe710e9_31075883($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('contact_information','user_profile_info','text_multiprofile_notice','billing_address','shipping_address','shipping_address','usergroup','status','no_data','allow_api_access','api_key','notify_user','new_profile','editing_profile','editing_profile','editing_profile','view_all_orders','act_on_behalf'));
?>
...
" />
    ...
    <div id="content_general">
        <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"profiles:general_content")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"profiles:general_content"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profiles_account.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
            ...
            <?php if ((fn_allowed_for("ULTIMATE")||$_smarty_tpl->tpl_vars['user_type']->value=="V")&&$_smarty_tpl->tpl_vars['id']->value!=$_smarty_tpl->tpl_vars['auth']->value['user_id']){?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_field.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"user_data[company_id]",'id'=>"user_data_company_id",'selected'=>$_smarty_tpl->tpl_vars['user_data']->value['company_id'],'zero_company_id_name_lang_var'=>$_smarty_tpl->tpl_vars['zero_company_id_name_lang_var']->value,'disable_company_picker'=>$_smarty_tpl->tpl_vars['hide_inputs']->value), 0);?>
...
">
        ...
        <?php if ($_smarty_tpl->tpl_vars['settings']->value['General']['user_multiple_profiles']=="Y"&&$_smarty_tpl->tpl_vars['id']->value){?>
            <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("user_profile_info")), 0);?>

            <p class="form-note"><?php echo $_smarty_tpl->__("text_multiprofile_notice");?>
</p>
            <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/multiple_profiles.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>

        <?php }?>

        <?php if ($_smarty_tpl->tpl_vars['profile_fields']->value['B']){?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profile_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section'=>"B",'title'=>__("billing_address")), 0);?>

            <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profile_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section'=>"S",'title'=>__("shipping_address"),'body_id'=>"sa",'shipping_flag'=>fn_compare_shipping_billing($_smarty_tpl->tpl_vars['profile_fields']->value)), 0);?>

        <?php }else{ ?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/profile_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('section'=>"S",'title'=>__("shipping_address"),'shipping_flag'=>false), 0);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['usergroup']->value['usergroup'], ENT_QUOTES, 'UTF-8');?>
    ...
    <?php if (fn_check_user_type_admin_area($_smarty_tpl->tpl_vars['user_data']->value)&&$_smarty_tpl->tpl_vars['user_data']->value['user_id']){?>
        <div id="content_api">
...
<?php }?>" readonly="readonly"/>
    ...
    <div class="control-group notify-customer cm-toggle-button">
        <label class="control-label" for="notify_customer"><?php echo $_smarty_tpl->__("notify_user");?>
</label>
        <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tabsbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('content'=>Smarty::$_smarty_vars['capture']['tabsbox'],'group_name'=>$_smarty_tpl->tpl_vars['runtime']->value['controller'],'active_tab'=>$_smarty_tpl->tpl_vars['selected_section']->value,'track'=>true), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[profiles.".((string)$_smarty_tpl->tpl_vars['runtime']->value['mode'])."]",'hide_first_button'=>$_smarty_tpl->tpl_vars['hide_first_button']->value,'hide_second_button'=>$_smarty_tpl->tpl_vars['hide_first_button']->value,'but_target_form'=>"profile_form",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['_title']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>
