<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 05:33:23
         compiled from "/var/www/4profit4good/design/backend/templates/addons/banners/views/banners/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2097592760522d256314e716-40368519%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f6da85bfdc8699b4687a6a918b7f30e5f00139b8' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/addons/banners/views/banners/manage.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2097592760522d256314e716-40368519',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d256326cab7_76549709',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d256326cab7_76549709')) {function content_522d256326cab7_76549709($_smarty_tpl) {?><?php
...
<tr>
    <th width="1%" class="left">
        <?php echo $_smarty_tpl->getSubTemplate ("common/check_items.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('class'=>"cm-no-hide-input"), 0);?>
</th>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['banner']->value['banner'], ENT_QUOTES, 'UTF-8');?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('object'=>$_smarty_tpl->tpl_vars['banner']->value), 0);?>

    </td>
    <td class="nowrap row-status <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['no_hide_input']->value, ENT_QUOTES, 'UTF-8');?>
"><?php if ($_smarty_tpl->tpl_vars['banner']->value['type']=="G"){?><?php echo $_smarty_tpl->__("graphic_banner");?>
<?php }else{ ?><?php echo $_smarty_tpl->__("text_banner");?>
<?php }?></td>
    <td>
        ...
        <?php if ($_smarty_tpl->tpl_vars['allow_save']->value){?>
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'class'=>"cm-confirm",'text'=>__("delete"),'href'=>"banners.delete?banner_id=".((string)$_smarty_tpl->tpl_vars['banner']->value['banner_id'])));?>
</li>
        <?php }?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tool_href'=>"banners.add",'prefix'=>"top",'hide_tools'=>"true",'title'=>__("add_banner"),'icon'=>"icon-plus"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("banners"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons'],'select_languages'=>true), 0);?>
