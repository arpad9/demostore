<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:20:18
         compiled from "/var/www/4profit4good/design/backend/templates/views/cart/cart_list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:183763399752333b421d2726-79125043%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'be3130382ee7b24a7c75d96b79df0d6cf14428c6' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/cart/cart_list.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '183763399752333b421d2726-79125043',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333b424f3769_12618882',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333b424f3769_12618882')) {function content_52333b424f3769_12618882($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
<?php }?>" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=customer&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'UTF-8');?>
...
<?php }?>" href="<?php echo htmlspecialchars(fn_url(((string)$_smarty_tpl->tpl_vars['c_url']->value)."&sort_by=date&sort_order=".((string)$_smarty_tpl->tpl_vars['search']->value['sort_order_rev'])), ENT_QUOTES, 'UTF-8');?>
...
" class="cm-combination-carts" onclick="Tygh.$.ceAjax('request', '<?php echo fn_url("cart.cart_list?user_id=".((string)$_smarty_tpl->tpl_vars['customer']->value['user_id'])."&c_company_id=".((string)$_smarty_tpl->tpl_vars['customer']->value['company_id']),'A','rel');?>
...
" title="<?php echo $_smarty_tpl->__("expand_sublist_of_items");?>
" id="on_user_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['user_id'], ENT_QUOTES, 'UTF-8');?>
" class="cm-combination-carts" onclick="Tygh.$.ceAjax('request', '<?php echo fn_url("cart.cart_list?user_id=".((string)$_smarty_tpl->tpl_vars['customer']->value['user_id']),'A','rel');?>
', <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ldelim']->value, ENT_QUOTES, 'UTF-8');?>
result_ids: 'cart_products_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['user_id'], ENT_QUOTES, 'UTF-8');?>
,wishlist_products_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['user_id'], ENT_QUOTES, 'UTF-8');?>
', caching: true<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['rdelim']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="underlined"><?php if ($_smarty_tpl->tpl_vars['customer']->value['firstname']||$_smarty_tpl->tpl_vars['customer']->value['lastname']){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['lastname'], ENT_QUOTES, 'UTF-8');?>
 <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['firstname'], ENT_QUOTES, 'UTF-8');?>
<?php }else{ ?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['customer']->value['user_data']['email'], ENT_QUOTES, 'UTF-8');?>
<?php }?></a><?php }else{ ?><?php echo $_smarty_tpl->__("unregistered_customer");?>
<?php }?>
        <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('object'=>$_smarty_tpl->tpl_vars['customer']->value), 0);?>
...
"><?php echo $_smarty_tpl->tpl_vars['product']->value['product'];?>
                ...
                <td class="right"><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['product']->value['price'],'span_id'=>"c_".((string)$_smarty_tpl->tpl_vars['customer']->value['user_id'])."_".((string)$_smarty_tpl->tpl_vars['product']->value).".item_id"), 0);?>
</td>
            </tr>
            <?php }?>
...
:</span></td>
                ...
                <td class="right"><span><?php echo $_smarty_tpl->getSubTemplate ("common/price.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['customer']->value['total'],'span_id'=>"u_".((string)$_smarty_tpl->tpl_vars['customer']->value).".user_id"), 0);?>
</span></td>
            </tr>
            </table>
            <?php }?>
...
">
                ...
                <dl>
                    ...
                    <dd><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['b_first_name'], ENT_QUOTES, 'UTF-8');?>
</dd>            
                    <dt><?php echo $_smarty_tpl->__("last_name");?>
</dt>
                    <dd><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['b_last_name'], ENT_QUOTES, 'UTF-8');?>
</dd>
                ...
                <dl>
                    ...
                    <dd><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['s_first_name'], ENT_QUOTES, 'UTF-8');?>
</dd>            
                    <dt><?php echo $_smarty_tpl->__("last_name");?>
</dt>
                    <dd><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['user_data']->value['s_last_name'], ENT_QUOTES, 'UTF-8');?>
</dd>
                    <dt><?php echo $_smarty_tpl->__("address");?>
</dt>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("sidebar", null, null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/saved_search.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"cart.cart_list",'view_type'=>"carts"), 0);?>

    <?php echo $_smarty_tpl->getSubTemplate ("views/cart/components/carts_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"cart.cart_list"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("users_carts"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar']), 0);?>
