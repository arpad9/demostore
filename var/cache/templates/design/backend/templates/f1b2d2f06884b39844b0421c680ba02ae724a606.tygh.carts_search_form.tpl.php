<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:20:18
         compiled from "/var/www/4profit4good/design/backend/templates/views/cart/components/carts_search_form.tpl" */ ?>
<?php /*%%SmartyHeaderCode:29637121752333b42608f96-72348503%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f1b2d2f06884b39844b0421c680ba02ae724a606' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/cart/components/carts_search_form.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '29637121752333b42608f96-72348503',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333b426e5a54_28265549',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333b426e5a54_28265549')) {function content_52333b426e5a54_28265549($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('search','customer','email','total','content','cart','wishlist','with_contact_information','online_only','tt_views_cart_components_carts_search_form_online_only','users_type','any','registered','guest','products_in_cart'));
?>
...
<div class="group">
    <div class="control-group">
        <?php echo $_smarty_tpl->getSubTemplate ("common/period_selector.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('period'=>$_smarty_tpl->tpl_vars['search']->value['period'],'form_name'=>"carts_search_form"), 0);?>
...
<label for="cb_product_type_c">
                    ...
                    <label for="cb_product_type_w"><input type="checkbox" value="Y" name="product_type_w" <?php if ($_smarty_tpl->tpl_vars['search']->value['product_type_w']=="Y"||$_smarty_tpl->tpl_vars['check_all']->value){?>checked="checked"<?php }?> id="cb_product_type_w" onclick="if (!this.checked) document.getElementById('cb_product_type_c').checked = true;" disabled="disabled"/>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_cart_components_carts_search_form_online_only")), 0);?>
</label>
            <div class="controls">
                <input type="checkbox" id="online_only" name="online_only" value="Y" class="checkbox" <?php if ($_smarty_tpl->tpl_vars['search']->value['online_only']){?>checked="checked"<?php }?> />
            </div>
        </div>
	<?php }?>
    </div>
    ...
    <div class="group span6 form-horizontal">
        <div class="control-group">
            <label class="control-label" for="users_type"><?php echo $_smarty_tpl->__("users_type");?>
</label>
            <div class="controls">
                <select name="users_type" id="users_type">
                    ...
                    <option value="R" <?php if ($_smarty_tpl->tpl_vars['search']->value['users_type']=="R"){?>selected="selected"<?php }?>><?php echo $_smarty_tpl->__("registered");?>
</option>
...
<div class="group">
    <div class="control-group">
        ...
        <div class="controls">
            <?php echo $_smarty_tpl->getSubTemplate ("common/products_to_search.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('placement'=>"right"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/advanced_search.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('simple_search'=>Smarty::$_smarty_vars['capture']['simple_search'],'advanced_search'=>Smarty::$_smarty_vars['capture']['advanced_search'],'dispatch'=>"cart.cart_list",'view_type'=>"carts"), 0);?>
