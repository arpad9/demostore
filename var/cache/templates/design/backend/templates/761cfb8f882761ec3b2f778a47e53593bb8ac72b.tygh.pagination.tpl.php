<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 00:49:50
         compiled from "/var/www/4profit4good/design/backend/templates/common/pagination.tpl" */ ?>
<?php /*%%SmartyHeaderCode:515473678522ce2eee296e9-64786653%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '761cfb8f882761ec3b2f778a47e53593bb8ac72b' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/common/pagination.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '515473678522ce2eee296e9-64786653',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522ce2ef0bedd3_69063331',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522ce2ef0bedd3_69063331')) {function content_522ce2ef0bedd3_69063331($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
?><?php
...
<?php $_smarty_tpl->tpl_vars["c_url"] = new Smarty_variable(fn_query_remove($_smarty_tpl->tpl_vars['config']->value['current_url'],"page","result_ids"), null, 0);?>
...
<?php if (Smarty::$_smarty_vars['capture']['pagination_open']!="Y"){?>
<div <?php if ($_smarty_tpl->tpl_vars['pagination_class']->value){?>class="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pagination_class']->value, ENT_QUOTES, 'UTF-8');?>
...
"><a data-ca-event="ce.ajax_pagination" class="cm-ajax<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'UTF-8');?>
...
">1</a>
                <?php if ($_smarty_tpl->tpl_vars['pg']->value!=2){?><a data-ca-event="ce.ajax_pagination" class="<?php if ($_smarty_tpl->tpl_vars['pagination']->value['prev_range']){?>cm-ajax<?php }?> prev-range<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'UTF-8');?>
...
"<?php }?>>&nbsp;...&nbsp;</a><?php }?>
                <?php }?>
                <?php if ($_smarty_tpl->tpl_vars['pg']->value!=$_smarty_tpl->tpl_vars['pagination']->value['current_page']){?><a data-ca-event="ce.ajax_pagination" class="cm-ajax<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'UTF-8');?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['pg']->value, ENT_QUOTES, 'UTF-8');?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['pg']->value!=$_smarty_tpl->tpl_vars['pagination']->value['total_pages']-1){?><a data-ca-event="ce.ajax_pagination" class="<?php if ($_smarty_tpl->tpl_vars['pagination']->value['next_range']){?>cm-ajax<?php }?> next-range<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'UTF-8');?>
...
" data-ca-target-id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
"<?php }?>>&nbsp;...&nbsp;</a><?php }?><a data-ca-event="ce.ajax_pagination" class="cm-ajax<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'UTF-8');?>
...
"><a data-ca-event="ce.ajax_pagination" class="<?php if ($_smarty_tpl->tpl_vars['pagination']->value['next_page']){?>cm-ajax<?php }?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'UTF-8');?>
...
?>
                        <li><a data-ca-event="ce.ajax_pagination" class="cm-ajax<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['history_class']->value, ENT_QUOTES, 'UTF-8');?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('prefix'=>"pagination_".((string)$_smarty_tpl->tpl_vars['rnd']->value),'hide_actions'=>true,'tools_list'=>Smarty::$_smarty_vars['capture']['pagination_list'],'link_text'=>$_smarty_tpl->tpl_vars['pagination']->value['items_per_page'],'override_meta'=>"btn-text",'skip_check_permissions'=>"true",'tool_meta'=>$_smarty_tpl->tpl_vars['pagination_meta']->value,'caret'=>true), 0);?>
