<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 01:51:07
         compiled from "/var/www/4profit4good/design/backend/templates/views/block_manager/components/setting_element.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1051613677522cf14bc45b58-91259651%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '488e12bc780a1f4b5c54f06174942141c79626fb' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/block_manager/components/setting_element.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1051613677522cf14bc45b58-91259651',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf14be20ba7_18664091',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf14be20ba7_18664091')) {function content_522cf14be20ba7_18664091($_smarty_tpl) {?><?php if (!is_callable('smarty_function_html_checkboxes')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.html_checkboxes.php';
...
<?php }?><?php if ($_smarty_tpl->tpl_vars['option']->value['tooltip']){?><?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>$_smarty_tpl->tpl_vars['option']->value['tooltip']), 0);?>
<?php }?></label>
<?php }?>
...
?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/block_manager/components/setting_element.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option'=>$_smarty_tpl->tpl_vars['setting_data']->value,'name'=>$_smarty_tpl->tpl_vars['setting_name']->value,'block'=>$_smarty_tpl->tpl_vars['block']->value,'html_id'=>"block_".((string)$_smarty_tpl->tpl_vars['html_id']->value)."_properties_".((string)$_smarty_tpl->tpl_vars['name']->value)."_".((string)$_smarty_tpl->tpl_vars['setting_name']->value),'html_name'=>"block_data[properties][".((string)$_smarty_tpl->tpl_vars['name']->value)."][".((string)$_smarty_tpl->tpl_vars['value']->value)."][".((string)$_smarty_tpl->tpl_vars['setting_name']->value)."]",'editable'=>$_smarty_tpl->tpl_vars['editable']->value,'value'=>$_smarty_tpl->tpl_vars['block']->value['properties'][$_smarty_tpl->tpl_vars['name']->value][$_smarty_tpl->tpl_vars['value']->value][$_smarty_tpl->tpl_vars['setting_name']->value]), 0);?>
...
$_smarty_tpl->tpl_vars['setting_data']->_loop = true;
 $_smarty_tpl->tpl_vars['setting_name']->value = $_smarty_tpl->tpl_vars['setting_data']->key;
?>
                <?php echo $_smarty_tpl->getSubTemplate ("views/block_manager/components/setting_element.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('option'=>$_smarty_tpl->tpl_vars['setting_data']->value,'name'=>$_smarty_tpl->tpl_vars['setting_name']->value,'block'=>$_smarty_tpl->tpl_vars['block']->value,'html_id'=>"block_".((string)$_smarty_tpl->tpl_vars['html_id']->value)."_properties_".((string)$_smarty_tpl->tpl_vars['name']->value)."_".((string)$_smarty_tpl->tpl_vars['setting_name']->value),'html_name'=>"block_data[content][".((string)$_smarty_tpl->tpl_vars['name']->value)."][".((string)$_smarty_tpl->tpl_vars['setting_name']->value)."]",'editable'=>$_smarty_tpl->tpl_vars['editable']->value,'value'=>$_smarty_tpl->tpl_vars['block']->value['content'][$_smarty_tpl->tpl_vars['name']->value][$_smarty_tpl->tpl_vars['setting_name']->value]), 0);?>

            <?php } ?>
        <?php }?>
    <?php }?>
<?php }elseif($_smarty_tpl->tpl_vars['option']->value['type']=="template"){?> 
    <?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['option']->value['template'], $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('value'=>$_smarty_tpl->tpl_vars['value']->value), 0);?>
