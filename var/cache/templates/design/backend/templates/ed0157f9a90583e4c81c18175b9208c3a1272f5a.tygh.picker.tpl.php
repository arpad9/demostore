<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 01:51:49
         compiled from "/var/www/4profit4good/design/backend/templates/pickers/categories/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:431192723522cf1754109a6-98899330%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ed0157f9a90583e4c81c18175b9208c3a1272f5a' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/pickers/categories/picker.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '431192723522cf1754109a6-98899330',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf175675326_02692706',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf175675326_02692706')) {function content_522cf175675326_02692706($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
?><?php
...
<?php }?>" <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['extra']->value, ENT_QUOTES, 'UTF-8');?>
 />
    ...
    <?php }?>
        <?php if ($_smarty_tpl->tpl_vars['multiple']->value){?>        
            <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('category_id'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."category_id".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'holder'=>$_smarty_tpl->tpl_vars['data_id']->value,'hide_input'=>$_smarty_tpl->tpl_vars['hide_input']->value,'input_name'=>$_smarty_tpl->tpl_vars['input_name']->value,'radio_input_name'=>$_smarty_tpl->tpl_vars['radio_input_name']->value,'clone'=>true,'hide_link'=>$_smarty_tpl->tpl_vars['hide_link']->value,'hide_delete_button'=>$_smarty_tpl->tpl_vars['hide_delete_button']->value,'position_field'=>$_smarty_tpl->tpl_vars['positions']->value,'position'=>"0"), 0);?>
...
?>
                <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('main_category'=>$_smarty_tpl->tpl_vars['main_category']->value,'category_id'=>$_smarty_tpl->tpl_vars['c_id']->value,'holder'=>$_smarty_tpl->tpl_vars['data_id']->value,'hide_input'=>$_smarty_tpl->tpl_vars['hide_input']->value,'input_name'=>$_smarty_tpl->tpl_vars['input_name']->value,'clone'=>true,'hide_link'=>$_smarty_tpl->tpl_vars['hide_link']->value,'first_item'=>$_smarty_tpl->getVariable('smarty')->value['foreach']['items']['first'],'view_mode'=>"list"), 0);?>

            <?php }
if (!$_smarty_tpl->tpl_vars["c_id"]->_loop) {
?>
                <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('category_id'=>'','holder'=>$_smarty_tpl->tpl_vars['data_id']->value,'hide_input'=>$_smarty_tpl->tpl_vars['hide_input']->value,'input_name'=>$_smarty_tpl->tpl_vars['input_name']->value,'clone'=>true,'hide_link'=>$_smarty_tpl->tpl_vars['hide_link']->value,'view_mode'=>"list"), 0);?>
...
?>
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('category_id'=>$_smarty_tpl->tpl_vars['c_id']->value,'holder'=>$_smarty_tpl->tpl_vars['data_id']->value,'hide_input'=>$_smarty_tpl->tpl_vars['hide_input']->value,'input_name'=>$_smarty_tpl->tpl_vars['input_name']->value,'hide_link'=>$_smarty_tpl->tpl_vars['hide_link']->value,'hide_delete_button'=>$_smarty_tpl->tpl_vars['hide_delete_button']->value,'first_item'=>$_smarty_tpl->getVariable('smarty')->value['foreach']['items']['first'],'position_field'=>$_smarty_tpl->tpl_vars['positions']->value,'position'=>$_smarty_tpl->getVariable('smarty')->value['foreach']['items']['iteration']+$_smarty_tpl->tpl_vars['start_pos']->value), 0);?>
...
?>
                ...
                <div class="input-append choose-input">
                    <?php echo $_smarty_tpl->getSubTemplate ("pickers/categories/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('category_id'=>'','holder'=>$_smarty_tpl->tpl_vars['data_id']->value,'hide_input'=>$_smarty_tpl->tpl_vars['hide_input']->value,'input_name'=>$_smarty_tpl->tpl_vars['input_name']->value,'hide_link'=>$_smarty_tpl->tpl_vars['hide_link']->value,'hide_delete_button'=>$_smarty_tpl->tpl_vars['hide_delete_button']->value), 0);?>
