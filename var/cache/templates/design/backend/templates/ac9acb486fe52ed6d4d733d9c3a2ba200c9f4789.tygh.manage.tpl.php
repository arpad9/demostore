<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 01:51:49
         compiled from "/var/www/4profit4good/design/backend/templates/views/static_data/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1388994814522cf1750cab84-76944636%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ac9acb486fe52ed6d4d733d9c3a2ba200c9f4789' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/static_data/manage.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1388994814522cf1750cab84-76944636',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf1751bfe09_95988938',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf1751bfe09_95988938')) {function content_522cf1751bfe09_95988938($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
?><?php
...
<div id="static_data_list" class="<?php if (!fn_allow_save_object('',"static_data",$_smarty_tpl->tpl_vars['section_data']->value['skip_edition_checking'])){?> cm-hide-inputs<?php }?>">
    ...
    <?php }?>
        ...
        <div class="items-container multi-level">
            ...
            <table class="table table-middle table-tree hidden-inputs">
                <?php echo $_smarty_tpl->getSubTemplate ("views/static_data/components/multi_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('items'=>$_smarty_tpl->tpl_vars['static_data']->value,'header'=>true), 0);?>
...
<?php }else{ ?>
    <?php echo $_smarty_tpl->getSubTemplate ("views/static_data/components/single_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php if ($_smarty_tpl->tpl_vars['section_data']->value['multi_level']==true&&$_smarty_tpl->tpl_vars['static_data']->value){?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[static_data.m_update]",'but_role'=>"submit-link",'but_target_form'=>"static_data_tree_form"), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php if (fn_allow_save_object('',"static_data",$_smarty_tpl->tpl_vars['section_data']->value['skip_edition_checking'])){?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("add_new_picker", null, null); ob_start(); ?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/static_data/update.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('static_data'=>array()), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['title']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'tools'=>Smarty::$_smarty_vars['capture']['tools'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'select_languages'=>true,'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons']), 0);?>
<?php }} ?>