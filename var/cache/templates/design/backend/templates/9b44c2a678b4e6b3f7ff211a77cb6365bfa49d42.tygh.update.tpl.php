<?php /* Smarty version Smarty-3.1.13, created on 2013-09-16 03:00:46
         compiled from "/var/www/4profit4good/design/backend/templates/views/tabs/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:124119238852363c1e392a66-76829189%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9b44c2a678b4e6b3f7ff211a77cb6365bfa49d42' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/tabs/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '124119238852363c1e392a66-76829189',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52363c1e4e65a1_60544960',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52363c1e4e65a1_60544960')) {function content_52363c1e4e65a1_60544960($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
...
" name="update_product_tab_form_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_general_".((string)$_smarty_tpl->tpl_vars['html_id']->value)){?> active cm-active<?php }?>">
...
" class="cm-js<?php if ($_smarty_tpl->tpl_vars['active_tab']->value=="block_status_".((string)$_smarty_tpl->tpl_vars['html_id']->value)){?> active cm-active<?php }?>">
...
" class="input-text" size="18" />
                ...
                <?php if (!$_smarty_tpl->tpl_vars['dynamic_object_scheme']->value){?>
                    <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"tab_data[status]",'id'=>"elm_tab_data_".((string)$_smarty_tpl->tpl_vars['html_id']->value),'obj'=>$_smarty_tpl->tpl_vars['tab_data']->value), 0);?>
...
" />
                                <?php if ($_smarty_tpl->tpl_vars['tab_data']->value['block_id']>0){?>
                                    <?php echo $_smarty_tpl->getSubTemplate ("views/block_manager/render/block.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('block_data'=>$_smarty_tpl->tpl_vars['block_data']->value,'external_render'=>true,'external_id'=>$_smarty_tpl->tpl_vars['html_id']->value), 0);?>
...
:</label>
                        <div class="controls">
                            <label class="radio text-value"><?php if ($_smarty_tpl->tpl_vars['tab_data']->value['status']=='A'){?><?php echo $_smarty_tpl->__("active");?>
...
" />
                    <div class="control-group">
                        <label class="control-label"><?php if ($_smarty_tpl->tpl_vars['tab_data']->value['status']=='A'){?><?php echo $_smarty_tpl->__("disable_for");?>
...
<div class="buttons-container">
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[tabs.update]",'cancel_action'=>"close",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
