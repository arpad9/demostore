<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:22:47
         compiled from "/var/www/4profit4good/design/backend/templates/views/promotions/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:59036276452333bd7bf2c99-80251997%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31bc01d74f80f77a074e4a5770c36ae7356902df' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/promotions/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '59036276452333bd7bf2c99-80251997',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333bd7d82824_08537840',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333bd7d82824_08537840')) {function content_52333bd7d82824_08537840($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
?><?php
                ...
                if (l == value) {
                    if (items[k]['items'][l]['variants']) {
                        ...
                        if (count < <?php echo htmlspecialchars(@constant('PRODUCT_FEATURE_VARIANTS_THRESHOLD'), ENT_QUOTES, 'UTF-8');?>
                            ...
                            $('#content_loader_mixed_ajax_select_' + id).attr('data-ca-target-url', '<?php echo htmlspecialchars(fn_url("product_features.get_feature_variants_list?feature_id="), ENT_QUOTES, 'UTF-8');?>
' + l);
...
:</label>
    ...
    <?php if (fn_allowed_for("ULTIMATE")){?>
        <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_field.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"promotion_data[company_id]",'id'=>"elm_promotion_data_".((string)$_smarty_tpl->tpl_vars['id']->value),'selected'=>$_smarty_tpl->tpl_vars['promotion_data']->value['company_id']), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_promotions_update_stop_other_rules")), 0);?>
</label>
        <div class="controls">
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"promotion_data[status]",'id'=>"elm_promotion_status",'obj'=>$_smarty_tpl->tpl_vars['promotion_data']->value,'hidden'=>true), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("views/promotions/components/bonuses_group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('prefix'=>"promotion_data[bonuses]",'group'=>$_smarty_tpl->tpl_vars['promotion_data']->value['bonuses'],'zone'=>(($tmp = @$_smarty_tpl->tpl_vars['promotion_data']->value['zone'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['zone']->value : $tmp),'hide_add_buttons'=>!$_smarty_tpl->tpl_vars['allow_save']->value), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[promotions.update]",'hide_first_button'=>$_smarty_tpl->tpl_vars['hide_first_button']->value,'hide_second_button'=>$_smarty_tpl->tpl_vars['hide_second_button']->value,'but_target_form'=>"promotion_form",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
<?php }?>
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['title']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>true,'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>
