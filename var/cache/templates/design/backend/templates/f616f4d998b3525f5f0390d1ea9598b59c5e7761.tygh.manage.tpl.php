<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 02:11:46
         compiled from "/var/www/4profit4good/design/backend/templates/views/profiles/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:87790885352323c228ac266-95447293%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'f616f4d998b3525f5f0390d1ea9598b59c5e7761' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/profiles/manage.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '87790885352323c228ac266-95447293',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52323c22d5c0e9_72141427',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52323c22d5c0e9_72141427')) {function content_52323c22d5c0e9_72141427($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
?><?php
fn_preload_lang_vars(array('id','username','name','email','registered','type','status','view','administrator','vendor_administrator','customer','affiliate','view_all_orders','act_on_behalf','edit','delete','notify_user','no_data','export_selected','export_selected','users','add_user','add_users'));
?>
...
</a><?php }else{ ?>-<?php }?><?php if ($_smarty_tpl->tpl_vars['user']->value['company_id']){?><?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('object'=>$_smarty_tpl->tpl_vars['user']->value), 0);?>
<?php }?></td>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php if ($_smarty_tpl->tpl_vars['users']->value){?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']&&$_REQUEST['user_type']=="C"&&!fn_allowed_for("ULTIMATE")){?>
                ...
                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("export_selected"),'dispatch'=>"dispatch[profiles.export_range]",'class'=>"cm-confirm cm-process-items"));?>
</li>
            <?php }else{ ?>
                <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"profiles:list_tools")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"profiles:list_tools"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php smarty_template_function_dropdown($_smarty_tpl,array('content'=>Smarty::$_smarty_vars['capture']['tools_list'],'no_caret'=>true,'icon'=>"icon-plus",'title'=>__("add_users")));?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("sidebar", null, null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/saved_search.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"profiles.manage",'view_type'=>"users"), 0);?>

    <?php echo $_smarty_tpl->getSubTemplate ("views/profiles/components/users_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"profiles.manage"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['_title']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'content_id'=>"manage_users"), 0);?>
<?php }} ?>