<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 03:45:48
         compiled from "/var/www/4profit4good/design/backend/templates/views/pages/components/pages_tree.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1701307332522d0c2cda08d2-14929417%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4a751cd0e7a8f28fa43a0b0d9f9e8d405d60b382' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/pages/components/pages_tree.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1701307332522d0c2cda08d2-14929417',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d0c2d083ca0_01656216',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d0c2d083ca0_01656216')) {function content_522d0c2d083ca0_01656216($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
?><?php
...
)</span><?php }?><div class="shift-left"><?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('object'=>$_smarty_tpl->tpl_vars['page']->value), 0);?>
</div></div>
    </td>
    <?php if (!$_smarty_tpl->tpl_vars['picker']->value){?>
    <td width="10%">
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <td width="10%" class="nowrap right">
        <?php if (fn_allowed_for("ULTIMATE")&&$_smarty_tpl->tpl_vars['allow_save']->value||!fn_allowed_for("ULTIMATE")){?>
            <?php echo $_smarty_tpl->getSubTemplate ("common/select_popup.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>$_smarty_tpl->tpl_vars['page']->value['page_id'],'status'=>$_smarty_tpl->tpl_vars['page']->value['status'],'hidden'=>true,'object_id_name'=>"page_id",'table'=>"pages"), 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['page']->value['subpages']||$_smarty_tpl->tpl_vars['page']->value['has_children']){?>
    <?php echo $_smarty_tpl->getSubTemplate ("views/pages/components/pages_tree.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('pages_tree'=>$_smarty_tpl->tpl_vars['page']->value['subpages'],'parent_id'=>$_smarty_tpl->tpl_vars['page']->value['page_id']), 0);?>
