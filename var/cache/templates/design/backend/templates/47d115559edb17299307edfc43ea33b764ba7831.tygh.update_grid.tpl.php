<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 01:40:48
         compiled from "/var/www/4profit4good/design/backend/templates/views/block_manager/update_grid.tpl" */ ?>
<?php /*%%SmartyHeaderCode:162779667522ceee101ada9-86477286%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '47d115559edb17299307edfc43ea33b764ba7831' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/block_manager/update_grid.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '162779667522ceee101ada9-86477286',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522ceee11072d0_80160475',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522ceee11072d0_80160475')) {function content_522ceee11072d0_80160475($_smarty_tpl) {?><?php
...
" method="post" class="form-horizontal form-edit " name="grid_update_form">
<input type="hidden" name="grid_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
" />

<input type="hidden" name="container_id" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['params']->value['container_id'], ENT_QUOTES, 'UTF-8');?>
" />
<input type="hidden" name="parent_id" value="<?php echo htmlspecialchars((($tmp = @(($tmp = @$_smarty_tpl->tpl_vars['params']->value['parent_id'])===null||$tmp==='' ? $_smarty_tpl->tpl_vars['grid']->value['parent_id'] : $tmp))===null||$tmp==='' ? 0 : $tmp), ENT_QUOTES, 'UTF-8');?>
" />
...
$_smarty_tpl->tpl_vars['smarty']->value['section']["width"]['start'] = (int)(($tmp = @$_smarty_tpl->tpl_vars['params']->value['min_width'])===null||$tmp==='' ? 1 : $tmp)-(($tmp = @1)===null||$tmp==='' ? 0 : $tmp);
$_smarty_tpl->tpl_vars['smarty']->value['section']["width"]['loop'] = is_array($_loop=(($tmp = @$_smarty_tpl->tpl_vars['params']->value['max_width'])===null||$tmp==='' ? 24 : $tmp)) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
...
$_smarty_tpl->tpl_vars['smarty']->value['section']["offset"]['loop'] = is_array($_loop=(($tmp = @$_smarty_tpl->tpl_vars['params']->value['max_width'])===null||$tmp==='' ? 24 : $tmp)) ? count($_loop) : max(0, (int)$_loop); unset($_loop);
