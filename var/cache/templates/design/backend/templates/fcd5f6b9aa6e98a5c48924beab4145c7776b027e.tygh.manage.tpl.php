<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:30:40
         compiled from "/var/www/4profit4good/design/backend/templates/views/product_features/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:47074502252333db0876fb4-91798790%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'fcd5f6b9aa6e98a5c48924beab4145c7776b027e' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/product_features/manage.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '47074502252333db0876fb4-91798790',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333db0a7bb57_92043884',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333db0a7bb57_92043884')) {function content_52333db0a7bb57_92043884($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
?><?php
...
?>
        <?php if ($_smarty_tpl->tpl_vars['gr_feature']->value['feature_type']=="G"){?>
            ...
            <?php if (!fn_allow_save_object($_smarty_tpl->tpl_vars['gr_feature']->value,"product_features")){?>
                <?php ob_start();?><?php echo $_smarty_tpl->__("viewing_feature");?>
<?php $_tmp3=ob_get_clean();?><?php echo $_smarty_tpl->getSubTemplate ("common/object_group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>$_smarty_tpl->tpl_vars['gr_feature']->value['feature_id'],'details'=>$_smarty_tpl->tpl_vars['gr_feature']->value['feature_description'],'text'=>$_smarty_tpl->tpl_vars['gr_feature']->value['description'],'status'=>$_smarty_tpl->tpl_vars['gr_feature']->value['status'],'hidden'=>true,'href'=>"product_features.update?feature_id=".((string)$_smarty_tpl->tpl_vars['gr_feature']->value['feature_id'])."&return_url=".((string)$_smarty_tpl->tpl_vars['r_url']->value),'object_id_name'=>"feature_id",'table'=>"product_features",'additional_class'=>"cm-hide-inputs",'header_text'=>$_tmp3.": ".((string)$_smarty_tpl->tpl_vars['gr_feature']->value['description']),'no_table'=>true,'link_meta'=>"strong",'link_text'=>__("view"),'non_editable'=>true,'is_view_link'=>true,'company_object'=>$_smarty_tpl->tpl_vars['gr_feature']->value), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("add_new_picker", null, null); ob_start(); ?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/product_features/update.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('feature'=>array(),'is_group'=>true), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <li><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_group",'text'=>__("new_group"),'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'link_text'=>__("add_group"),'act'=>"link",'icon'=>"true"), 0);?>
</li>

        <?php $_smarty_tpl->_capture_stack[0][] = array("add_new_picker_2", null, null); ob_start(); ?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/product_features/update.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('feature'=>array()), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <li><?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_feature",'text'=>__("new_feature"),'content'=>Smarty::$_smarty_vars['capture']['add_new_picker_2'],'link_text'=>__("add_feature"),'act'=>"link",'icon'=>"true"), 0);?>
</li>
    <?php list($_capture_buffer, $_capture_assign, $_capture_append) = array_pop($_smarty_tpl->_capture_stack[0]);
if (!empty($_capture_buffer)) {
 if (isset($_capture_assign)) $_smarty_tpl->assign($_capture_assign, ob_get_contents());
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php smarty_template_function_dropdown($_smarty_tpl,array('content'=>Smarty::$_smarty_vars['capture']['tools_list'],'icon'=>"icon-plus",'no_caret'=>true,'title'=>__("add_feature")));?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("sidebar", null, null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/saved_search.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"product_features.manage",'view_type'=>"product_features"), 0);?>

    <?php echo $_smarty_tpl->getSubTemplate ("views/product_features/components/product_features_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"product_features.manage"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("features"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>true,'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar']), 0);?>
<?php }} ?>