<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 00:38:59
         compiled from "/var/www/4profit4good/design/backend/templates/common/quick_menu.tpl" */ ?>
<?php /*%%SmartyHeaderCode:783953767522ce0632541a3-78604122%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '3f7d0dbfa63a4a6d65e0310938372b601b7da321' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/common/quick_menu.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '783953767522ce0632541a3-78604122',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522ce06339bd64_21439839',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522ce06339bd64_21439839')) {function content_522ce06339bd64_21439839($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
?><?php
...
<div class="quick-menu-container" id="quick_menu">
    <div class="quick-menu">
        <a id="sw_quick_menu_content"
           class="cm-combo-<?php if ($_smarty_tpl->tpl_vars['edit_quick_menu']->value||$_smarty_tpl->tpl_vars['expand_quick_menu']->value){?>off<?php }else{ ?>on<?php }?> cm-combination"<?php if ($_smarty_tpl->tpl_vars['settings']->value['show_menu_mouseover']=="Y"){?> onmouseover="fn_quick_menu_mouse_action(this, true);" onmouseout="fn_quick_menu_mouse_action(this, false);"<?php }?>><?php echo $_smarty_tpl->__("quick_menu");?>
</a>
    </div>
        ...
        <div id="quick_box" class="hidden quick-menu-popup">
            ...
            <div id="quick_menu_language_selector">
                <?php if (!fn_allowed_for("ULTIMATE:FREE")){?>
                    <?php echo $_smarty_tpl->getSubTemplate ("common/select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('style'=>"graphic",'link_tpl'=>fn_link_attach("tools.get_quick_menu_variant","descr_sl="),'items'=>$_smarty_tpl->tpl_vars['languages']->value,'selected_id'=>@constant('DESCR_SL'),'key_name'=>"name",'suffix'=>"quick_menu",'display_icons'=>true,'select_container_id'=>"quick_menu_language_selector"), 0);?>
...
:</label>
                ...
                <div class="buttons-container">
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[tools.update_quick_menu_item.edit]",'cancel_action'=>"close"), 0);?>
