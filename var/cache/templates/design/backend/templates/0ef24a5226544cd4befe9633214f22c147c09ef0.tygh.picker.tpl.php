<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 05:32:46
         compiled from "/var/www/4profit4good/design/backend/templates/addons/banners/pickers/banners/picker.tpl" */ ?>
<?php /*%%SmartyHeaderCode:922443780522d253eaef991-48932737%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0ef24a5226544cd4befe9633214f22c147c09ef0' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/addons/banners/pickers/banners/picker.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '922443780522d253eaef991-48932737',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d253ec0b7c2_98518893',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d253ec0b7c2_98518893')) {function content_522d253ec0b7c2_98518893($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/function.math.php';
...
"<?php if (!$_smarty_tpl->tpl_vars['item_ids']->value){?> class="hidden"<?php }?>>
    <?php echo $_smarty_tpl->getSubTemplate ("addons/banners/pickers/banners/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('banner_id'=>((string)$_smarty_tpl->tpl_vars['ldelim']->value)."banner_id".((string)$_smarty_tpl->tpl_vars['rdelim']->value),'holder'=>$_smarty_tpl->tpl_vars['data_id']->value,'input_name'=>$_smarty_tpl->tpl_vars['input_name']->value,'clone'=>true,'hide_link'=>$_smarty_tpl->tpl_vars['hide_link']->value,'hide_delete_button'=>$_smarty_tpl->tpl_vars['hide_delete_button']->value,'position_field'=>$_smarty_tpl->tpl_vars['positions']->value,'position'=>"0"), 0);?>
...
?>
        <?php echo $_smarty_tpl->getSubTemplate ("addons/banners/pickers/banners/js.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('banner_id'=>$_smarty_tpl->tpl_vars['p_id']->value,'holder'=>$_smarty_tpl->tpl_vars['data_id']->value,'input_name'=>$_smarty_tpl->tpl_vars['input_name']->value,'hide_link'=>$_smarty_tpl->tpl_vars['hide_link']->value,'hide_delete_button'=>$_smarty_tpl->tpl_vars['hide_delete_button']->value,'first_item'=>$_smarty_tpl->getVariable('smarty')->value['foreach']['items']['first'],'position_field'=>$_smarty_tpl->tpl_vars['positions']->value,'position'=>$_smarty_tpl->getVariable('smarty')->value['foreach']['items']['iteration']), 0);?>
