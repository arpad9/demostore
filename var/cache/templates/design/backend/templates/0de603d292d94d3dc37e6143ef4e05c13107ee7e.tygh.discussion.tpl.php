<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 02:21:23
         compiled from "/var/www/4profit4good/design/backend/templates/addons/discussion/views/discussion_manager/components/discussion.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1568859756522cf863b073f5-60129609%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0de603d292d94d3dc37e6143ef4e05c13107ee7e' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/addons/discussion/views/discussion_manager/components/discussion.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1568859756522cf863b073f5-60129609',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf863c2af91_23067208',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf863c2af91_23067208')) {function content_522cf863c2af91_23067208($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
...
<?php if (($_smarty_tpl->tpl_vars['discussion']->value['object_type']!="M"||!$_smarty_tpl->tpl_vars['runtime']->value['company_id'])&&fn_check_view_permissions("discussion.update")){?>
<?php $_smarty_tpl->tpl_vars['allow_save'] = new Smarty_variable(true, null, 0);?>
<?php }?>
<div class="<?php if ($_smarty_tpl->tpl_vars['allow_save']->value){?>cm-no-hide-input<?php }else{ ?>cm-hide-inputs<?php }?>" id="content_discussion">
<div class="clearfix">
            ...
            <?php if (fn_check_view_permissions("discussion_manager")){?>
                <?php if ($_smarty_tpl->tpl_vars['discussion']->value['object_type']=="E"){?>
                    <?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
                        <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_post",'title'=>__("add_post"),'icon'=>"icon-plus",'act'=>"general",'link_class'=>"cm-dialog-switch-avail"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <?php }else{ ?>
                    <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_post",'link_text'=>__("add_post"),'act'=>"general",'link_class'=>"cm-dialog-switch-avail"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/pagination.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('save_current_page'=>true,'id'=>"pagination_discussion",'search'=>$_smarty_tpl->tpl_vars['discussion']->value['search']), 0);?>
...
<div class="post-item <?php if ($_smarty_tpl->tpl_vars['discussion']->value['object_type']=="O"){?><?php if ($_smarty_tpl->tpl_vars['post']->value['user_id']==$_smarty_tpl->tpl_vars['user_id']->value){?>incoming<?php }else{ ?>outgoing<?php }?><?php }?>">
    <?php $_smarty_tpl->smarty->_tag_stack[] = array('hook', array('name'=>"discussion:items_list_row")); $_block_repeat=true; echo smarty_block_hook(array('name'=>"discussion:items_list_row"), null, $_smarty_tpl, $_block_repeat);while ($_block_repeat) { ob_start();?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("addons/discussion/views/discussion_manager/components/post.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('post'=>$_smarty_tpl->tpl_vars['post']->value,'type'=>$_smarty_tpl->tpl_vars['discussion']->value['type']), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/pagination.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"pagination_discussion",'search'=>$_smarty_tpl->tpl_vars['discussion']->value['search']), 0);?>
...
<?php if (fn_check_view_permissions("discussion_manager")){?>
    ...
    <div class="tabs cm-j-tabs">
        <ul class="nav nav-tabs">
            <li id="tab_add_post" class="cm-js cm-active active"><a><?php echo $_smarty_tpl->__("general");?>
</a></li>
        </ul>
    </div>
...
<?php }?>" disabled="disabled">
    ...
    <div class="control-group">
        ...
        <div class="controls clearfix">
            <?php echo $_smarty_tpl->getSubTemplate ("addons/discussion/views/discussion_manager/components/rate.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('rate_id'=>"rating_value",'rate_name'=>"post_data[rating_value]",'disabled'=>true), 0);?>
...
:</label>
    ...
    <div class="buttons-container">
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("add"),'but_name'=>"dispatch[discussion.add]",'cancel_action'=>"close",'hide_first_button'=>false), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_post",'text'=>__("new_post"),'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'act'=>"fake"), 0);?>
