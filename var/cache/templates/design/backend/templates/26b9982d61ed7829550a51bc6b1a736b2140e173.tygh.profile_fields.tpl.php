<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 02:12:32
         compiled from "/var/www/4profit4good/design/backend/templates/views/profiles/components/profile_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:71446460252323c500c1703-04033022%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '26b9982d61ed7829550a51bc6b1a736b2140e173' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/profiles/components/profile_fields.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '71446460252323c500c1703-04033022',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52323c503e5aa3_09319472',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52323c503e5aa3_09319472')) {function content_52323c503e5aa3_09319472($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
?><?php
...
<label for="elm_ship_to_another">
     <input class="hidden" id="elm_ship_to_another" type="checkbox" name="ship_to_another" value="1" <?php if ($_smarty_tpl->tpl_vars['ship_to_another']->value){?>checked="checked"<?php }?> />
        <span <?php if ($_smarty_tpl->tpl_vars['ship_to_another']->value){?>class="hidden"<?php }?> id="on_sta_notice">
            <?php echo $_smarty_tpl->__("text_ship_to_billing");?>
.&nbsp;<a class="cm-combination dashed cm-hide-with-inputs" onclick="Tygh.$('#sa').switchAvailability(false); Tygh.$('#elm_ship_to_another').click();"><?php echo $_smarty_tpl->__("ship_to_another");?>
</a>
        </span>
        <span <?php if (!$_smarty_tpl->tpl_vars['ship_to_another']->value){?>class="hidden"<?php }?> id="off_sta_notice">
            <a class="cm-combination dashed cm-hide-with-inputs" onclick="Tygh.$('#sa').switchAvailability(true); Tygh.$('#elm_ship_to_another').click();"><?php echo $_smarty_tpl->__("text_ship_to_billing");?>
</a>
        </span>
</label>
