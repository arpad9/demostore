<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:29:18
         compiled from "/var/www/4profit4good/design/backend/templates/views/usergroups/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:2109767652333d5e620439-54230067%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '20d72ab97ac6ec3b9d56edabebaae214c2272f7b' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/usergroups/manage.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '2109767652333d5e620439-54230067',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333d5e7797e6_83629557',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333d5e7797e6_83629557')) {function content_52333d5e7797e6_83629557($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['usergroup']->value['usergroup'], ENT_QUOTES, 'UTF-8');?>
    ...
    <td class="row-status">
        <?php if ($_smarty_tpl->tpl_vars['usergroup']->value['type']=="C"){?><?php echo $_smarty_tpl->__("customer");?>
<?php }?>
        <?php if ($_smarty_tpl->tpl_vars['usergroup']->value['type']=="A"){?><?php echo $_smarty_tpl->__("administrator");?>
<?php }?>
    </td>
    <td class="row-status">
        ...
        <?php $_smarty_tpl->_capture_stack[0][] = array("tools_list", null, null); ob_start(); ?>
            ...
            <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"list",'text'=>__("delete"),'class'=>"cm-confirm",'href'=>"usergroups.delete?usergroup_id=".((string)$_smarty_tpl->tpl_vars['usergroup']->value['usergroup_id'])));?>
</li>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php if (fn_check_view_permissions("usergroups.update")){?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("add_new_picker", null, null); ob_start(); ?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/usergroups/update.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('usergroup'=>array()), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_usergroups",'text'=>__("new_usergroups"),'title'=>__("new_usergroups"),'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'act'=>"general",'icon'=>"icon-plus"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("usergroups"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons'],'select_languages'=>true), 0);?>
<?php }} ?>