<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 00:39:18
         compiled from "/var/www/4profit4good/design/backend/templates/views/settings_wizard/view.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1558261243522ce0760d8017-83297555%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '29146f973a9afc6d55ad1c1f4f7f80d72b6f654e' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/settings_wizard/view.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1558261243522ce0760d8017-83297555',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522ce0761f0c53_60780915',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522ce0761f0c53_60780915')) {function content_522ce0761f0c53_60780915($_smarty_tpl) {?><?php
...
?>
                ...
                <?php }elseif($_smarty_tpl->tpl_vars['item']->value['type']=="template"){?>
                    <p><?php echo $_smarty_tpl->getSubTemplate ($_smarty_tpl->tpl_vars['item']->value['template'], $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</p>
            
                <?php }elseif($_smarty_tpl->tpl_vars['item']->value['type']=="setting"){?>
                    <p><?php echo $_smarty_tpl->getSubTemplate ("common/settings_fields.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('class'=>"setting-wide",'item'=>$_smarty_tpl->tpl_vars['item']->value['setting_data'],'html_id'=>"field_".((string)$_smarty_tpl->tpl_vars['item']->value['setting_data']['name']),'html_name'=>"settings[".((string)$_smarty_tpl->tpl_vars['item']->value['setting_data']['name'])."]"), 0);?>
</p>
...
"><?php echo $_smarty_tpl->__("close");?>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_id'=>"settings_wizard_next_step",'but_text'=>__("next_step"),'but_name'=>"dispatch[settings_wizard.next_step]",'but_role'=>"submit-link",'but_target_form'=>"settings_wizard_form",'but_meta'=>"btn btn-primary"), 0);?>


    <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("finish"),'but_name'=>"dispatch[settings_wizard.next_step.finish]",'but_role'=>"submit-link",'but_meta'=>"cm-no-ajax",'but_target_form'=>"settings_wizard_form"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("settings_wizard"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons']), 0);?>
