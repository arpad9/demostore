<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:24:48
         compiled from "/var/www/4profit4good/design/backend/templates/views/statuses/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:127045272352333c501602b1-09125319%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5b1519b317810d7d042fb53172decebced704270' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/statuses/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '127045272352333c501602b1-09125319',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333c502ee818_79039166',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333c502ee818_79039166')) {function content_52333c502ee818_79039166($_smarty_tpl) {?><?php
...
" method="post" name="update_status_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['st']->value, ENT_QUOTES, 'UTF-8');?>
_form" class="form-horizontal">
<input type="hidden" name="type" value="<?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['type']->value)===null||$tmp==='' ? "O" : $tmp), ENT_QUOTES, 'UTF-8');?>
">
...
" <?php if ($_smarty_tpl->tpl_vars['disable_input']->value){?>disabled="disabled"<?php }?>>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>$_smarty_tpl->tpl_vars['id']->value,'name'=>"update_all_vendors[email_subj]",'hide_element'=>"email_subj_".((string)$_smarty_tpl->tpl_vars['id']->value)), 0);?>
...
" name="status_data[email_header]" class="cm-wysiwyg input-textarea-long" <?php if ($_smarty_tpl->tpl_vars['disable_input']->value){?>disabled="disabled"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status_data']->value['email_header'], ENT_QUOTES, 'UTF-8');?>
            ...
            <?php if (fn_allowed_for("ULTIMATE")){?>
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['show_update_for_all']->value,'object_id'=>$_smarty_tpl->tpl_vars['id']->value,'name'=>"update_all_vendors[email_header]",'hide_element'=>"email_header_".((string)$_smarty_tpl->tpl_vars['id']->value)), 0);?>
...
" class="control-label<?php if ($_smarty_tpl->tpl_vars['data']->value['type']=="color"){?> cm-color<?php }?>"><?php echo $_smarty_tpl->__($_smarty_tpl->tpl_vars['data']->value['label']);?>
            ...
            <div class="controls">
                ...
                <?php }else{ ?>
                    <?php $_smarty_tpl->tpl_vars["param_value"] = new Smarty_variable('', null, 0);?>
                <?php }?>
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['name']->value, ENT_QUOTES, 'UTF-8');?>
" value="Y" <?php if (($_smarty_tpl->tpl_vars['status_data']->value&&$_smarty_tpl->tpl_vars['status_data']->value['params'][$_smarty_tpl->tpl_vars['name']->value]=="Y")||(!$_smarty_tpl->tpl_vars['status_data']->value&&$_smarty_tpl->tpl_vars['data']->value['default_value']=="Y")){?> checked="checked"<?php }?> class="checkbox">

                <?php }elseif($_smarty_tpl->tpl_vars['data']->value['type']=="status"){?>
                    <?php echo $_smarty_tpl->getSubTemplate ("common/status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('status'=>$_smarty_tpl->tpl_vars['param_value']->value,'display'=>"select",'name'=>"status_data[params][".((string)$_smarty_tpl->tpl_vars['name']->value)."]",'status_type'=>$_smarty_tpl->tpl_vars['data']->value['status_type'],'select_id'=>"status_param_".((string)$_smarty_tpl->tpl_vars['id']->value)."_".((string)$_smarty_tpl->tpl_vars['name']->value)), 0);?>


                <?php }elseif($_smarty_tpl->tpl_vars['data']->value['type']=="color"){?>
                    <?php echo $_smarty_tpl->getSubTemplate ("common/colorpicker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('cp_name'=>"status_data[params][".((string)$_smarty_tpl->tpl_vars['name']->value)."]",'cp_id'=>"status_param_".((string)$_smarty_tpl->tpl_vars['id']->value)."_".((string)$_smarty_tpl->tpl_vars['name']->value),'cp_value'=>$_smarty_tpl->tpl_vars['param_value']->value), 0);?>
...
<div class="buttons-container">
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[statuses.update]",'cancel_action'=>"close",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
