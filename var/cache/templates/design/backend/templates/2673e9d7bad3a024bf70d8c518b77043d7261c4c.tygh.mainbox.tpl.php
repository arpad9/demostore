<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 00:38:58
         compiled from "/var/www/4profit4good/design/backend/templates/common/mainbox.tpl" */ ?>
<?php /*%%SmartyHeaderCode:956913644522ce06276e0e7-83853656%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '2673e9d7bad3a024bf70d8c518b77043d7261c4c' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/common/mainbox.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '956913644522ce06276e0e7-83853656',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522ce0628d5bb1_58562234',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522ce0628d5bb1_58562234')) {function content_522ce0628d5bb1_58562234($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
if (!is_callable('smarty_block_notes')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.notes.php';
?><?php
...
<div class="actions cm-sticky-scroll">
    <?php if (!$_smarty_tpl->tpl_vars['no_sidebar']->value){?>
        <div class="btn-bar-left pull-left">
            <div class="pull-left"><?php echo $_smarty_tpl->getSubTemplate ("common/last_viewed_items.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</div>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('hide_actions'=>true,'tools_list'=>Smarty::$_smarty_vars['capture']['tools_list'],'link_text'=>__("choose_action")), 0);?>
        ...
        <?php if ($_smarty_tpl->tpl_vars['select_languages']->value&&sizeof($_smarty_tpl->tpl_vars['languages']->value)>1){?>
            <div class="sidebar-row">
                <?php if (!fn_allowed_for("ULTIMATE:FREE")){?>
                    <?php echo $_smarty_tpl->getSubTemplate ("common/select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('style'=>"graphic",'link_tpl'=>fn_link_attach($_smarty_tpl->tpl_vars['config']->value['current_url'],"descr_sl="),'items'=>$_smarty_tpl->tpl_vars['languages']->value,'selected_id'=>@constant('DESCR_SL'),'key_name'=>"name",'suffix'=>"content",'display_icons'=>true), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/sidebox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('content'=>$_smarty_tpl->tpl_vars['note']->value,'title'=>Smarty::$_smarty_vars['capture']['note_title']), 0);?>
