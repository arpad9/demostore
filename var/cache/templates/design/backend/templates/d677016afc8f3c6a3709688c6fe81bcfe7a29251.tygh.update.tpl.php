<?php /* Smarty version Smarty-3.1.13, created on 2013-09-20 22:12:48
         compiled from "/var/www/4profit4good/design/backend/templates/views/payments/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:571158576523d00a0b975a5-34422752%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'd677016afc8f3c6a3709688c6fe81bcfe7a29251' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/payments/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '571158576523d00a0b975a5-34422752',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_523d00a0db2074_68315421',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_523d00a0db2074_68315421')) {function content_523d00a0db2074_68315421($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
...
">
        ...
        <?php if (fn_allowed_for("ULTIMATE")&&$_smarty_tpl->tpl_vars['allow_save']->value){?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_field.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"payment_data[company_id]",'id'=>"payment_data_".((string)$_REQUEST['payment_id']),'selected'=>$_smarty_tpl->tpl_vars['payment']->value['company_id']), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_payments_update_template")), 0);?>
:</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_payments_update_surcharge_title")), 0);?>
:</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_payments_update_taxes")), 0);?>
:</label>
            <div class="controls">
...
" name="payment_data[instructions]" cols="55" rows="8" class="cm-wysiwyg input-textarea-long"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment']->value['instructions'], ENT_QUOTES, 'UTF-8');?>
        ...
        <?php if (!$_smarty_tpl->tpl_vars['id']->value){?>
            <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"payment_data[status]",'id'=>"elm_payment_status_".((string)$_smarty_tpl->tpl_vars['id']->value),'obj_id'=>$_smarty_tpl->tpl_vars['id']->value,'obj'=>$_smarty_tpl->tpl_vars['payment']->value), 0);?>

        <?php }?>

        <?php echo $_smarty_tpl->getSubTemplate ("views/localizations/components/select.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_name'=>"payment_data[localization]",'id'=>"elm_payment_localization_".((string)$_smarty_tpl->tpl_vars['id']->value),'data_from'=>$_smarty_tpl->tpl_vars['payment']->value['localization']), 0);?>


        <div class="control-group">
            <label class="control-label"><?php echo $_smarty_tpl->__("icon");?>
:</label>
            <div class="controls"><?php echo $_smarty_tpl->getSubTemplate ("common/attach_images.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('image_name'=>"payment_image",'image_key'=>$_smarty_tpl->tpl_vars['id']->value,'image_object_type'=>"payment",'image_pair'=>$_smarty_tpl->tpl_vars['payment']->value['icon'],'no_detailed'=>"Y",'hide_titles'=>"Y",'image_object_id'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
</div>
        </div>
...
<?php if (!$_smarty_tpl->tpl_vars['hide_for_vendor']->value){?>
    <div class="buttons-container">
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[payments.update]",'cancel_action'=>"close",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
