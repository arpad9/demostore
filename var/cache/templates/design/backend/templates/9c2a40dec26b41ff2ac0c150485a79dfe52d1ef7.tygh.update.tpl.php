<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:30:40
         compiled from "/var/www/4profit4good/design/backend/templates/views/product_features/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:90873847752333db0acb737-76607929%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '9c2a40dec26b41ff2ac0c150485a79dfe52d1ef7' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/product_features/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '90873847752333db0acb737-76607929',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333db0d75851_46110897',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333db0d75851_46110897')) {function content_52333db0d75851_46110897($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
?><?php
...
" />
        ...
        <?php if (fn_allowed_for("ULTIMATE")){?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_field.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"feature_data[company_id]",'id'=>"elm_feature_data_".((string)$_smarty_tpl->tpl_vars['id']->value),'selected'=>$_smarty_tpl->tpl_vars['feature']->value['company_id']), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_features_update_feature_display_on_product")), 0);?>
</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_features_update_feature_display_on_catalog")), 0);?>
</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_features_update_feature_display_on_header")), 0);?>
</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_features_update_prefix")), 0);?>
</label>
            <div class="controls">
...
<?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>__("tt_views_product_features_update_suffix")), 0);?>
</label>
            <div class="controls">
...
--></div>
    <?php if ($_smarty_tpl->tpl_vars['id']->value&&$_smarty_tpl->tpl_vars['id']->value!="0G"){?>
        <?php echo $_smarty_tpl->getSubTemplate ("views/product_features/components/variants_list.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
<div class="buttons-container">
    ...
    <?php }?>
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[product_features.update]",'cancel_action'=>"close",'hide_first_button'=>$_smarty_tpl->tpl_vars['hide_first_button']->value,'save'=>$_smarty_tpl->tpl_vars['feature']->value['feature_id']), 0);?>
