<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 00:39:18
         compiled from "/var/www/4profit4good/design/backend/templates/common/settings_fields.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1309100161522ce076242a47-13404137%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '31d99d1d1d262f0a70be28ce34bc502d3e2bd86d' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/common/settings_fields.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1309100161522ce076242a47-13404137',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522ce0764de1c4_10260231',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522ce0764de1c4_10260231')) {function content_522ce0764de1c4_10260231($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/var/www/4profit4good/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
fn_preload_lang_vars(array('multiple_selectbox_notice','select_country','select_state','browse'));
?>
...
<?php }elseif($_smarty_tpl->tpl_vars['item']->value['type']=="E"){?>
    <div><?php echo $_smarty_tpl->getSubTemplate ("addons/".((string)$_REQUEST['addon'])."/settings/".((string)$_smarty_tpl->tpl_vars['item']->value['value']), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
</div>
<?php }elseif($_smarty_tpl->tpl_vars['item']->value['type']=="Z"){?>
    <div><?php echo $_smarty_tpl->getSubTemplate ("addons/".((string)$_REQUEST['addon'])."/settings/".((string)$_smarty_tpl->tpl_vars['item']->value['value']), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('skip_addon_check'=>true), 0);?>
</div>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['item']->value['description'],'target'=>"#collapsable_".((string)$_smarty_tpl->tpl_vars['html_id']->value)), 0);?>
...
<?php if ($_smarty_tpl->tpl_vars['item']->value['tooltip']){?><?php echo $_smarty_tpl->getSubTemplate ("common/tooltip.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tooltip'=>$_smarty_tpl->tpl_vars['item']->value['tooltip']), 0);?>
<?php }?>:
        </label>
...
" class="<?php if ($_smarty_tpl->tpl_vars['item']->value['type']=="U"){?> cm-value-integer<?php }?>" <?php if ($_smarty_tpl->tpl_vars['disable_input']->value){?>disabled="disabled"<?php }?> />
            ...
            <div class="right update-for-all">
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/update_for_all.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('display'=>$_smarty_tpl->tpl_vars['item']->value['update_for_all'],'object_id'=>$_smarty_tpl->tpl_vars['item']->value['object_id'],'name'=>"update_all_vendors[".((string)$_smarty_tpl->tpl_vars['item']->value['object_id'])."]",'hide_element'=>$_smarty_tpl->tpl_vars['html_id']->value), 0);?>
...
<?php }elseif($_smarty_tpl->tpl_vars['item']->value['type']=="B"){?>
    <div class="control-group">
        <?php echo $_smarty_tpl->getSubTemplate ("common/selectable_box.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('addon'=>$_smarty_tpl->tpl_vars['section']->value,'name'=>$_smarty_tpl->tpl_vars['html_name']->value,'id'=>$_smarty_tpl->tpl_vars['html_id']->value,'fields'=>$_smarty_tpl->tpl_vars['item']->value['variants'],'selected_fields'=>$_smarty_tpl->tpl_vars['item']->value['value']), 0);?>

    </div>
<?php }?>
<?php if ($_smarty_tpl->tpl_vars['total']->value-1==$_smarty_tpl->tpl_vars['index']->value&&Smarty::$_smarty_vars['capture']['header_first']=='true'){?>
    </fieldset>
        </div>
<?php }?><?php }} ?>