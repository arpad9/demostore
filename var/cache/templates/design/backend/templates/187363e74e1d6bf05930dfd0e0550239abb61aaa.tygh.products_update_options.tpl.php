<?php /* Smarty version Smarty-3.1.13, created on 2013-09-15 07:40:16
         compiled from "/var/www/4profit4good/design/backend/templates/views/products/components/products_update_options.tpl" */ ?>
<?php /*%%SmartyHeaderCode:211982078852352c20ce9b43-96195876%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '187363e74e1d6bf05930dfd0e0550239abb61aaa' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/products/components/products_update_options.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '211982078852352c20ce9b43-96195876',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52352c20dcc826_15624047',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52352c20dcc826_15624047')) {function content_52352c20dcc826_15624047($_smarty_tpl) {?><?php
...
: <?php echo htmlspecialchars(fn_get_company_name($_smarty_tpl->tpl_vars['option_']->value['company_id']), ENT_QUOTES, 'UTF-8');?>
                ...
                <div class="buttons-container">
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("apply"),'but_name'=>"dispatch[products.apply_global_option]",'cancel_action'=>"close"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
        ...
        <div class="pull-right shift-left">
            <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_global_option",'text'=>__("add_global_option"),'content'=>Smarty::$_smarty_vars['capture']['add_global_option'],'link_text'=>__("add_global_option"),'act'=>"general"), 0);?>
    ...
    <div class="pull-left">
        <?php if ($_smarty_tpl->tpl_vars['product_options']->value){?>
            <?php if (!fn_allowed_for("ULTIMATE:FREE")){?>
                ...
                <?php }?>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>$_smarty_tpl->tpl_vars['except_title']->value,'but_href'=>"product_options.exceptions?product_id=".((string)$_smarty_tpl->tpl_vars['product_data']->value['product_id']),'but_meta'=>"btn",'but_role'=>"text"), 0);?>
            ...
            <?php }else{ ?>
                ...
                <?php }else{ ?>
                    <?php $_smarty_tpl->tpl_vars["except_title"] = new Smarty_variable($_smarty_tpl->__("allowed_combinations"), null, 0);?>
                <?php }?>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>$_smarty_tpl->tpl_vars['except_title']->value,'but_meta'=>"btn cm-promo-popup",'but_role'=>"text"), 0);?>

            <?php }?>

            <?php if ($_smarty_tpl->tpl_vars['has_inventory']->value){?>
                <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("option_combinations"),'but_href'=>"product_options.inventory?product_id=".((string)$_smarty_tpl->tpl_vars['product_data']->value['product_id']),'but_meta'=>"btn",'but_role'=>"text"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
                ...
                <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('act'=>"button",'id'=>"content_option_combinations",'text'=>__("note"),'content'=>Smarty::$_smarty_vars['capture']['notes_picker'],'link_text'=>__("option_combinations"),'but_href'=>"product_options.inventory?product_id=".((string)$_smarty_tpl->tpl_vars['product_data']->value['product_id']),'but_role'=>"text",'extra_act'=>"notes"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("views/product_options/manage.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('object'=>"product",'extra'=>Smarty::$_smarty_vars['capture']['extra'],'product_id'=>$_REQUEST['product_id'],'view_mode'=>"embed"), 0);?>
<?php }} ?>