<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 19:40:35
         compiled from "/var/www/4profit4good/design/backend/templates/views/companies/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1563937509523331f3373fb2-68282681%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c3ae45707ec14c97318413b600aed4e8d1a2073a' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/companies/manage.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1563937509523331f3373fb2-68282681',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_523331f35f0dd0_83766165',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_523331f35f0dd0_83766165')) {function content_523331f35f0dd0_83766165($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/4profit4good/app/lib/other/smarty/plugins/modifier.date_format.php';
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['company']->value['storefront'], ENT_QUOTES, 'UTF-8');?>
</a></td>
    <?php }?>
...
<?php if ($_smarty_tpl->tpl_vars['companies']->value){?>
    ...
    <?php $_smarty_tpl->_capture_stack[0][] = array("activate_selected", null, null); ob_start(); ?>
        <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/reason_container.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('type'=>"activate"), 0);?>

        <div class="buttons-container">
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("proceed"),'but_name'=>"dispatch[companies.m_activate]",'cancel_action'=>"close",'but_meta'=>"cm-process-items"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"activate_selected",'text'=>__("activate_selected"),'content'=>Smarty::$_smarty_vars['capture']['activate_selected'],'link_text'=>__("activate_selected")), 0);?>


    <?php $_smarty_tpl->_capture_stack[0][] = array("disable_selected", null, null); ob_start(); ?>
        <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/reason_container.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('type'=>"disable"), 0);?>

        <div class="buttons-container">
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_text'=>__("proceed"),'but_name'=>"dispatch[companies.m_disable]",'cancel_action'=>"close",'but_meta'=>"cm-process-items"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"disable_selected",'text'=>__("disable_selected"),'content'=>Smarty::$_smarty_vars['capture']['disable_selected'],'link_text'=>__("disable_selected")), 0);?>
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php if ($_smarty_tpl->tpl_vars['companies']->value&&!$_smarty_tpl->tpl_vars['runtime']->value['company_id']){?>
        <?php if (!fn_allowed_for("ULTIMATE")){?>
            ...
            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_target_id'=>"content_activate_selected",'but_target_form'=>"companies_form",'but_text'=>__("activate_selected"),'but_meta'=>$_smarty_tpl->tpl_vars['but_class']->value,'but_role'=>"button_main",'but_name'=>$_smarty_tpl->tpl_vars['but_name']->value), 0);?>

            <?php echo $_smarty_tpl->getSubTemplate ("buttons/button.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_target_id'=>"content_disable_selected",'but_target_form'=>"companies_form",'but_text'=>__("disable_selected"),'but_meta'=>$_smarty_tpl->tpl_vars['but_class']->value,'but_role'=>"button_main",'but_name'=>$_smarty_tpl->tpl_vars['but_name']->value), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('tool_href'=>"companies.add",'prefix'=>"top",'hide_tools'=>true,'title'=>__("add_vendor"),'icon'=>"icon-plus"), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("sidebar", null, null); ob_start(); ?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/saved_search.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"companies.manage",'view_type'=>"companies"), 0);?>

    <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/companies_search_form.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"companies.manage"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("vendors"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons'],'sidebar'=>Smarty::$_smarty_vars['capture']['sidebar']), 0);?>
