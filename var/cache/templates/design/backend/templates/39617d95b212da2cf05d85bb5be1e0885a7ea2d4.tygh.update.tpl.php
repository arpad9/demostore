<?php /* Smarty version Smarty-3.1.13, created on 2013-09-20 14:03:21
         compiled from "/var/www/4profit4good/design/backend/templates/views/pages/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:335299607523c8de921ca66-51394984%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '39617d95b212da2cf05d85bb5be1e0885a7ea2d4' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/pages/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '335299607523c8de921ca66-51394984',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_523c8de94d14d0_22966734',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_523c8de94d14d0_22966734')) {function content_523c8de94d14d0_22966734($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
?><?php
fn_preload_lang_vars(array('information','name','description','show_page_in_popup','seo_meta_data','page_title','ttc_page_title','meta_description','meta_keywords','availability','usergroups','ttc_usergroups','creation_date','use_avail_period','avail_from','avail_till','add_page','add_link','clone_this_page','delete_this_page','preview'));
?>
...
"/>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("information"),'target'=>"#pages_information_setting"), 0);?>

    <div id="pages_information_setting" class="in collapse">
    <fieldset>
        <?php echo $_smarty_tpl->getSubTemplate ("views/pages/components/parent_page_selector.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
...
:</label>
        ...
        <?php if ($_smarty_tpl->tpl_vars['page_type']->value==@constant('PAGE_TYPE_LINK')){?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/pages/components/pages_link.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array(), 0);?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"page_data[status]",'id'=>"elm_page_status",'obj'=>$_smarty_tpl->tpl_vars['page_data']->value,'hidden'=>true), 0);?>
...
:</label>
    ...
    <?php if ($_smarty_tpl->tpl_vars['page_type']->value!=@constant('PAGE_TYPE_LINK')){?>
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("seo_meta_data"),'target'=>"#pages_seo_meta_data_setting"), 0);?>
...
:</label>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("availability"),'target'=>"#pages_availability_setting"), 0);?>
...
:</label>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("views/localizations/components/select.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_name'=>"page_data[localization]",'data_from'=>$_smarty_tpl->tpl_vars['page_data']->value['localization']), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php }?>
    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[pages.update]",'hide_first_button'=>$_smarty_tpl->tpl_vars['hide_first_button']->value,'hide_second_button'=>$_smarty_tpl->tpl_vars['hide_second_button']->value,'but_target_form'=>"page_update_form",'save'=>$_smarty_tpl->tpl_vars['id']->value), 0);?>
...
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["_title"] = new Smarty_variable($_tmp1.": ".((string)$_smarty_tpl->tpl_vars['page_data']->value['page']), null, 0);?>
    ...
    <?php if ($_smarty_tpl->tpl_vars['page_type']->value!=@constant('PAGE_TYPE_LINK')){?>
        <?php $_smarty_tpl->_capture_stack[0][] = array("preview", null, null); ob_start(); ?>
            <?php if (!fn_allowed_for("ULTIMATE")){?>
                <?php $_smarty_tpl->tpl_vars["view_uri"] = new Smarty_variable("pages.view?page_id=".((string)$_smarty_tpl->tpl_vars['id']->value), null, 0);?>
            ...
            <?php if (fn_allowed_for("ULTIMATE")){?>
                ...
                <?php }else{ ?>
                    <?php $_smarty_tpl->tpl_vars["company_id"] = new Smarty_variable($_smarty_tpl->tpl_vars['page_data']->value['company_id'], null, 0);?>
                <?php }?>
                <?php $_smarty_tpl->tpl_vars["view_uri"] = new Smarty_variable("pages.view?page_id=".((string)$_smarty_tpl->tpl_vars['id']->value)."&company_id=".((string)$_smarty_tpl->tpl_vars['company_id']->value), null, 0);?>
                <?php $_smarty_tpl->tpl_vars["view_uri_escaped"] = new Smarty_variable(rawurlencode(fn_url(((string)$_smarty_tpl->tpl_vars['view_uri']->value)."&action=preview",'C','http',@constant('DESCR_SL'))), null, 0);?>
            <?php }?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['_title']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons']), 0);?>
