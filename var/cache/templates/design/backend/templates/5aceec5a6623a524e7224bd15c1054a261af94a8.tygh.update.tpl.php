<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 05:33:31
         compiled from "/var/www/4profit4good/design/backend/templates/addons/banners/views/banners/update.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1239122633522d256b607eb7-35872582%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '5aceec5a6623a524e7224bd15c1054a261af94a8' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/addons/banners/views/banners/update.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1239122633522d256b607eb7-35872582',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522d256b77c478_29148590',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522d256b77c478_29148590')) {function content_522d256b77c478_29148590($_smarty_tpl) {?><?php
fn_preload_lang_vars(array('name','position_short','type','graphic_banner','text_banner','image','description','open_in_new_window','url','creation_date','new_banner','editing_banner'));
?>
...
" size="25" class="input-large" /></div>
    ...
    <?php if (fn_allowed_for("ULTIMATE")){?>
        <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_field.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('name'=>"banner_data[company_id]",'id'=>"banner_data_company_id",'selected'=>$_smarty_tpl->tpl_vars['banner']->value['company_id']), 0);?>
...
"><?php echo $_smarty_tpl->__("creation_date");?>
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("views/localizations/components/select.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_name'=>"banner_data[localization]",'data_from'=>$_smarty_tpl->tpl_vars['banner']->value['localization']), 0);?>


    <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"banner_data[status]",'id'=>"elm_banner_status",'obj_id'=>$_smarty_tpl->tpl_vars['id']->value,'obj'=>$_smarty_tpl->tpl_vars['banner']->value,'hidden'=>true), 0);?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("buttons", null, null); ob_start(); ?>
    <?php if (!$_smarty_tpl->tpl_vars['id']->value){?>
        <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_role'=>"submit-link",'but_target_form'=>"banners_form",'but_name'=>"dispatch[banners.update]"), 0);?>
...
<?php if (!$_smarty_tpl->tpl_vars['id']->value){?>
    <?php $_smarty_tpl->tpl_vars["title"] = new Smarty_variable($_smarty_tpl->__("new_banner"), null, 0);?>
<?php }else{ ?>
    <?php ob_start();?><?php echo $_smarty_tpl->__("editing_banner");?>
<?php $_tmp1=ob_get_clean();?><?php $_smarty_tpl->tpl_vars["title"] = new Smarty_variable($_tmp1.": ".((string)$_smarty_tpl->tpl_vars['banner']->value['banner']), null, 0);?>
<?php }?>
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>$_smarty_tpl->tpl_vars['title']->value,'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'buttons'=>Smarty::$_smarty_vars['capture']['buttons'],'select_languages'=>true), 0);?>
