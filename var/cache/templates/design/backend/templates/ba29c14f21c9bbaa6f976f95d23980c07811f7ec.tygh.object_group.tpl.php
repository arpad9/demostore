<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 01:51:21
         compiled from "/var/www/4profit4good/design/backend/templates/common/object_group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:257132175522cf15968a500-58275194%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'ba29c14f21c9bbaa6f976f95d23980c07811f7ec' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/common/object_group.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '257132175522cf15968a500-58275194',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522cf1597be257_69526482',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522cf1597be257_69526482')) {function content_522cf1597be257_69526482($_smarty_tpl) {?><?php
...
<?php }?>"<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['text']->value, ENT_QUOTES, 'UTF-8');?>
</a>
                <?php }else{ ?>
...
"><?php echo htmlspecialchars((($tmp = @$_smarty_tpl->tpl_vars['text']->value)===null||$tmp==='' ? $_smarty_tpl->__("view") : $tmp), ENT_QUOTES, 'UTF-8');?>
                ...
                <?php if ($_smarty_tpl->tpl_vars['company_object']->value){?>
                    <?php echo $_smarty_tpl->getSubTemplate ("views/companies/components/company_name.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('object'=>$_smarty_tpl->tpl_vars['company_object']->value), 0);?>
                    ...
                    <?php }?>
                        ...
                        <?php if (!$_smarty_tpl->tpl_vars['non_editable']->value){?>
                            <?php if ($_smarty_tpl->tpl_vars['href_delete']->value&&!$_smarty_tpl->tpl_vars['skip_delete']->value){?>
                                ...
                                <?php }?>
                                <li><?php smarty_template_function_btn($_smarty_tpl,array('type'=>"text",'text'=>__("delete"),'href'=>$_smarty_tpl->tpl_vars['href']->value,'class'=>"cm-confirm cm-tooltip cm-ajax cm-ajax-force cm-ajax-full-render ".((string)$_smarty_tpl->tpl_vars['class']->value),'data'=>array("data-ca-target-id"=>$_smarty_tpl->tpl_vars['delete_target_id']->value)));?>
</li>
                            <?php }?>
                        <?php }?>
            ...
            <?php if (!$_smarty_tpl->tpl_vars['nostatus']->value){?>
                <td width="12%">
                    <div class="pull-right nowrap">
                        ...
                        <?php echo $_smarty_tpl->getSubTemplate ("common/select_popup.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('popup_additional_class'=>"dropleft",'id'=>$_smarty_tpl->tpl_vars['id']->value,'status'=>$_smarty_tpl->tpl_vars['status']->value,'hidden'=>$_smarty_tpl->tpl_vars['hidden']->value,'object_id_name'=>$_smarty_tpl->tpl_vars['object_id_name']->value,'table'=>$_smarty_tpl->tpl_vars['table']->value,'hide_for_vendor'=>$_smarty_tpl->tpl_vars['hide_for_vendor']->value,'display'=>$_smarty_tpl->tpl_vars['display']->value,'non_editable'=>$_smarty_tpl->tpl_vars['non_editable']->value), 0);?>
