<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 02:12:31
         compiled from "/var/www/4profit4good/design/backend/templates/views/profiles/components/profiles_account.tpl" */ ?>
<?php /*%%SmartyHeaderCode:140542178352323c4fe9ef61-23768444%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'a1d1daa1af7008a4e110bc02662614ff479536ec' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/profiles/components/profiles_account.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '140542178352323c4fe9ef61-23768444',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52323c500ac1c7_65129092',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52323c500ac1c7_65129092')) {function content_52323c500ac1c7_65129092($_smarty_tpl) {?><?php if (!is_callable('smarty_block_hook')) include '/var/www/4profit4good/app/functions/smarty_plugins/block.hook.php';
?><?php
...
?>
<?php echo $_smarty_tpl->getSubTemplate ("common/subheader.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("user_account_information")), 0);?>
...
<?php if (($_smarty_tpl->tpl_vars['uid']->value!=1||defined("RESTRICTED_ADMIN"))&&$_smarty_tpl->tpl_vars['user_data']->value['user_id']!=$_smarty_tpl->tpl_vars['auth']->value['user_id']){?>
    <?php if ($_smarty_tpl->tpl_vars['runtime']->value['company_id']&&$_smarty_tpl->tpl_vars['user_data']->value['is_root']!="Y"||!fn_check_user_type_admin_area($_smarty_tpl->tpl_vars['user_data']->value)||!$_smarty_tpl->tpl_vars['user_data']->value['user_id']||($_smarty_tpl->tpl_vars['user_data']->value['company_id']&&!$_smarty_tpl->tpl_vars['auth']->value['company_id'])){?>
        ...
        <?php echo $_smarty_tpl->getSubTemplate ("common/select_status.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('input_name'=>"user_data[status]",'id'=>"user_data",'obj'=>$_smarty_tpl->tpl_vars['user_data']->value,'hidden'=>false,'display'=>$_smarty_tpl->tpl_vars['display']->value), 0);?>
