<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:22:47
         compiled from "/var/www/4profit4good/design/backend/templates/views/promotions/components/condition.tpl" */ ?>
<?php /*%%SmartyHeaderCode:157806851652333bd7edc998-89699793%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '7cddc3da9f0a5f7391247dd8eec831a26169df71' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/promotions/components/condition.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '157806851652333bd7edc998-89699793',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333bd8166a12_25423908',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333bd8166a12_25423908')) {function content_52333bd8166a12_25423908($_smarty_tpl) {?><?php if (!is_callable('smarty_function_include_ext')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.include_ext.php';
?><?php
...
[value]" class="input-medium hidden"></select>
        <?php echo $_smarty_tpl->getSubTemplate ("common/ajax_select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('data_url'=>'','text'=>'','result_elm'=>"mixed_input_".((string)$_smarty_tpl->tpl_vars['p_md']->value),'id'=>"mixed_ajax_select_".((string)$_smarty_tpl->tpl_vars['p_md']->value),'js_action'=>"$"."('#mixed_input_".((string)$_smarty_tpl->tpl_vars['p_md']->value)."').toggleBy(("."$"."('#mixed_input_".((string)$_smarty_tpl->tpl_vars['p_md']->value)."').val() != 'disable_select')); if ("."$"."('#mixed_input_".((string)$_smarty_tpl->tpl_vars['p_md']->value)."').val() == 'disable_select') "."$"."('#mixed_input_".((string)$_smarty_tpl->tpl_vars['p_md']->value)."').val('');"), 0);?>
