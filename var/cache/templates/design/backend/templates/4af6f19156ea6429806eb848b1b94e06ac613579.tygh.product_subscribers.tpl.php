<?php /* Smarty version Smarty-3.1.13, created on 2013-09-15 07:40:16
         compiled from "/var/www/4profit4good/design/backend/templates/views/products/components/product_subscribers.tpl" */ ?>
<?php /*%%SmartyHeaderCode:101890724452352c21010a02-73602944%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '4af6f19156ea6429806eb848b1b94e06ac613579' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/products/components/product_subscribers.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '101890724452352c21010a02-73602944',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52352c210fb0c0_78143745',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52352c210fb0c0_78143745')) {function content_52352c210fb0c0_78143745($_smarty_tpl) {?><?php
...
<div class="btn-toolbar clearfix">
    ...
    <?php }?>
        <div class="pull-left">
            <?php echo $_smarty_tpl->getSubTemplate ("views/products/components/search_product_subscribers.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('dispatch'=>"products.update",'search'=>$_smarty_tpl->tpl_vars['product_subscribers_search']->value), 0);?>
...
" method="post" name="subscribers_form_0" class=" ">
                ...
                <div class="buttons-container">
                    <?php echo $_smarty_tpl->getSubTemplate ("buttons/save_cancel.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('but_name'=>"dispatch[products.update]",'cancel_action'=>"close"), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
            ...
            <span class="shift-right">
                <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_subscribers",'text'=>__("new_subscribers"),'content'=>Smarty::$_smarty_vars['capture']['new_email_picker'],'link_text'=>__("add_subscriber"),'act'=>"general"), 0);?>

            </span>

            <?php echo $_smarty_tpl->getSubTemplate ("pickers/users/picker.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('no_container'=>true,'data_id'=>"subscr_user",'picker_for'=>"subscribers",'extra_var'=>"products.update?product_id=".((string)$_smarty_tpl->tpl_vars['product_id']->value)."&selected_section=subscribers",'but_text'=>__("add_subscribers_from_users"),'view_mode'=>"button",'but_meta'=>"btn"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/pagination.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('save_current_page'=>true,'div_id'=>"product_subscribers",'search'=>$_smarty_tpl->tpl_vars['product_subscribers_search']->value), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/pagination.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('div_id'=>"product_subscribers",'search'=>$_smarty_tpl->tpl_vars['product_subscribers_search']->value), 0);?>
