<?php /* Smarty version Smarty-3.1.13, created on 2013-09-20 22:12:48
         compiled from "/var/www/4profit4good/design/backend/templates/views/payments/manage.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1345773626523d00a0a4b113-89332232%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0322e46c2aabe9588c4dd3c80da95aecd46f31c8' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/payments/manage.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1345773626523d00a0a4b113-89332232',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_523d00a0b2d8d3_02558539',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_523d00a0b2d8d3_02558539')) {function content_523d00a0b2d8d3_02558539($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
?><?php
...
function fn_switch_processor(payment_id, processor_id)
{
    ...
    if (processor_id != 0) {
        ...
        Tygh.$('#tab_conf_' + payment_id + ' a').prop('href', '<?php echo fn_url("payments.processor?payment_id=",'A','rel');?>
...
<?php $_smarty_tpl->_capture_stack[0][] = array("adv_buttons", null, null); ob_start(); ?>
    <?php $_smarty_tpl->_capture_stack[0][] = array("add_new_picker", null, null); ob_start(); ?>
        <?php echo $_smarty_tpl->getSubTemplate ("views/payments/update.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('payment'=>array(),'hide_for_vendor'=>false), 0);?>
...
if (!empty($_capture_buffer)) {
 ...
 Smarty::$_smarty_vars['capture'][$_capture_buffer]=ob_get_clean();
    ...
    <?php echo $_smarty_tpl->getSubTemplate ("common/popupbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('id'=>"add_new_payments",'text'=>__("new_payments"),'content'=>Smarty::$_smarty_vars['capture']['add_new_picker'],'title'=>__("add_payment"),'act'=>"general",'icon'=>"icon-plus"), 0);?>
...
<?php echo $_smarty_tpl->getSubTemplate ("common/mainbox.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('title'=>__("payment_methods"),'content'=>Smarty::$_smarty_vars['capture']['mainbox'],'select_languages'=>true,'adv_buttons'=>Smarty::$_smarty_vars['capture']['adv_buttons']), 0);?>
