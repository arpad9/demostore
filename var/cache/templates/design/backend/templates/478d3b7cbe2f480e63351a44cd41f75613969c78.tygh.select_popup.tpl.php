<?php /* Smarty version Smarty-3.1.13, created on 2013-09-09 00:49:51
         compiled from "/var/www/4profit4good/design/backend/templates/common/select_popup.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1312814107522ce2ef653e53-88082453%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '478d3b7cbe2f480e63351a44cd41f75613969c78' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/common/select_popup.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '1312814107522ce2ef653e53-88082453',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_522ce2ef7ff284_05381648',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_522ce2ef7ff284_05381648')) {function content_522ce2ef7ff284_05381648($_smarty_tpl) {?><?php if (!is_callable('smarty_function_script')) include '/var/www/4profit4good/app/functions/smarty_plugins/function.script.php';
?><?php
...
<?php }?> dropdown-toggle <?php if ($_smarty_tpl->tpl_vars['id']->value){?> cm-combo-on cm-combination<?php }?>" data-toggle="dropdown">
    <?php }?>
...
?>
 ...
 <?php if ($_smarty_tpl->tpl_vars['status']->value==$_smarty_tpl->tpl_vars['st']->value){?>cm-active<?php }else{ ?>cm-ajax<?php }?> <?php if ($_smarty_tpl->tpl_vars['status_meta']->value){?><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['status_meta']->value, ENT_QUOTES, 'UTF-8');?>
...
<?php }?>');" data-ca-event="ce.update_object_status_callback"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['val']->value, ENT_QUOTES, 'UTF-8');?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['notify']->value){?>
                <li><a href="#"><label for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_notify">
                    <input type="checkbox" name="__notify_user" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['prefix']->value, ENT_QUOTES, 'UTF-8');?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_notify" value="Y" class="checkbox" checked="checked" onclick="Tygh.$('input[name=__notify_user]').prop('checked', this.checked);" />
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_notify_department" value="Y" class="checkbox" checked="checked" onclick="Tygh.$('input[name=__notify_department]').prop('checked', this.checked);" />
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['id']->value, ENT_QUOTES, 'UTF-8');?>
_notify_vendor" value="Y" class="checkbox" checked="checked" onclick="Tygh.$('input[name=__notify_vendor]').prop('checked', this.checked);" />
