<?php /* Smarty version Smarty-3.1.13, created on 2013-09-13 20:22:47
         compiled from "/var/www/4profit4good/design/backend/templates/views/promotions/components/group.tpl" */ ?>
<?php /*%%SmartyHeaderCode:204845091052333bd7dabd32-72851298%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'c92724b72625a1adafd880ae785adab0c8a269d0' => 
    array (
      0 => '/var/www/4profit4good/design/backend/templates/views/promotions/components/group.tpl',
      1 => 1372247425,
      2 => 'tygh',
    ),
  ),
  'nocache_hash' => '204845091052333bd7dabd32-72851298',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_52333bd7ecbc22_48722035',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_52333bd7ecbc22_48722035')) {function content_52333bd7ecbc22_48722035($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_in_array')) include '/var/www/4profit4good/app/functions/smarty_plugins/modifier.in_array.php';
?><?php
fn_preload_lang_vars(array('any','all','all','any','true','false','false','true','remove_this_item','add_condition','add_group','group','text_promotions_group_condition','no_items'));
?>
...
<?php $_smarty_tpl->tpl_vars["selected_name"] = new Smarty_variable($_smarty_tpl->__("any"), null, 0);?>
<?php }else{ ?>
<?php $_smarty_tpl->tpl_vars["selected_name"] = new Smarty_variable($_smarty_tpl->__("all"), null, 0);?>
<?php }?>
<?php echo $_smarty_tpl->getSubTemplate ("common/select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('style'=>"field",'items'=>array("all"=>__("all"),"any"=>__("any")),'select_container_name'=>((string)$_smarty_tpl->tpl_vars['prefix']->value)."[set]",'selected_key'=>$_smarty_tpl->tpl_vars['group']->value['set'],'selected_name'=>$_smarty_tpl->tpl_vars['selected_name']->value), 0);?>
...
<?php $_smarty_tpl->tpl_vars["selected_name"] = new Smarty_variable($_smarty_tpl->__("true"), null, 0);?>
<?php }else{ ?>
<?php $_smarty_tpl->tpl_vars["selected_name"] = new Smarty_variable($_smarty_tpl->__("false"), null, 0);?>
<?php }?>
<?php echo $_smarty_tpl->getSubTemplate ("common/select_object.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('style'=>"field",'items'=>array("0"=>__("false"),"1"=>__("true")),'select_container_name'=>((string)$_smarty_tpl->tpl_vars['prefix']->value)."[set_value]",'selected_key'=>(($tmp = @$_smarty_tpl->tpl_vars['group']->value['set_value'])===null||$tmp==='' ? 1 : $tmp),'selected_name'=>$_smarty_tpl->tpl_vars['selected_name']->value), 0);?>
...
<ul class="promotion-group cm-row-item">
    <li class="no-node<?php if ($_smarty_tpl->tpl_vars['root']->value){?>-root<?php }?>">
        ...
        <div class="pull-right">
            <a class="icon-trash cm-delete-row cm-tooltip promotion-remove" name="remove" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['item_id']->value, ENT_QUOTES, 'UTF-8');?>
...
" class="btn-toolbar pull-right">
            <?php if (!$_smarty_tpl->tpl_vars['hide_add_buttons']->value){?>
                <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('hide_tools'=>true,'tool_onclick'=>"fn_promotion_add(Tygh."."$"."(this).parents('div[id^=add_condition_]').prop('id'), false, 'condition');",'prefix'=>"simple",'link_text'=>__("add_condition")), 0);?>

                <?php echo $_smarty_tpl->getSubTemplate ("common/tools.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('hide_tools'=>true,'tool_onclick'=>"fn_promotion_add_group(Tygh."."$"."(this).parents('div[id^=add_condition_]').prop('id'), '".((string)$_smarty_tpl->tpl_vars['zone']->value)."');",'prefix'=>"simple",'link_text'=>__("add_group")), 0);?>

            <?php }?>
        </div>
        <strong><?php echo $_smarty_tpl->__("group");?>
</strong>
...
" class="cm-row-item<?php if ($_smarty_tpl->getVariable('smarty')->value['foreach']['conditions']['last']){?> cm-last-item<?php }?>">
        <?php if ($_smarty_tpl->tpl_vars['condition_data']->value['set']){?> 
            <?php echo $_smarty_tpl->getSubTemplate ("views/promotions/components/group.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('root'=>false,'group'=>$_smarty_tpl->tpl_vars['condition_data']->value,'prefix'=>((string)$_smarty_tpl->tpl_vars['prefix']->value)."[conditions][".((string)$_smarty_tpl->tpl_vars['k']->value)."]",'elm_id'=>"condition_".((string)$_smarty_tpl->tpl_vars['prefix_md5']->value)."_".((string)$_smarty_tpl->tpl_vars['k']->value)), 0);?>

        <?php }else{ ?>
            <?php echo $_smarty_tpl->getSubTemplate ("views/promotions/components/condition.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('condition_data'=>$_smarty_tpl->tpl_vars['condition_data']->value,'prefix'=>((string)$_smarty_tpl->tpl_vars['prefix']->value)."[conditions][".((string)$_smarty_tpl->tpl_vars['k']->value)."]",'elm_id'=>"condition_".((string)$_smarty_tpl->tpl_vars['prefix_md5']->value)."_".((string)$_smarty_tpl->tpl_vars['k']->value)), 0);?>
...
" class="hidden cm-row-item">
        <div class="option">
        <select onchange="Tygh.$.ceAjax('request', '<?php echo fn_url("promotions.dynamic?zone=".((string)$_smarty_tpl->tpl_vars['zone']->value)."&promotion_id=".((string)$_REQUEST['promotion_id']),'A','rel');?>
&prefix=' + escape(this.name) + '&condition=' + this.value + '&elm_id=' + this.id, <?php echo htmlspecialchars($_smarty_tpl->tpl_vars['ldelim']->value, ENT_QUOTES, 'UTF-8');?>
